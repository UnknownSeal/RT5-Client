...
public final class Class264_Sub1 extends Class264 {
	...
	private static int method6577(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1) {
		@Pc(3) int local3 = -1;
	...
	public static int method6578(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		return method6577(arg0, arg1);
	}

	@OriginalMember(owner = "unpackclass!e", name = "<init>", descriptor = "(I)V")
	public Class264_Sub1(@OriginalArg(0) int arg0) {
		this.aByteArray100 = Class263.method6572(arg0);
		this.anInt7287 = 0;
	}
	...
	public void method6582(@OriginalArg(0) long arg0) {
	...
	public void method6583(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1) {
	...
	public void method6588(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1) {
		for (@Pc(3) int local3 = 0; local3 < arg1; local3++) {
	...
	public int method6589() {
		...
		return local7 < 128 ? this.method6584() : this.method6585() - 32768;
	}
	...
	public void method6591(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(4) int local4 = this.anInt7287;
		this.anInt7287 = 5;
		@Pc(13) int local13 = (arg1 - 5) / 8;
		for (@Pc(15) int local15 = 0; local15 < local13; local15++) {
			@Pc(20) int local20 = this.method6587();
			@Pc(23) int local23 = this.method6587();
			...
			this.anInt7287 -= 8;
			this.method6581(local20);
			this.method6581(local23);
		}
