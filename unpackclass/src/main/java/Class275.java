...
public final class Class275 {
	...
	public static int method6610(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3) {
	...
	private static void method6611(@OriginalArg(0) Class267 arg0) {
	...
	private static void method6612(@OriginalArg(0) Class267 arg0) {
		...
		while (true) {
			while (local56) {
				@Pc(60) byte local60 = method6613(arg0);
				if (local60 == 23) {
					return;
				}
				local60 = method6613(arg0);
				local60 = method6613(arg0);
				local60 = method6613(arg0);
				local60 = method6613(arg0);
				local60 = method6613(arg0);
				...
				@Pc(217) int local217 = method6615(3, arg0);
				@Pc(221) int local221 = method6615(15, arg0);
				...
				for (local304 = 0; local304 < local217; local304++) {
					@Pc(309) int local309 = method6615(5, arg0);
				...
				for (local304 = 0; local304 < local217; local304++) {
					...
					method6617(arg0.anIntArrayArray68[local304], arg0.anIntArrayArray69[local304], arg0.anIntArrayArray70[local304], arg0.aByteArrayArray26[local304], local347, local349, local213);
				...
				for (local507 = method6615(local485, arg0); local507 > local490[local503]; local507 = local507 << 1 | local516) {
					local503++;
					local516 = method6614(arg0);
				}
	...
	private static byte method6613(@OriginalArg(0) Class267 arg0) {
		return (byte) method6615(8, arg0);
	}
	...
	private static byte method6614(@OriginalArg(0) Class267 arg0) {
		return (byte) method6615(1, arg0);
	}

	@OriginalMember(owner = "unpackclass!u", name = "a", descriptor = "(ILunpackclass!h;)I")
	private static int method6615(@OriginalArg(0) int arg0, @OriginalArg(1) Class267 arg1) {
	...
	private static void method6616(@OriginalArg(0) Class267 arg0) {
		arg0.anInt7302 = 0;
	...
	private static void method6617(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3;
