...
public abstract class Class262 {
	...
	private static byte[] method6605(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class264_Sub1 local4 = new Class264_Sub1(arg0);
		@Pc(7) int local7 = local4.method6584();
		@Pc(10) int local10 = local4.method6587();
		if (local10 < 0 || anInt7311 != 0 && local10 > anInt7311) {
			throw new RuntimeException();
		} else if (local7 == 0) {
			@Pc(26) byte[] local26 = new byte[local10];
			local4.method6588(local26, local10);
			return local26;
		} else {
			@Pc(36) int local36 = local4.method6587();
			if (local36 < 0 || anInt7311 != 0 && local36 > anInt7311) {
				throw new RuntimeException();
			}
			@Pc(50) byte[] local50 = new byte[local36];
			if (local7 == 1) {
				Class275.method6610(local50, local36, arg0, local10);
			} else {
				aClass270_2.method6595(local4, local50);
			}
			return local50;
		}
	}
	...
	protected final void method6597(@OriginalArg(0) byte[] arg0) {
		this.anInt7310 = Class264_Sub1.method6578(arg0, arg0.length);
		@Pc(13) Class264_Sub1 local13 = new Class264_Sub1(method6605(arg0));
		@Pc(16) int local16 = local13.method6584();
		...
		@Pc(42) int local42 = local13.method6584();
		this.anInt7309 = local13.method6585();
		@Pc(48) int local48 = 0;
		@Pc(50) int local50 = -1;
		this.anIntArray543 = new int[this.anInt7309];
		for (@Pc(57) int local57 = 0; local57 < this.anInt7309; local57++) {
			this.anIntArray543[local57] = local48 += local13.method6585();
		...
		if (local42 != 0) {
			...
			for (local157 = 0; local157 < this.anInt7309; local157++) {
				this.anIntArray544[this.anIntArray543[local157]] = local13.method6587();
			}
			new Class268(this.anIntArray544);
		}
		for (local142 = 0; local142 < this.anInt7309; local142++) {
			this.anIntArray545[this.anIntArray543[local142]] = local13.method6587();
		}
		for (local157 = 0; local157 < this.anInt7309; local157++) {
			this.anIntArray546[this.anIntArray543[local157]] = local13.method6587();
		}
		for (@Pc(215) int local215 = 0; local215 < this.anInt7309; local215++) {
			this.anIntArray547[this.anIntArray543[local215]] = local13.method6585();
		}
		@Pc(240) int local240;
		@Pc(245) int local245;
		@Pc(249) int local249;
		...
		for (@Pc(233) int local233 = 0; local233 < this.anInt7309; local233++) {
			...
			for (local257 = 0; local257 < local245; local257++) {
				local273 = this.anIntArrayArray71[local240][local257] = local48 += local13.method6585();
		...
		for (local240 = 0; local240 < this.anInt7309; local240++) {
			...
			for (local273 = 0; local273 < local249; local273++) {
				...
				this.anIntArrayArray72[local245][local375] = local13.method6587();
			}
	...
	private boolean method6598(@OriginalArg(0) int arg0) {
	...
	private boolean method6599(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public final byte[] method6600(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method6601(arg0, arg1, null);
	}

	@OriginalMember(owner = "unpackclass!aa", name = "a", descriptor = "(II[I)[B")
	private byte[] method6601(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		if (!this.method6599(arg0, arg1)) {
			return null;
		}
		if (this.anObjectArrayArray3[arg0] == null || this.anObjectArrayArray3[arg0][arg1] == null) {
			@Pc(23) boolean local23 = this.method6604(arg0, arg2);
			if (!local23) {
				this.method6602(arg0);
				local23 = this.method6604(arg0, arg2);
				if (!local23) {
					return null;
				}
			}
		}
		@Pc(46) byte[] local46 = Class261.method6559(this.anObjectArrayArray3[arg0][arg1], false);
		if (this.aBoolean500) {
	...
	private void method6602(@OriginalArg(0) int arg0) {
	}

	@OriginalMember(owner = "unpackclass!aa", name = "c", descriptor = "(I)I")
	public final int method6603() {
		return this.method6598(0) ? this.anIntArray548[0] : 0;
	}

	@OriginalMember(owner = "unpackclass!aa", name = "a", descriptor = "(I[I)Z")
	private boolean method6604(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1) {
		if (!this.method6598(arg0)) {
			return false;
			...
			if (arg1 == null || arg1[0] == 0 && arg1[1] == 0 && arg1[2] == 0 && arg1[3] == 0) {
				local100 = Class261.method6559(this.anObjectArray37[arg0], false);
			} else {
				local100 = Class261.method6559(this.anObjectArray37[arg0], true);
				@Pc(105) Class264_Sub1 local105 = new Class264_Sub1(local100);
				local105.method6591(arg1, local105.aByteArray100.length);
			}
			...
			if (local19 > 1) {
				...
				for (@Pc(276) int local276 = 0; local276 < local198; local276++) {
					...
					for (local282 = 0; local282 < local19; local282++) {
						local280 += local211.method6587();
						Class271.method6596(local124, local274, local250[local282], local214[local282], local280);
				...
				for (local280 = 0; local280 < local19; local280++) {
					...
					if (this.aBoolean500) {
						...
						local43[local282] = Class261.method6558(local250[local280]);
					}
				}
			} else {
				if (local24 == null) {
				...
				if (this.aBoolean500) {
					...
					local43[local191] = Class261.method6558(local124);
				}
			}
			return true;
		}
