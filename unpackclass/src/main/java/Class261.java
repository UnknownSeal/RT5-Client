...
public abstract class Class261 {
	...
	public static Object method6558(@OriginalArg(0) byte[] arg0) {
		if (arg0 == null) {
			return null;
		}
	...
	public static byte[] method6559(@OriginalArg(0) Object arg0, @OriginalArg(1) boolean arg1) {
		if (arg0 == null) {
			return null;
		} else if (arg0 instanceof byte[]) {
			@Pc(9) byte[] local9 = (byte[]) arg0;
			return arg1 ? method6560(local9) : local9;
		} else if (arg0 instanceof Class261) {
			@Pc(22) Class261 local22 = (Class261) arg0;
			return local22.method6561();
		} else {
	...
	private static byte[] method6560(@OriginalArg(0) byte[] arg0) {
		@Pc(2) int local2 = arg0.length;
		@Pc(5) byte[] local5 = new byte[local2];
		Class271.method6596(arg0, 0, local5, 0, local2);
		return local5;
	}

	@OriginalMember(owner = "unpackclass!a", name = "a", descriptor = "()[B")
	protected abstract byte[] method6561();

	@OriginalMember(owner = "unpackclass!a", name = "b", descriptor = "([B)V")
	protected abstract void method6562(@OriginalArg(0) byte[] arg0);
}
