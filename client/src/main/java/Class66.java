...
public final class Class66 {
	...
	public void method1936(@OriginalArg(0) Class2_Sub4 arg0) {
		while (true) {
			@Pc(9) int local9 = arg0.method4814();
			if (local9 == 0) {
				return;
			}
			this.method1938(arg0, local9);
		}
	}

	@OriginalMember(owner = "client!et", name = "a", descriptor = "(Lclient!bt;IZ)V")
	private void method1938(@OriginalArg(0) Class2_Sub4 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt1877 = arg0.method4814();
		} else if (arg1 == 2) {
			this.anInt1883 = arg0.method4828();
		} else if (arg1 == 3) {
			this.anInt1879 = arg0.method4828();
		} else if (arg1 == 4) {
			this.anInt1880 = arg0.method4822();
			return;
		}
	}
}
