...
public final class Class245 {
	...
	private void method6310(@OriginalArg(0) Class2_Sub4 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt7072 = arg0.method4828();
		} else if (arg1 == 2) {
			this.anIntArray484 = new int[arg0.method4814()];
			for (@Pc(19) int local19 = 0; local19 < this.anIntArray484.length; local19++) {
				this.anIntArray484[local19] = arg0.method4828();
			}
		} else if (arg1 == 3) {
			this.anInt7078 = arg0.method4814();
		}
	}

	@OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lclient!bt;B)V")
	public void method6314(@OriginalArg(0) Class2_Sub4 arg0) {
		while (true) {
			@Pc(5) int local5 = arg0.method4814();
			if (local5 == 0) {
				return;
			}
			this.method6310(arg0, local5);
		}
	}
}
