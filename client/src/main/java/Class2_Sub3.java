...
public abstract class Class2_Sub3 extends Node {
	...
	protected final int[] method6472(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return this.aClass2_Sub3Array42[arg0].aBoolean487 ? this.aClass2_Sub3Array42[arg0].method6484(arg1) : this.aClass2_Sub3Array42[arg0].method6478(arg1)[0];
	}
	...
	protected final int[][] method6482(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aClass2_Sub3Array42[arg0].aBoolean487) {
			@Pc(22) int[] local22 = this.aClass2_Sub3Array42[arg0].method6484(arg1);
			return new int[][] { local22, local22, local22 };
		} else {
			return this.aClass2_Sub3Array42[arg0].method6478(arg1);
		}
	}
