...
public final class Class12_Sub1_Sub1_Sub1 extends Class12_Sub1_Sub1 {
	...
	public void method4215(@OriginalArg(0) long arg0) {
		...
		if (local36.anInt4679 < Static92.anInt1914 - 1) {
			local66 = local42[local36.anInt4679 + 1].method5718(local4, local9);
		} else {
		...
		if (local40.aBoolean448) {
			...
			if (local40.anInt6577 >= 0 && local14 > local42[local40.anInt6577].method5718(local4, local9)) {
				this.method4219();
				return;
			}
			...
			if (local40.anInt6587 >= 0 && local14 < local42[local40.anInt6587 + 1].method5718(local4, local9)) {
				this.method4219();
				return;
			}
		}
		if (local4 >= local36.anInt4677 && local4 <= local36.anInt4676 && local9 >= local36.anInt4680 && local9 <= local36.anInt4675 && local14 <= local50 && local14 >= local66) {
			local36.aClass224_2.aClass191_1.method4890(this);
			return;
		}
		@Pc(152) int local152;
		for (local152 = Static92.anInt1914 - 1; local152 > 0 && local14 > local42[local152].method5718(local4, local9); local152--) {
		}
		if (local152 == 0 && local14 > local42[0].method5718(local4, local9)) {
			this.method4219();
		} else if (local152 == Static92.anInt1914 - 1 && local42[local152].method5718(local4, local9) - local14 > 1024) {
			this.method4219();
		} else {
			...
			if (local203.aClass224_1 == null) {
				...
				local203.aClass224_1.aClass191_1.method4891();
				local203.aClass224_1.aBoolean429 = false;
				local203.aByte13 = (byte) (arg0 & 0xFFL);
			}
			local203.aClass224_1.aClass191_1.method4890(this);
		}
	}
	...
	private void method4216() {
		...
		if (this.aClass12_Sub8_1.aClass12_Sub5_6.aClass12_Sub1_Sub1_Sub1Array2[local4] != null) {
			this.aClass12_Sub8_1.aClass12_Sub5_6.aClass12_Sub1_Sub1_Sub1Array2[local4].method4219();
		}
	...
	public void method4217(@OriginalArg(0) Class12_Sub8 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) boolean arg12, @OriginalArg(13) boolean arg13) {
		this.aClass12_Sub8_1 = arg0;
		super.anInt4465 = arg1 << Static111.anInt2254;
		super.anInt4470 = arg2 << Static111.anInt2254;
		super.anInt4467 = arg3 << Static111.anInt2254;
	...
	public void method4218(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
			...
			for (local313 = 0; local313 < local35.anIntArray459.length; local313++) {
				...
				while (local743 != null) {
					...
					if (local775 > local747.aLong23) {
						local743 = (Class2_Sub2_Sub5) Static141.aClass115_1.method2974();
					} else {
