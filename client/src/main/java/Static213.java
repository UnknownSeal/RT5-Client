...
public final class Static213 {
	...
	private static Class174 aClass174_1 = new Class174();

	@OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lclient!ot;)V")
	private static void method3734(@OriginalArg(0) Class174 arg0) {
		arg0.anInt4794 = 0;
	...
	private static byte method3737(@OriginalArg(0) Class174 arg0) {
		return (byte) method3739(1, arg0);
	}

	@OriginalMember(owner = "client!mj", name = "d", descriptor = "(Lclient!ot;)B")
	private static byte method3738(@OriginalArg(0) Class174 arg0) {
		return (byte) method3739(8, arg0);
	}

	@OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILclient!ot;)I")
	private static int method3739(@OriginalArg(0) int arg0, @OriginalArg(1) Class174 arg1) {
	...
	public static int method3741(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3) {
	...
	private static void method3742(@OriginalArg(0) Class174 arg0) {
		arg0.anInt4788 = 1;
		...
		while (true) {
			while (local56) {
				@Pc(60) byte local60 = method3738(arg0);
				if (local60 == 23) {
					return;
				}
				...
				@Pc(217) int local217 = method3739(3, arg0);
				@Pc(221) int local221 = method3739(15, arg0);
				...
				for (local304 = 0; local304 < local217; local304++) {
					@Pc(309) int local309 = method3739(5, arg0);
				...
				for (local304 = 0; local304 < local217; local304++) {
					...
					method3735(arg0.anIntArrayArray39[local304], arg0.anIntArrayArray38[local304], arg0.anIntArrayArray37[local304], arg0.aByteArrayArray13[local304], local347, local349, local213);
				...
				for (local507 = method3739(local485, arg0); local507 > local490[local503]; local507 = local507 << 1 | local516) {
					local503++;
					local516 = method3737(arg0);
				}
