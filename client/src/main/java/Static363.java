...
public final class Static363 {
	...
	public static void method6090() {
		...
		if (Static314.anInt5911 != 1) {
			local94 = Static386.method6031(Static136.anInt6778, Static211.anInt3777, Static355.anInt6585);
			if (local94 - Static102.anInt3592 < 800 && (Static359.aByteArrayArrayArray16[Static355.anInt6585][Static136.anInt6778 >> 7][Static211.anInt3777 >> 7] & 0x4) != 0) {
				Static81.method3666(Static330.aClass67ArrayArrayArray3, false, Static136.anInt6778 >> 7, Static211.anInt3777 >> 7, 1);
				return;
			}
			return;
		}
		...
		if (local196 == 0 && local210 == 0 || local196 <= -Static373.anInt7033 || Static373.anInt7033 <= local196 || local210 <= -Static242.anInt4449 || local210 >= Static242.anInt4449) {
			Static262.report(null, "RC: " + local94 + "," + local175 + " " + local180 + "," + local185 + " " + Static164.originX + "," + Static148.originZ);
			return;
		}
		@Pc(290) int local290;
		@Pc(292) int local292;
		if (local210 >= local196) {
			...
			while (local185 != local175) {
				...
				if ((Static359.aByteArrayArrayArray16[Static355.anInt6585][local94][local175] & 0x4) != 0) {
					Static81.method3666(Static330.aClass67ArrayArrayArray3, false, local94, local175, 1);
					return;
				}
				local292 += local290;
				if (local292 >= 65536) {
