...
public final class Class15_Sub2 extends Class15 {
	...
	private void method1587() {
		...
		if (this.anInt1415 == 21) {
			Static90.method5949(this.aClass90_1, (Class67) local34);
		} else if (this.anInt1415 == 20) {
			@Pc(57) Class67 local57 = (Class67) local34;
			if (local57.aClass11_Sub1_3 != null) {
				local57.aClass11_Sub1_3.method6069(Static16.aClass19_10);
			}
			if (local57.aClass11_Sub1_2 != null) {
				local57.aClass11_Sub1_2.method6069(Static16.aClass19_10);
			}
			if (local57.aClass11_Sub3_2 != null) {
				local57.aClass11_Sub3_2.method6069(Static16.aClass19_10);
			}
			if (local57.aClass11_Sub3_3 != null) {
				local57.aClass11_Sub3_3.method6069(Static16.aClass19_10);
			}
			if (local57.aClass11_Sub2_2 != null) {
				local57.aClass11_Sub2_2.method6069(Static16.aClass19_10);
			}
			for (@Pc(100) Class22 local100 = local57.aClass22_2; local100 != null; local100 = local100.aClass22_1) {
				local100.aClass11_Sub5_1.method6069(Static16.aClass19_10);
			}
		} else if (this.anInt1415 >= 30 && this.anInt1415 <= 33) {
			Static16.aClass19_10.method2823(3000.0F, super.aFloatArray11[local8] * 1.5F);
			((Class6) local34).method5728(Static248.anInt4650, Static211.anInt3780, Static212.anInt3788, Static6.aBooleanArrayArray1, this.anInt1415 - 30 == 0);
		} else if (this.anInt1415 >= 40 && this.anInt1415 <= 43) {
			Static16.aClass19_10.method2823(3000.0F, super.aFloatArray11[local8] * 1.5F);
			((Class6) local34).method5728(Static248.anInt4650, Static211.anInt3780, Static212.anInt3788, Static364.aBooleanArrayArray5, this.anInt1415 - 40 == 0);
