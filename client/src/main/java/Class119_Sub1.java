...
public final class Class119_Sub1 extends Class119 implements MouseListener, MouseMotionListener {
	...
	private void method3313(@OriginalArg(1) MouseEvent arg0) {
		this.anInt3346 = arg0.getX();
		this.anInt3345 = arg0.getY();
		if (this.aBoolean224) {
			this.method3316(-1, arg0.getX(), arg0.getY());
		}
	}
	...
	private void method3316(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(7) Class2_Sub24_Sub1 local7 = new Class2_Sub24_Sub1();
		local7.anInt5770 = arg1;
		local7.anInt5764 = arg0;
		local7.anInt5766 = arg2;
		local7.aLong175 = Static204.method3684();
	...
	private void method3318(@OriginalArg(0) Component arg0) {
		this.method3320();
	...
	private int method3319(@OriginalArg(0) MouseEvent arg0) {
	...
	public synchronized void mouseReleased(@OriginalArg(0) MouseEvent arg0) {
		@Pc(8) int local8 = this.method3319(arg0);
		if ((this.anInt3347 & local8) == 0) {
			local8 = this.anInt3347;
		}
		if ((local8 & 0x1) != 0) {
			this.method3316(3, arg0.getX(), arg0.getY());
		}
		if ((local8 & 0x4) != 0) {
			this.method3316(5, arg0.getX(), arg0.getY());
		}
		if ((local8 & 0x2) != 0) {
			this.method3316(4, arg0.getX(), arg0.getY());
		}
	...
	public synchronized void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		@Pc(10) int local10 = this.method3319(arg0);
		if (local10 == 1) {
			this.method3316(0, arg0.getX(), arg0.getY());
		} else if (local10 == 4) {
			this.method3316(2, arg0.getX(), arg0.getY());
		} else if (local10 == 2) {
			this.method3316(1, arg0.getX(), arg0.getY());
		}
