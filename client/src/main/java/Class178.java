...
public final class Class178 {
	...
	private int method4548(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 1) {
	...
	public int[] method4549(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		Static403.method4607(Static269.anIntArray339, 0, arg0);
		if (arg1 < 10) {
			return Static269.anIntArray339;
		}
		@Pc(16) double local16 = (double) arg0 / ((double) arg1 + 0.0D);
		this.aClass232_9.method5841();
		this.aClass232_8.method5841();
		@Pc(24) int local24 = 0;
		@Pc(26) int local26 = 0;
		@Pc(28) int local28 = 0;
		if (this.aClass232_1 != null) {
			this.aClass232_1.method5841();
			this.aClass232_6.method5841();
		...
		if (this.aClass232_7 != null) {
			this.aClass232_7.method5841();
			this.aClass232_3.method5841();
		...
		for (@Pc(176) int local176 = 0; local176 < arg0; local176++) {
			local182 = this.aClass232_9.method5839(arg0);
			local187 = this.aClass232_8.method5839(arg0);
			if (this.aClass232_1 != null) {
				local195 = this.aClass232_1.method5839(arg0);
				local200 = this.aClass232_6.method5839(arg0);
				local182 += this.method4548(local28, local200, this.aClass232_1.anInt6459) >> 1;
				local28 += (local195 * local24 >> 16) + local26;
			}
			if (this.aClass232_7 != null) {
				local195 = this.aClass232_7.method5839(arg0);
				local200 = this.aClass232_3.method5839(arg0);
				local187 = local187 * ((this.method4548(local67, local200, this.aClass232_7.anInt6459) >> 1) + 32768) >> 15;
			...
			for (local195 = 0; local195 < 5; local195++) {
				if (this.anIntArray343[local195] != 0) {
					...
					if (local200 < arg0) {
						Static269.anIntArray339[local200] += this.method4548(Static269.anIntArray345[local195], local187 * Static269.anIntArray348[local195] >> 15, this.aClass232_9.anInt6459);
		...
		if (this.aClass232_4 != null) {
			this.aClass232_4.method5841();
			this.aClass232_5.method5841();
			local182 = 0;
			@Pc(339) boolean local339 = true;
			for (local200 = 0; local200 < arg0; local200++) {
				local347 = this.aClass232_4.method5839(arg0);
				local352 = this.aClass232_5.method5839(arg0);
				if (local339) {
		...
		if (this.aClass176_1.anIntArray332[0] > 0 || this.aClass176_1.anIntArray332[1] > 0) {
			this.aClass232_2.method5841();
			local182 = this.aClass232_2.method5839(arg0 + 1);
			local187 = this.aClass176_1.method4469(0, (float) local182 / 65536.0F);
			local195 = this.aClass176_1.method4469(1, (float) local182 / 65536.0F);
				...
				while (true) {
					...
					if (local200 >= arg0 - local187) {
						while (local200 < arg0) {
							...
							Static269.anIntArray339[local200] = local352;
							this.aClass232_2.method5839(arg0 + 1);
							local200++;
						}
						break;
					}
	...
	public void method4551(@OriginalArg(0) Class2_Sub4 arg0) {
		this.aClass232_9 = new Class232();
		this.aClass232_9.method5840(arg0);
		this.aClass232_8 = new Class232();
		this.aClass232_8.method5840(arg0);
		@Pc(21) int local21 = arg0.method4814();
		if (local21 != 0) {
			arg0.anInt5300--;
			this.aClass232_1 = new Class232();
			this.aClass232_1.method5840(arg0);
			this.aClass232_6 = new Class232();
			this.aClass232_6.method5840(arg0);
		}
		local21 = arg0.method4814();
		if (local21 != 0) {
			arg0.anInt5300--;
			this.aClass232_7 = new Class232();
			this.aClass232_7.method5840(arg0);
			this.aClass232_3 = new Class232();
			this.aClass232_3.method5840(arg0);
		}
		local21 = arg0.method4814();
		if (local21 != 0) {
			arg0.anInt5300--;
			this.aClass232_4 = new Class232();
			this.aClass232_4.method5840(arg0);
			this.aClass232_5 = new Class232();
			this.aClass232_5.method5840(arg0);
		}
		for (@Pc(109) int local109 = 0; local109 < 10; local109++) {
			@Pc(114) int local114 = arg0.method4816();
			if (local114 == 0) {
				break;
			}
			this.anIntArray343[local109] = local114;
			this.anIntArray340[local109] = arg0.method4817();
			this.anIntArray341[local109] = arg0.method4816();
		}
		this.anInt4961 = arg0.method4816();
		this.anInt4962 = arg0.method4816();
		this.anInt4960 = arg0.method4828();
		this.anInt4963 = arg0.method4828();
		this.aClass176_1 = new Class176();
		this.aClass232_2 = new Class232();
		this.aClass176_1.method4467(arg0, this.aClass232_2);
	}
}
