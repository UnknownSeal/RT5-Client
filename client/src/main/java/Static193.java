...
public final class Static193 {
	...
	public static boolean method3510(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(19) int local19 = -1;
		label56: while (true) {
			@Pc(23) int local23 = local17.method4838();
			if (local23 == 0) {
				return local7;
			}
			local19 += local23;
			...
			while (true) {
				...
				while (!local33) {
					...
					@Pc(78) int local78 = local17.method4814() >> 2;
	...
	public static void method3511(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) Class130 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		arg2.method5899((Static249.aClass50_3 == Static343.aClass50_4 ? Static221.aClass79_99 : Static221.aClass79_98).method2267(Static295.anInt5581), -1, Static172.anInt3299 / 2 - 26, arg0, Static250.anInt4665 / 2);
