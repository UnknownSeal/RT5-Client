...
public final class Class2_Sub2_Sub12 extends SecondaryNode {
	...
	private void method3795(@OriginalArg(1) int arg0, @OriginalArg(2) Buffer arg1) {
		if (arg0 == 1) {
	...
	public void method3796(@OriginalArg(0) Buffer arg0) {
		while (true) {
