...
public final class Static258 {
	...
	public static void method4401(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		Static344.method5517(arg2);
	}

	@OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lclient!wm;Lclient!hp;IIIII)V")
	public static void method4402(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class11 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
					...
					if (local23 >= 0 && local23 < Static72.anInt1684) {
						for (@Pc(32) int local32 = local11; local32 <= local15; local32++) {
							if (local32 >= 0 && local32 < Static210.anInt3773 && (!local1 || local23 >= local7 || local32 >= local15 || local32 < arg4 && local23 != arg3)) {
								...
								if (local62 != null) {
									@Pc(140) int local140 = (Static365.aClass6Array4[local17].method5718(local23, local32) + Static365.aClass6Array4[local17].method5718(local23 + 1, local32) + Static365.aClass6Array4[local17].method5718(local23, local32 + 1) + Static365.aClass6Array4[local17].method5718(local23 + 1, local32 + 1)) / 4 - (Static365.aClass6Array4[arg2].method5718(arg3, arg4) + Static365.aClass6Array4[arg2].method5718(arg3 + 1, arg4) + Static365.aClass6Array4[arg2].method5718(arg3, arg4 + 1) + Static365.aClass6Array4[arg2].method5718(arg3 + 1, arg4 + 1)) / 4;
									@Pc(143) Class11_Sub1 local143 = local62.aClass11_Sub1_3;
									@Pc(146) Class11_Sub1 local146 = local62.aClass11_Sub1_2;
									if (local143 != null && local143.method6075()) {
										arg1.method6074((local23 - arg3) * Static256.anInt4716 + (1 - arg5) * Static253.anInt4693, (local32 - arg4) * Static256.anInt4716 + (1 - arg6) * Static253.anInt4693, local140, arg0, local1, local143);
									}
									if (local146 != null && local146.method6075()) {
										arg1.method6074((local23 - arg3) * Static256.anInt4716 + (1 - arg5) * Static253.anInt4693, (local32 - arg4) * Static256.anInt4716 + (1 - arg6) * Static253.anInt4693, local140, arg0, local1, local146);
									}
									for (@Pc(219) Class22 local219 = local62.aClass22_2; local219 != null; local219 = local219.aClass22_1) {
										...
										if (local223 != null && local223.method6075() && (local23 == local223.aShort103 || local23 == local3) && (local32 == local223.aShort101 || local32 == local11)) {
											@Pc(252) int local252 = local223.aShort104 + 1 - local223.aShort103;
											@Pc(260) int local260 = local223.aShort102 + 1 - local223.aShort101;
											arg1.method6074((local223.aShort103 - arg3) * Static256.anInt4716 + (local252 - arg5) * Static253.anInt4693, (local223.aShort101 - arg4) * Static256.anInt4716 + (local260 - arg6) * Static253.anInt4693, local140, arg0, local1, local223);
										}
									}
								}
							}
	...
	public static void method4403(@OriginalArg(0) String arg0) {
		if (arg0 == null) {
			return;
		}
		if (arg0.startsWith("*")) {
