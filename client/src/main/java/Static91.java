	...
	public static void method1961() {
		...
		try {
			...
			if (Static347.anInt6441 == 2) {
				...
				Static335.aClass111_4.method2797(2, Static257.aClass2_Sub4_Sub2_4.data);
			...
			if (Static347.anInt6441 == 3) {
				...
				Static335.aClass111_4.method2793(Static212.aClass2_Sub4_Sub2_3.data, 8, 0);
				...
				Static257.aClass2_Sub4_Sub2_4.p4(Static288.aClass197_70.method5077());
			...
			if (Static347.anInt6441 == 6) {
				...
				if (Static347.anInt6441 == 8) {
					...
					Static335.aClass111_4.method2793(Static212.aClass2_Sub4_Sub2_3.data, 13, 0);
					Static212.aClass2_Sub4_Sub2_3.offset = 0;
				...
				if (Static347.anInt6441 == 10) {
					if (Static212.aClass2_Sub4_Sub2_3.method4869()) {
						...
						Static335.aClass111_4.method2793(Static212.aClass2_Sub4_Sub2_3.data, 1, Static212.aClass2_Sub4_Sub2_3.offset + 2);
					}
