...
public final class Static33 {
	...
	public static void method4202(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (anInt4463 >= 100) {
			...
			@Pc(44) int local44 = Static386.method6031(local30, local36, Static355.anInt6585) - Static57.anInt1464;
	...
	public static int method4204(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if ((arg1 & 0x1) == 1) {
	...
	public static void method4206() {
		...
		for (@Pc(13) int local13 = 0; local13 < Static373.anInt7033; local13++) {
			for (@Pc(17) int local17 = 0; local17 < Static242.anInt4449; local17++) {
				if (Static81.method3666(Static330.aClass67ArrayArrayArray3, true, local13, local17, local11)) {
					local11++;
				}
				if (local11 >= 512) {
					return;
