...
public abstract class Class57 {
	...
	protected abstract void method6010(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1);
	...
	protected final void method6012() {
			...
			for (@Pc(83) int local83 = 0; local83 < 128; local83++) {
				for (@Pc(87) int local87 = 0; local87 < 128; local87++) {
					for (@Pc(91) int local91 = 0; local91 < this.anInt6721; local91++) {
						...
						@Pc(321) int local321 = Static169.method3210(local145, local129, local137, this.aShortArray127[local309 + local172]);
						@Pc(333) int local333 = Static169.method3210(local145, local279, local137, this.aShortArray127[local168 + local309]);
						@Pc(344) int local344 = local321 + (local275 * (local333 - local321) >> 12);
						@Pc(356) int local356 = Static169.method3210(local145, local129, local249, this.aShortArray127[local172 + local287]);
						@Pc(368) int local368 = Static169.method3210(local145, local279, local249, this.aShortArray127[local287 + local168]);
						@Pc(379) int local379 = ((local368 - local356) * local275 >> 12) + local356;
						@Pc(390) int local390 = (local266 * (local379 - local344) >> 12) + local344;
						@Pc(402) int local402 = Static169.method3210(local253, local129, local137, this.aShortArray127[local172 + local302]);
						@Pc(415) int local415 = Static169.method3210(local253, local279, local137, this.aShortArray127[local168 + local302]);
						@Pc(426) int local426 = (local275 * (local415 - local402) >> 12) + local402;
						@Pc(438) int local438 = Static169.method3210(local253, local129, local249, this.aShortArray127[local294 + local172]);
						@Pc(450) int local450 = Static169.method3210(local253, local279, local249, this.aShortArray127[local294 + local168]);
						@Pc(461) int local461 = (local275 * (local450 - local438) >> 12) + local438;
						@Pc(473) int local473 = local426 + (local266 * (local461 - local426) >> 12);
						this.method6010(local91, local390 + (local262 * (local473 - local390) >> 12));
					}
					this.method6016();
				}
			}
