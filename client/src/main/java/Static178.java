...
public final class Static178 {
	...
	public static Model method2340(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) SeqType arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Model arg7, @OriginalArg(8) int arg8, @OriginalArg(9) Class19 arg9, @OriginalArg(10) int arg10, @OriginalArg(11) boolean arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13) {
		if (arg7 == null) {
			return null;
		}
		@Pc(11) int local11 = 1031;
		if (arg4 != null) {
			local11 = arg4.method3989(arg0, false, -1) | 0x407;
			local11 &= 0xFFFFFDFF;
		}
		...
		@Pc(169) int local169;
		@Pc(173) int local173;
		if (local58 == null || arg9.method2863(local58.method3826(), local11) != 0) {
			if (local58 != null) {
				local11 = arg9.method2806(local11, local58.method3826());
			}
			@Pc(93) byte local93;
			if (arg5 == 1) {
				local93 = 9;
			...
			for (local169 = 0; local169 < 3; local169++) {
				...
				for (local199 = 0; local199 < local93; local199++) {
					if (local169 == 0) {
						local150.method4658(local295, local157, local250, local161[0][(local199 + 1) % local93], (byte) 1, local161[0][local199], (short) -1, (byte) -1);
					} else {
						local150.method4658(local295, local161[local169 - 1][local199], local250, local161[local169 - 1][(local199 + 1) % local93], (byte) 1, local161[local169][(local199 + 1) % local93], (short) -1, (byte) -1);
						local150.method4658(local295, local161[local169 - 1][local199], local250, local161[local169][(local199 + 1) % local93], (byte) 1, local161[local169][local199], (short) -1, (byte) -1);
					}
				}
			}
		...
		@Pc(477) int local477 = arg7.method3805();
		local163 = arg7.method3821();
		local169 = arg7.method3811();
		...
		if (local521 == null) {
			local58 = local58.method3799((byte) 3, local11, true);
			local58.method3841((local163 - local477) / 2, 128, (local173 - local169) / 2);
			local58.method3812((local477 + local163) / 2, 0, (local173 + local169) / 2);
		} else {
			local58 = local58.method3799((byte) 3, local11, true);
			local58.method3841((local163 - local477) / 2, 128, (local173 - local169) / 2);
			local58.method3812((local477 + local163) / 2, 0, (local173 + local169) / 2);
			local58.method3817(local521, arg0);
		}
		if (arg13 != 0) {
			local58.method3823(arg13);
		}
		if (arg3 != 0) {
			local58.method3814(arg3);
		}
		if (arg12 != 0) {
			local58.method3812(0, arg12, 0);
		}
		return local58;
	}
	...
	public static void method2342() {
		...
		client.musicChannel = AudioChannel.create(GameShell.signlink, GameShell.canvas, 0, 22050);
		client.musicChannel.setStream(client.musicStream);
		client.soundChannel = AudioChannel.create(GameShell.signlink, GameShell.canvas, 1, 2048);
