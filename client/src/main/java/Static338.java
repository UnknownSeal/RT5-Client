...
public final class Static338 {
	...
	public static void method6140() {
		if (Static31.aFloat28 < 1024.0F) {
			Static31.aFloat28 = 1024.0F;
		}
		while (Static277.aFloat67 >= 16384.0F) {
			Static277.aFloat67 -= 16384.0F;
		}
		if (Static31.aFloat28 > 3072.0F) {
			Static31.aFloat28 = 3072.0F;
		}
		while (Static277.aFloat67 < 0.0F) {
			Static277.aFloat67 += 16384.0F;
		}
		@Pc(46) int local46 = Static288.anInt5463 >> 7;
		@Pc(50) int local50 = Static62.anInt2395 >> 7;
		@Pc(56) int local56 = Static386.method6031(Static288.anInt5463, Static62.anInt2395, Static355.anInt6585);
		@Pc(58) int local58 = 0;
		@Pc(76) int local76;
		if (local46 > 3 && local50 > 3 && local46 < 100 && local50 < 100) {
			for (local76 = local46 - 4; local76 <= local46 + 4; local76++) {
				for (@Pc(82) int local82 = local50 - 4; local82 <= local50 + 4; local82++) {
					...
					if (local86 < 3 && Static325.method5544(local82, local76)) {
						local86++;
					}
					@Pc(99) int local99 = 0;
					...
					@Pc(132) int local132 = local99 + local56 - Static365.aClass6Array4[local86].method5718(local76, local82);
					if (local132 > local58) {
						local58 = local132;
					}
				}
