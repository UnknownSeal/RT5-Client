...
public final class Static315 {
	...
	public static void method5380() {
		Static295.aClass135_32.method3543();
		for (@Pc(13) Class2_Sub5 local13 = (Class2_Sub5) Static129.aClass135_19.method3550(); local13 != null; local13 = (Class2_Sub5) Static129.aClass135_19.method3551()) {
			if (local13.anInt1005 < 1000) {
				local13.method6467();
				Static295.aClass135_32.method3539(local13);
			}
		}
		Static295.aClass135_32.method3541(Static129.aClass135_19);
		@Pc(41) int local41 = -1;
		if (Static370.aClass2_Sub24_1 != null) {
			local41 = Static370.aClass2_Sub24_1.method5246();
		}
		if (!Static375.aBoolean477) {
			if (local41 == 0 && (Static232.anInt4087 == 1 && Static268.anInt4959 > 2 || Static208.method3709())) {
				local41 = 2;
			}
	...
	public static void method5381() {
		...
		@Pc(13) int local13 = Static212.aClass2_Sub4_Sub2_3.method4867(8);
		@Pc(18) int local18;
		...
		for (local18 = 0; local18 < local13; local18++) {
			...
			@Pc(73) int local73 = Static212.aClass2_Sub4_Sub2_3.method4867(1);
			if (local73 == 0) {
				Static211.anIntArray230[Static166.anInt3187++] = local64;
				local68.anInt4610 = Static114.anInt2348;
			} else {
				@Pc(96) int local96 = Static212.aClass2_Sub4_Sub2_3.method4867(2);
				if (local96 == 0) {
					Static211.anIntArray230[Static166.anInt3187++] = local64;
					local68.anInt4610 = Static114.anInt2348;
					...
					if (local96 == 1) {
						Static211.anIntArray230[Static166.anInt3187++] = local64;
						local68.anInt4610 = Static114.anInt2348;
						local140 = Static212.aClass2_Sub4_Sub2_3.method4867(3);
						local68.method4337(1, local140);
						local150 = Static212.aClass2_Sub4_Sub2_3.method4867(1);
						if (local150 == 1) {
							Static277.anIntArray361[Static343.anInt6390++] = local64;
						}
					} else if (local96 == 2) {
						Static211.anIntArray230[Static166.anInt3187++] = local64;
						local68.anInt4610 = Static114.anInt2348;
						if (Static212.aClass2_Sub4_Sub2_3.method4867(1) == 1) {
							local140 = Static212.aClass2_Sub4_Sub2_3.method4867(3);
							local68.method4337(2, local140);
							local150 = Static212.aClass2_Sub4_Sub2_3.method4867(3);
							local68.method4337(2, local150);
						} else {
							local140 = Static212.aClass2_Sub4_Sub2_3.method4867(3);
							local68.method4337(0, local140);
						}
						local140 = Static212.aClass2_Sub4_Sub2_3.method4867(1);
						if (local140 == 1) {
							Static277.anIntArray361[Static343.anInt6390++] = local64;
						}
					} else if (local96 == 3) {
