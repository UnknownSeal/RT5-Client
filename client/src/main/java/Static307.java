	...
	public static void method5254(@OriginalArg(0) int arg0) {
		...
		if (arg0 != -1) {
			...
			if (local29 == null) {
				...
				GameShell.signlink.method3769(local29.method1680(), new Point(local25.anInt6203, local25.anInt6200), local29.method1685(), Static21.aCanvas1, local29.method1683());
				Static29.anInt721 = arg0;
			}
		}
		if (arg0 == -1 && Static29.anInt721 != -1) {
			GameShell.signlink.method3769(-1, new Point(), null, Static21.aCanvas1, -1);
			Static29.anInt721 = -1;
		}
	}
