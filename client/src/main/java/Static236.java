...
public final class Static236 {
	...
	public static void method4101(@OriginalArg(0) Class197 arg0, @OriginalArg(1) Class197 arg1, @OriginalArg(2) Class19 arg2) {
	...
	public static void method4111() {
		for (@Pc(7) int local7 = 0; local7 < Static343.anInt6390; local7++) {
			...
			@Pc(29) int local29 = Static212.aClass2_Sub4_Sub2_3.method4814();
			if ((local29 & 0x40) != 0) {
				local29 += Static212.aClass2_Sub4_Sub2_3.method4814() << 8;
			}
			@Pc(55) int local55;
			if ((local29 & 0x400) != 0) {
				local55 = Static212.aClass2_Sub4_Sub2_3.method4805();
				local25.anInt4578 = Static212.aClass2_Sub4_Sub2_3.method4810();
				local25.anInt4591 = Static212.aClass2_Sub4_Sub2_3.method4810();
			...
			@Pc(107) int local107;
			if ((local29 & 0x2) != 0) {
				local55 = Static212.aClass2_Sub4_Sub2_3.method4816();
				local107 = Static212.aClass2_Sub4_Sub2_3.method4803();
				local25.method4333(local107, local55, Static114.anInt2348);
				local25.anInt4606 = Static114.anInt2348 + 300;
				local25.anInt4631 = Static212.aClass2_Sub4_Sub2_3.method4814();
			}
			if ((local29 & 0x8) != 0) {
				local55 = Static212.aClass2_Sub4_Sub2_3.method4828();
				if (local55 == 65535) {
					local55 = -1;
				}
				local107 = Static212.aClass2_Sub4_Sub2_3.method4810();
				Static307.method5255(local55, local25, local107);
			}
			if ((local29 & 0x80) != 0) {
				local25.aString50 = Static212.aClass2_Sub4_Sub2_3.method4808();
				local25.anInt4636 = 100;
			}
			@Pc(224) int local224;
			if ((local29 & 0x4) != 0) {
				local55 = Static212.aClass2_Sub4_Sub2_3.method4852();
				local107 = Static212.aClass2_Sub4_Sub2_3.method4843();
				if (local55 == 65535) {
					local55 = -1;
				}
			...
			if ((local29 & 0x20) != 0) {
				local25.anInt4611 = Static212.aClass2_Sub4_Sub2_3.method4828();
			...
			if ((local29 & 0x100) != 0) {
				local55 = Static212.aClass2_Sub4_Sub2_3.method4810();
				...
				for (@Pc(419) int local419 = 0; local419 < local55; local419++) {
					local224 = Static212.aClass2_Sub4_Sub2_3.method4805();
					if (local224 == 65535) {
						local224 = -1;
					}
					local411[local419] = local224;
					local414[local419] = Static212.aClass2_Sub4_Sub2_3.method4803();
					local417[local419] = Static212.aClass2_Sub4_Sub2_3.method4828();
				}
				Static92.method1966(local411, local417, local25, local414);
			}
			if ((local29 & 0x200) != 0) {
				local25.anInt4663 = Static212.aClass2_Sub4_Sub2_3.method4828();
				local25.anInt4657 = Static212.aClass2_Sub4_Sub2_3.method4802();
			}
			if ((local29 & 0x10) != 0) {
				if (local25.aClass71_1.method2099()) {
					Static154.method2781(local25);
				}
				local25.method4341(Static6.aClass219_1.method5569(Static212.aClass2_Sub4_Sub2_3.method4802()));
