...
public final class Class2_Sub3_Sub20 extends Class2_Sub3 {
	...
	public int[][] method6478(@OriginalArg(0) int arg0) {
		@Pc(19) int[][] local19 = super.aClass243_41.method6276(arg0);
		if (super.aClass243_41.aBoolean478) {
			@Pc(29) int[] local29 = this.method6472(0, arg0);
	...
	public void method6483(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		...
		@Pc(10) int local10 = arg1.method4814();
		if (local10 != 0) {
			this.method3502(local10);
			return;
		}
		this.anIntArrayArray26 = new int[arg1.method4814()][4];
		for (@Pc(21) int local21 = 0; local21 < this.anIntArrayArray26.length; local21++) {
			this.anIntArrayArray26[local21][0] = arg1.method4828();
			this.anIntArrayArray26[local21][1] = arg1.method4814() << 4;
			this.anIntArrayArray26[local21][2] = arg1.method4814() << 4;
			this.anIntArrayArray26[local21][3] = arg1.method4814() << 4;
		}
	}

	@OriginalMember(owner = "client!kt", name = "c", descriptor = "(IB)V")
	private void method3502(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			return;
		}
		if (arg0 == 1) {
