...
public final class Class29_Sub1 extends Class29 {
	...
	public void method1100(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class19 arg3, @OriginalArg(4) Buffer arg4) {
		...
		while (true) {
			...
			@Pc(140) int local140;
			@Pc(496) int local496;
			while (arg4.offset < arg4.bytes.length) {
				local24 = arg4.g1();
				if (local24 == 0) {
						...
						if (local118 > 0) {
							for (local496 = 0; local496 < local118; local496++) {
								...
								if (local503.anInt4376 == 31) {
									@Pc(516) Class66 local516 = Static90.aClass190_3.method4877(arg4.g2());
		...
		while (true) {
			while (true) {
				while (true) {
					...
					@Pc(404) int local404;
					@Pc(153) int local153;
					while (arg0.bytes.length > arg0.offset) {
						local36 = arg0.g1();
						if (local36 == 0) {
								...
								if (local117 > 0) {
									for (local404 = 0; local404 < local117; local404++) {
										...
										if (local411.anInt4376 == 31) {
											@Pc(422) Class66 local422 = Static90.aClass190_3.method4877(arg0.g2());
	...
	public void method1105(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class19 arg6, @OriginalArg(8) CollisionMap arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		@Pc(30) Class41 local30 = LocTypeList.locTypeList.method5162(arg3);
						...
						if (arg8 == 1) {
							...
							if (arg8 == 4) {
								...
								if (arg8 == 5) {
									...
									if (local1899 != null) {
										local1893 = LocTypeList.locTypeList.method5162(local1899.method6084()).anInt1340;
									}
									if (local220) {
									...
									local1899 = (Interface6) Static12.method283(arg5, arg1, arg2);
									if (local1899 != null) {
										local1893 = LocTypeList.locTypeList.method5162(local1899.method6084()).anInt1340 / 2;
									}
									if (local220) {
									...
									if (local2210 != null) {
										local2204 = LocTypeList.locTypeList.method5162(local2210.method6084()).anInt1340 / 2;
									}
	...
	public void method1107(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[] arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class19 arg6, @OriginalArg(8) CollisionMap[] arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		while (true) {
			...
			@Pc(28) int local28 = 0;
			while (true) {
				@Pc(32) int local32 = local14.gsmarts();
				if (local32 == 0) {
					break;
				}
				local28 += local32 - 1;
				...
				if (arg1 == local54 && local50 >= arg3 && arg3 + 8 > local50 && arg9 <= local44 && arg9 + 8 > local44) {
					@Pc(98) Class41 local98 = LocTypeList.locTypeList.method5162(local16);
	...
	public void method1108(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) CollisionMap arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) Class19 arg5) {
		...
		@Pc(70) Class41 local70 = LocTypeList.locTypeList.method5162(local7.method6084());
	...
	public void method1109(@OriginalArg(0) CollisionMap[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class19 arg4) {
		...
		while (true) {
			...
			@Pc(31) int local31 = 0;
			while (true) {
				@Pc(35) int local35 = local10.gsmarts();
				if (local35 == 0) {
					break;
				}
				local31 += local35 - 1;
