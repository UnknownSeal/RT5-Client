...
public final class Class2_Sub2_Sub3 extends Class2_Sub2 {
	...
	private void method1342(@OriginalArg(1) Class2_Sub4 arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(23) int local23 = arg0.method4814();
		@Pc(30) int local30;
		...
		for (local30 = 0; local30 < local23; local30++) {
			@Pc(49) boolean local49 = arg0.method4814() == 1;
			@Pc(53) int local53 = arg0.method4832();
			@Pc(62) Class2 local62;
			if (local49) {
				local62 = new Class2_Sub40(arg0.method4808());
			} else {
				local62 = new Class2_Sub39(arg0.method4835());
			}
