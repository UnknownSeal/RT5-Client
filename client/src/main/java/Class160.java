...
public final class Class160 {
	...
	private final Js5 aJs5_62;

	@OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;)V")
	public Class160(@OriginalArg(0) GameType arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Js5 arg2) {
		this.aJs5_62 = arg2;
		this.aJs5_62.getGroupCapacity(30);
	}
	...
	public Class101 method4030(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aSoftLruHashTable_35) {
			local16 = (Class101) this.aSoftLruHashTable_35.get((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		...
		synchronized (this.aSoftLruHashTable_35) {
			this.aSoftLruHashTable_35.put((long) arg0, local16);
			return local16;
		}
	}
	...
	public void method4032() {
		...
		synchronized (this.aSoftLruHashTable_35) {
			this.aSoftLruHashTable_35.clear();
		}
	}
}
