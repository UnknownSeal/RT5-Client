...
public final class Static239 {
	...
	public static int[] anIntArray284 = new int[2048];

	@OriginalMember(owner = "client!nn", name = "U", descriptor = "Lclient!gd;")
	public static Class79 aClass79_95 = new Class79("Drop", "Fallen lassen", "Poser", "Largar");

	@OriginalMember(owner = "client!nn", name = "V", descriptor = "Lclient!mc;")
	public static Class145 aClass145_158 = new Class145(78, 5);
