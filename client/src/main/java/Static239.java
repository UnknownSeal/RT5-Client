...
public final class Static239 {
	...
	public static void method4151(@OriginalArg(1) boolean arg0) {
		for (@Pc(12) AreaSound local12 = (AreaSound) Static83.A_LINKED_LIST___14.head(); local12 != null; local12 = (AreaSound) Static83.A_LINKED_LIST___14.next()) {
			if (local12.primarySystem != null) {
				client.soundStream.method2081(local12.primarySystem);
				local12.primarySystem = null;
			}
		...
		for (@Pc(55) AreaSound local55 = (AreaSound) Static363.npcSounds.head(); local55 != null; local55 = (AreaSound) Static363.npcSounds.next()) {
			if (local55.primarySystem != null) {
				client.soundStream.method2081(local55.primarySystem);
				local55.primarySystem = null;
			}
			local55.unlink();
		}
		for (@Pc(82) AreaSound local82 = (AreaSound) Static232.aClass4_86.head(); local82 != null; local82 = (AreaSound) Static232.aClass4_86.next()) {
			if (local82.primarySystem != null) {
				client.soundStream.method2081(local82.primarySystem);
				local82.primarySystem = null;
			}
			local82.unlink();
		}
	}
