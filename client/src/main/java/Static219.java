...
public final class Static219 {
	...
	public static Class2_Sub4_Sub1 aClass2_Sub4_Sub1_3 = new Class2_Sub4_Sub1(8192);
	...
	public static float[] method3852(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) float arg5, @OriginalArg(7) float arg6) {
	...
	public static float[] method3859(@OriginalArg(0) int arg0, @OriginalArg(1) float[] arg1) {
		@Pc(8) float[] local8 = new float[arg0];
		Static403.method4603(arg1, 0, local8, 0, arg0);
		return local8;
	}

	@OriginalMember(owner = "client!mp", name = "a", descriptor = "(II[S)[S")
	public static short[] method3861(@OriginalArg(1) int arg0, @OriginalArg(2) short[] arg1) {
		@Pc(2) short[] local2 = new short[arg0];
		Static403.method4605(arg1, 0, local2, 0, arg0);
		return local2;
	}

	@OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIBIIIFI[FI)V")
	public static void method3863(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) float arg5, @OriginalArg(7) int arg6, @OriginalArg(8) float[] arg7, @OriginalArg(9) int arg8) {
	...
	public static int method3866(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	public static void method3868(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
