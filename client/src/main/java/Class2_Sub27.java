...
public final class Class2_Sub27 extends Class2 {
	...
	private float[] method4514(@OriginalArg(0) int arg0) {
		...
		@Pc(140) boolean local140 = !Static267.aClass238Array1[local131].method6060();
		...
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2388; local144++) {
			...
			local152.method4676(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			...
			Static267.aClass238Array1[local176].method6056(Static267.aFloatArray23, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
	...
	private void method4515(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub4 local4 = new Class2_Sub4(arg0);
		this.anInt4927 = local4.method4835();
		this.anInt4920 = local4.method4835();
		this.anInt4921 = local4.method4835();
		this.anInt4918 = local4.method4835();
		if (this.anInt4918 < 0) {
			this.anInt4918 = ~this.anInt4918;
			this.aBoolean369 = true;
		}
		@Pc(40) int local40 = local4.method4835();
		this.aByteArrayArray14 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4814();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4798(local64, local49);
	...
	public Class2_Sub21_Sub1 method4518(@OriginalArg(0) int[] arg0) {
		...
		while (this.anInt4929 < this.aByteArrayArray14.length) {
			...
			@Pc(42) float[] local42 = this.method4514(this.anInt4929);
			if (local42 != null) {
