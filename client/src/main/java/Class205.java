...
public final class Class205 {
	...
	public void method5213(@OriginalArg(0) long arg0) throws IOException {
		if (arg0 < 0L) {
			throw new IOException("Invalid seek to " + arg0 + " in file " + this.method5216());
		}
		this.aLong168 = arg0;
	}
	...
	public void method5214(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int arg2) throws IOException {
		try {
			...
			if (this.aLong171 != -1L && this.aLong171 + (long) this.aByteArray74.length < this.aLong168 + (long) arg2) {
				...
				Static403.method4606(arg1, arg0, this.aByteArray74, (int) (this.aLong168 - this.aLong171), local92);
				arg0 += local92;
				arg2 -= local92;
			...
			if (arg2 > this.aByteArray74.length) {
				if (this.aLong168 != this.aLong169) {
					this.aClass204_4.method5196(this.aLong168);
				...
				if (local181 > -1L && local183 > local181) {
					...
					Static403.method4606(arg1, (int) ((long) arg0 + local181 - this.aLong168), this.aByteArray75, (int) (local181 - this.aLong170), local319);
				}
				this.aLong168 += arg2;
			} else if (arg2 > 0) {
				if (this.aLong171 == -1L) {
				...
				Static403.method4606(arg1, arg0, this.aByteArray74, (int) (this.aLong168 - this.aLong171), arg2);
				this.aLong168 += arg2;
	...
	private void method5215() throws IOException {
		...
		while (this.anInt5728 < this.aByteArray75.length) {
			...
			@Pc(66) int local66 = this.aClass204_4.method5193(local49, this.anInt5728, this.aByteArray75);
			if (local66 == -1) {
				break;
			}
	...
	private void method5218() throws IOException {
		...
		if (this.aLong169 != this.aLong171) {
			this.aClass204_4.method5196(this.aLong171);
		...
		if (local64 > -1L && local66 > local64) {
			...
			Static403.method4606(this.aByteArray74, (int) (local64 - this.aLong171), this.aByteArray75, (int) (local64 - this.aLong170), local199);
		}
		this.aLong171 = -1L;
		this.anInt5724 = 0;
	}
	...
	public void method5219(@OriginalArg(0) byte[] arg0) throws IOException {
		this.method5221(arg0, 0, arg0.length);
	}

	@OriginalMember(owner = "client!rn", name = "a", descriptor = "([BZII)V")
	public void method5221(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) throws IOException {
		try {
			if (arg0.length < arg2) {
			...
			if (this.aLong171 != -1L && this.aLong168 >= this.aLong171 && this.aLong168 + (long) arg2 <= this.aLong171 + (long) this.anInt5724) {
				Static403.method4606(this.aByteArray74, (int) (this.aLong168 - this.aLong171), arg0, 0, arg2);
				this.aLong168 += arg2;
				return;
			}
			...
			if (this.aLong168 >= this.aLong170 && this.aLong168 < this.aLong170 + (long) this.anInt5728) {
				...
				Static403.method4606(this.aByteArray75, (int) (this.aLong168 - this.aLong170), arg0, 0, local119);
				arg1 = local119;
			...
			if (this.aByteArray75.length < arg2) {
				...
				this.aLong169 = this.aLong168;
				while (arg2 > 0) {
					local119 = this.aClass204_4.method5193(arg2, arg1, arg0);
					if (local119 == -1) {
						break;
					}
					this.aLong168 += local119;
				...
				Static403.method4606(this.aByteArray75, 0, arg0, arg1, local119);
				arg1 += local119;
				this.aLong168 += local119;
				arg2 -= local119;
			}
			if (this.aLong171 != -1L) {
				...
				if (local307 > -1L && local307 < local309) {
					...
					Static403.method4606(this.aByteArray74, (int) (local307 - this.aLong171), arg0, (int) (local307 - local86), local431);
