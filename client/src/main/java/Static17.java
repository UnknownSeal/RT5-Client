	...
	public static void method4209(@OriginalArg(1) boolean arg0) {
		while (true) {
			if (Static212.aClass2_Sub4_Sub2_3.method4872(Static82.anInt1836) >= 15) {
				@Pc(16) int local16 = Static212.aClass2_Sub4_Sub2_3.method4867(15);
				if (local16 != 32767) {
					...
					@Pc(71) int local71;
					if (arg0) {
						local71 = Static212.aClass2_Sub4_Sub2_3.method4867(8);
						if (local71 > 127) {
							local71 -= 256;
						}
					} else {
						local71 = Static212.aClass2_Sub4_Sub2_3.method4867(5);
						if (local71 > 15) {
							local71 -= 32;
						}
					}
					@Pc(97) int local97;
					if (arg0) {
						local97 = Static212.aClass2_Sub4_Sub2_3.method4867(8);
						if (local97 > 127) {
							local97 -= 256;
						}
					} else {
						local97 = Static212.aClass2_Sub4_Sub2_3.method4867(5);
						if (local97 > 15) {
							local97 -= 32;
						}
					}
					@Pc(119) int local119 = Static212.aClass2_Sub4_Sub2_3.method4867(1);
					if (local119 == 1) {
						Static277.anIntArray361[Static343.anInt6390++] = local16;
					}
					local42.method4341(Static6.aClass219_1.method5569(Static212.aClass2_Sub4_Sub2_3.method4867(14)));
					@Pc(151) int local151 = Static212.aClass2_Sub4_Sub2_3.method4867(3) + 4 << 11 & 0x3929;
					@Pc(156) int local156 = Static212.aClass2_Sub4_Sub2_3.method4867(2);
					@Pc(161) int local161 = Static212.aClass2_Sub4_Sub2_3.method4867(1);
