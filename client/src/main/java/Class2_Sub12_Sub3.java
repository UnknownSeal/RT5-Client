...
public final class Class2_Sub12_Sub3 extends Class2_Sub12 {
	...
	public Class2_Sub12_Sub3() {
		this.method4300();
		this.method4287(true);
	}

	@OriginalMember(owner = "client!od", name = "b", descriptor = "(B)Z")
	public synchronized boolean method4269() {
		return this.aClass118_1.method3198();
	}

	@OriginalMember(owner = "client!od", name = "c", descriptor = "(I)V")
	public synchronized void method4270() {
		for (@Pc(11) Class2_Sub25 local11 = (Class2_Sub25) this.aClass4_92.head(); local11 != null; local11 = (Class2_Sub25) this.aClass4_92.next()) {
			local11.method4012();
		}
	}
	...
	@Override
	public synchronized Class2_Sub12 method4971() {
		return null;
	}

	@OriginalMember(owner = "client!od", name = "a", descriptor = "(IZLclient!ej;)V")
	public void method4271(@OriginalArg(1) boolean arg0, @OriginalArg(2) Class2_Sub11 arg1) {
	...
	public boolean method4274(@OriginalArg(1) Class2_Sub11 arg0) {
	...
	public synchronized void method4275() {
		for (@Pc(7) Class2_Sub25 local7 = (Class2_Sub25) this.aClass4_92.head(); local7 != null; local7 = (Class2_Sub25) this.aClass4_92.next()) {
			local7.unlink();
		}
	}

	@OriginalMember(owner = "client!od", name = "a", descriptor = "(IZI[ILclient!ej;)Z")
	public boolean method4276(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) Class2_Sub11 arg3) {
		...
		arg3.aClass2_Sub12_Sub4_1.method4990(this.method4293(arg3));
		...
		if (!local99) {
			arg3.aClass2_Sub12_Sub4_1.method4993(arg3.anInt1780, this.method4297(arg3), this.method4291(arg3));
			return false;
		}
		arg3.aClass2_Sub12_Sub4_1.method4989(arg3.anInt1780);
		if (arg2 == null) {
			arg3.aClass2_Sub12_Sub4_1.method4973(arg0);
		} else {
			arg3.aClass2_Sub12_Sub4_1.method4972(arg2, arg1, arg0);
		}
		if (arg3.aClass2_Sub12_Sub4_1.method4988()) {
	...
	public synchronized void method4277(@OriginalArg(0) int arg0) {
		this.anInt4548 = arg0;
	}
	...
	private void method4278(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		for (@Pc(41) Class2_Sub11 local41 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.head(); local41 != null; local41 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.next()) {
	...
	public synchronized void method4973(@OriginalArg(0) int arg0) {
		if (this.aClass118_1.method3198()) {
			@Pc(12) int local12 = this.anInt4540 * this.aClass118_1.anInt3194 / Static356.anInt6643;
			do {
				...
				this.aClass2_Sub12_Sub1_1.method4973(local51);
				arg0 -= local51;
				this.method4288();
			} while (this.aClass118_1.method3198());
		}
		this.aClass2_Sub12_Sub1_1.method4973(arg0);
	}
	...
	public synchronized void method4972(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aClass118_1.method3198()) {
			@Pc(14) int local14 = this.anInt4540 * this.aClass118_1.anInt3194 / Static356.anInt6643;
			do {
				...
				this.aClass2_Sub12_Sub1_1.method4972(arg0, arg1, local53);
				arg1 += local53;
				this.method4288();
				arg2 -= local53;
			} while (this.aClass118_1.method3198());
		}
		this.aClass2_Sub12_Sub1_1.method4972(arg0, arg1, arg2);
	}
	...
	private synchronized void method4282(@OriginalArg(1) boolean arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) Class2_Sub34 arg2) {
		...
		this.aClass118_1.method3202(arg2.aByteArray77);
		this.aBoolean314 = arg1;
		this.aLong136 = 0L;
		@Pc(29) int local29 = this.aClass118_1.method3192();
		for (@Pc(31) int local31 = 0; local31 < local29; local31++) {
			this.aClass118_1.method3205(local31);
			this.aClass118_1.method3194(local31);
			this.aClass118_1.method3191(local31);
		}
		this.anInt4565 = this.aClass118_1.method3197();
		this.anInt4566 = this.aClass118_1.anIntArray195[this.anInt4565];
		this.aLong135 = this.aClass118_1.method3199(this.anInt4566);
	}
	...
	private void method4285(@OriginalArg(0) int arg0) {
		for (@Pc(6) Class2_Sub11 local6 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.head(); local6 != null; local6 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.next()) {
			if (arg0 < 0 || arg0 == local6.anInt1793) {
				if (local6.aClass2_Sub12_Sub4_1 != null) {
					...
					if (local6.aClass2_Sub12_Sub4_1.method4988()) {
	...
	private void method4286(@OriginalArg(0) int arg0) {
		...
		for (@Pc(13) Class2_Sub11 local13 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.head(); local13 != null; local13 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.next()) {
	...
	private void method4287(@OriginalArg(0) boolean arg0) {
		if (arg0) {
			this.method4285(-1);
		} else {
			this.method4296(-1);
	...
	private void method4288() {
		...
		if (this.aClass2_Sub34_2 != null && local9 == this.anInt4567) {
			this.method4282(this.aBoolean315, this.aBoolean314, this.aClass2_Sub34_2);
			this.method4288();
			return;
		}
		while (this.anInt4566 == local9) {
			while (local9 == this.aClass118_1.anIntArray195[local6]) {
				this.aClass118_1.method3205(local6);
				@Pc(45) int local45 = this.aClass118_1.method3204(local6);
				if (local45 == 1) {
					this.aClass118_1.method3193();
					this.aClass118_1.method3191(local6);
					if (this.aClass118_1.method3195()) {
						if (this.aClass2_Sub34_2 != null) {
							this.method4272(this.aClass2_Sub34_2, this.aBoolean314);
							this.method4288();
							return;
						}
						if (!this.aBoolean314 || local9 == 0) {
							this.method4287(true);
							this.aClass118_1.method3206();
							return;
						}
						this.aClass118_1.method3203(local12);
					}
					break;
				}
				if ((local45 & 0x80) != 0) {
				...
				this.aClass118_1.method3194(local6);
				this.aClass118_1.method3191(local6);
			}
			local6 = this.aClass118_1.method3197();
			local9 = this.aClass118_1.anIntArray195[local6];
			local12 = this.aClass118_1.method3199(local9);
		}
	...
	private void method4289(@OriginalArg(0) int arg0) {
		...
		if (local7 == 128) {
			...
			local14 = arg0 & 0xF;
			local20 = arg0 >> 8 & 0x7F;
			this.method4290(local20 + this.anIntArray309[local14], local14);
		} else if (local7 == 208) {
			local14 = arg0 & 0xF;
			local20 = arg0 >> 8 & 0x7F;
	...
	private void method4290(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	private int method4291(@OriginalArg(0) Class2_Sub11 arg0) {
	...
	private synchronized void method4292(@OriginalArg(1) boolean arg0) {
		this.aClass118_1.method3206();
	...
	private int method4293(@OriginalArg(0) Class2_Sub11 arg0) {
		...
		local63 = (int) ((double) (arg0.aClass2_Sub21_Sub1_1.anInt3176 * 256) * Math.pow(2.0D, (double) local14 * 3.255208333333333E-4D) / (double) Static356.anInt6643 + 0.5D);
	...
	public synchronized void method4295() {
		this.method4303();
	}

	@OriginalMember(owner = "client!od", name = "b", descriptor = "(IZ)V")
	private void method4296(@OriginalArg(0) int arg0) {
		for (@Pc(10) Class2_Sub11 local10 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.head(); local10 != null; local10 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.next()) {
	...
	@Override
	public synchronized Class2_Sub12 method4977() {
	...
	private int method4297(@OriginalArg(1) Class2_Sub11 arg0) {
	...
	private void method4299(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		if (this.anIntArray297[arg0] == 0) {
			local120.aClass2_Sub12_Sub4_1 = Static405.method4997(local113, this.method4293(local120), this.method4297(local120), this.method4291(local120));
		} else {
			local120.aClass2_Sub12_Sub4_1 = Static405.method4997(local113, this.method4293(local120), 0, this.method4291(local120));
			this.method4271(local105.aShortArray90[arg1] < 0, local120);
		}
		if (local105.aShortArray90[arg1] < 0) {
			local120.aClass2_Sub12_Sub4_1.method4983(-1);
		}
		...
		this.aClass2_Sub12_Sub1_1.aLinkedList_15.addTail(local120);
	...
	private void method4304(@OriginalArg(1) int arg0) {
		...
		for (@Pc(17) Class2_Sub11 local17 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.head(); local17 != null; local17 = (Class2_Sub11) this.aClass2_Sub12_Sub1_1.aLinkedList_15.next()) {
