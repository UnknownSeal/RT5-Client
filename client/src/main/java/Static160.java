...
public final class Static160 {
	...
	public static boolean method2952(@OriginalArg(0) boolean arg0) {
		for (@Pc(1) int local1 = Static66.anInt1624; local1 < Static92.anInt1914; local1++) {
			@Pc(6) Class67[][] local6 = Static330.aClass67ArrayArrayArray3[local1];
			for (@Pc(9) int local9 = -Static212.anInt3788; local9 <= 0; local9++) {
				...
				if (local14 >= Static162.anInt2960 || local18 < Static221.anInt4637) {
					for (@Pc(27) int local27 = -Static212.anInt3788; local27 <= 0; local27++) {
						...
						if (local14 >= Static162.anInt2960) {
							if (local32 >= Static222.anInt3949) {
								...
								if (local48 != null && local48.aBoolean138) {
									...
									Static163.aClass15_1.method1583(local48);
						...
						if (Static386.anInt6737 == 0) {
							if (Static161.aBoolean208) {
								Static163.aClass15_1.method1578(24);
							}
							return true;
						}
					}
	...
	public static Class19 method2954(@OriginalArg(0) Canvas arg0, @OriginalArg(1) SignLink arg1, @OriginalArg(3) Interface2 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		try {
			@Pc(6) Class local6 = Class.forName("Class19_Sub1");
			@Pc(58) Constructor local58 = local6.getConstructor(Canvas.class, Interface2.class, Integer.TYPE, Integer.TYPE, SignLink.class);
	...
	public static void method2956(@OriginalArg(1) int arg0) {
