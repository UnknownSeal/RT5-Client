...
public final class Class123_Sub1 extends Class123 implements KeyListener, FocusListener {
	...
	public synchronized void keyTyped(@OriginalArg(0) KeyEvent arg0) {
		...
		if (local6 != '\u0000' && Static84.method1908(local6)) {
			this.method3344(local6, -1, 2);
			arg0.consume();
		}
	}

	@OriginalMember(owner = "client!ke", name = "a", descriptor = "(BCII)V")
	private void method3344(@OriginalArg(1) char arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public synchronized void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		this.method3347(arg0, 0);
	}

	@OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;II)V")
	private void method3347(@OriginalArg(0) KeyEvent arg0, @OriginalArg(1) int arg1) {
	...
	private void method3349(@OriginalArg(0) Component arg0) {
		this.method3350();
