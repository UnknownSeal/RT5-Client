...
public final class Class241 {
	...
	public Class241(@OriginalArg(2) Js5 arg2) {
		this.aJs5_93 = arg2;
		this.aJs5_93.getGroupCapacity(1);
	}
	...
	public void method6269() {
		...
		synchronized (this.aSoftLruHashTable_64) {
			this.aSoftLruHashTable_64.clear();
		}
	}
	...
	public Class225 method6270(@OriginalArg(1) int arg0) {
		...
		synchronized (this.aSoftLruHashTable_64) {
			local16 = (Class225) this.aSoftLruHashTable_64.get((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		@Pc(33) byte[] local33 = this.aJs5_93.fetchFile(1, arg0);
		...
		synchronized (this.aSoftLruHashTable_64) {
			this.aSoftLruHashTable_64.put((long) arg0, local16);
			return local16;
		}
	}
}
