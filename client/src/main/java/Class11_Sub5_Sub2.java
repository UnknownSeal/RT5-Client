...
public abstract class Class11_Sub5_Sub2 extends Class11_Sub5 {
	...
	@OriginalMember(owner = "client!mr", name = "M", descriptor = "[Lclient!bg;")
	...
	@OriginalMember(owner = "client!mr", name = "cb", descriptor = "Lclient!wn;")
	public final Class248 aClass248_7 = new Class248();

	@OriginalMember(owner = "client!mr", name = "Yb", descriptor = "Lclient!wn;")
	private final Class248 aClass248_8 = new Class248();

	@OriginalMember(owner = "client!mr", name = "Zb", descriptor = "Lclient!wn;")
	...
	protected final void method4319(@OriginalArg(1) Class31 arg0) {
		...
		@Pc(20) int local20 = arg0.method3801() / 2;
		arg0.method3812(0, -local20, 0);
		arg0.method3814(local7 & 0x3FFF);
		arg0.method3823(local11 & 0x3FFF);
		arg0.method3812(0, local20, 0);
	}

	@OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIIZ)V")
	protected final void method4320(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(27) int local27 = Class19.anIntArray177[arg2];
		...
		@Pc(79) int local79 = Static210.method3718(local19, super.aByte78, local11, local53 + super.anInt6781, local64 + super.anInt6783);
		...
		@Pc(125) int local125 = Static210.method3718(local19, super.aByte78, local11, super.anInt6781 + local98, local109 + super.anInt6783);
		...
		@Pc(172) int local172 = Static210.method3718(local19, super.aByte78, local11, super.anInt6781 + local145, super.anInt6783 - -local155);
		...
		@Pc(218) int local218 = Static210.method3718(local19, super.aByte78, local11, super.anInt6781 + local190, super.anInt6783 - -local201);
	...
	public final void method6077() {
		...
		if (this.aBoolean318) {
			@Pc(65) int local65 = this.aClass248_7.method6440();
	...
	public abstract int method4323();

	@OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)V")
	public final void method4324(@OriginalArg(0) int arg0) {
		this.aClass248_7.method6439();
	...
	public final int method4326() {
		...
		if (local9.anInt6266 == 0) {
			local30 = this.aClass248_7.method6442(this.anInt4616, this.anInt4604, this.anInt4604);
		} else {
			local30 = this.aClass248_7.method6442(this.anInt4616, local9.anInt6266, local9.anInt6300);
		}
		@Pc(49) int local49 = this.aClass248_7.anInt7197 - local13;
		if (local49 == 0) {
			this.anInt4605 = 0;
			this.aClass248_7.method6441(this.anInt4616);
		} else {
			this.anInt4605++;
		}
		if (local30) {
			if (local9.anInt6302 != 0) {
				if (local49 > 0) {
					this.aClass248_8.method6442(local9.anInt6281, local9.anInt6302, local9.anInt6278);
				} else {
					this.aClass248_8.method6442(-local9.anInt6281, local9.anInt6302, local9.anInt6278);
				}
			}
			if (local9.anInt6303 != 0) {
				this.aClass248_9.method6442(local9.anInt6283, local9.anInt6303, local9.anInt6280);
			}
		} else {
			if (local9.anInt6302 == 0) {
				this.aClass248_8.method6441(0);
			} else {
				this.aClass248_8.method6442(0, local9.anInt6302, local9.anInt6278);
			}
			if (local9.anInt6303 == 0) {
				this.aClass248_9.method6441(0);
			} else {
				this.aClass248_9.method6442(0, local9.anInt6303, local9.anInt6280);
			}
		}
		return local49;
	}
	...
	protected abstract int method4328();

	@OriginalMember(owner = "client!mr", name = "b", descriptor = "(II)V")
	public final void method4329(@OriginalArg(0) int arg0) {
			...
			if (local15 != null) {
				...
				if (this.aClass12_Sub5_3 != null) {
					...
					if (local29 == null) {
						...
						Static403.method4608(local24, 0, local78, 0, local24.length);
						Static403.method4608(local29, 0, local78, local24.length, local29.length);
					}
	...
	public final void method4333(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
