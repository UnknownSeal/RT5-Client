...
public final class Class226 implements Interface11 {
	...
	public void method5778(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		local24 <<= local14;
		this.method5779(local11, this.anIntArray430[local11] & ~local24 | local24 & arg1 << local14);
	}
	...
	public void method5779(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		if (local16 == null) {
			local16 = new Class2_Sub35(Static204.method3684() + 500L);
			this.aClass4_132.method87(local16, (long) arg0);
		} else {
			local16.aLong183 = Static204.method3684() + 500L;
		}
	}
	...
	public int method5782(@OriginalArg(1) boolean arg0) {
		@Pc(13) long local13 = Static204.method3684();
	...
	@Override
	public int method5776(@OriginalArg(1) int arg0) {
	...
	public void method5784(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		if (local24 == null) {
			...
			local24.aLong183 = Static204.method3684() + 500L | 0x4000000000000000L;
			return;
		}
	}
	...
	public void method5785(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		local28 <<= local14;
		this.method5784(this.anIntArray431[local11] & ~local28 | arg1 << local14 & local28, local11);
	}
}
