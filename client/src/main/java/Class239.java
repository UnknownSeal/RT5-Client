...
public final class Class239 {
	...
	public int method6118(@OriginalArg(1) String[] arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) Class13[] arg3) {
		if (arg1 == null) {
			return 0;
		}
		@Pc(11) int local11 = 0;
		...
		for (@Pc(38) int local38 = 0; local38 < local36; local38++) {
			...
			if (local48 == 60) {
				...
				if (local29 == -1) {
					local70 = local38;
					local50 = this.method6121(local48);
					...
					if (local77.equals("lt")) {
						...
						try {
							@Pc(286) int local286 = Static146.parseInt(local77.substring(4));
							local31 = -1;
							local50 = arg3[local286].method6398();
	...
	public int method6120(@OriginalArg(1) String arg0, @OriginalArg(3) Class13[] arg1) {
		@Pc(4) int local4 = this.anInt6841;
		@Pc(21) int local21 = this.method6118(Static112.aStringArray18, arg0, new int[] { 100 }, arg1);
	...
	public int method6121(@OriginalArg(1) int arg0) {
		return this.aByteArray98[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLjava/lang/String;I[Lclient!jd;)I")
	public int method6122(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class13[] arg2) {
		return this.method6118(Static112.aStringArray18, arg0, new int[] { arg1 }, arg2);
	}

	@OriginalMember(owner = "client!vi", name = "a", descriptor = "([Lclient!jd;Ljava/lang/String;BI)I")
	public int method6123(@OriginalArg(0) Class13[] arg0, @OriginalArg(1) String arg1, @OriginalArg(3) int arg2) {
		@Pc(18) int local18 = this.method6118(Static112.aStringArray18, arg1, new int[] { arg2 }, arg0);
		@Pc(20) int local20 = 0;
		for (@Pc(22) int local22 = 0; local22 < local18; local22++) {
			@Pc(40) int local40 = this.method6126(arg0, Static112.aStringArray18[local22]);
			if (local20 < local40) {
				local20 = local40;
			}
		}
	...
	public int method6124(@OriginalArg(0) int arg0, @OriginalArg(2) char arg1) {
	...
	public int method6125(@OriginalArg(0) String arg0) {
		return this.method6126(null, arg0);
	}

	@OriginalMember(owner = "client!vi", name = "a", descriptor = "([Lclient!jd;ZLjava/lang/String;)I")
	public int method6126(@OriginalArg(0) Class13[] arg0, @OriginalArg(2) String arg1) {
		if (arg1 == null) {
			return 0;
		}
		@Pc(19) int local19 = -1;
					...
					if (local58.equals("lt")) {
						...
						if (!local58.equals("reg")) {
							if (local58.startsWith("img=") && arg0 != null) {
								try {
									@Pc(118) int local118 = Static146.parseInt(local58.substring(4));
									local23 += arg0[local118].method6398();
									local21 = -1;
