...
public final class Class2_Sub3_Sub31 extends TextureOp {
	...
	public int[][] getColorOutput(@OriginalArg(0) int arg0) {
		...
		if (super.colorImageCache.invalid) {
			...
			for (@Pc(46) int local46 = 0; local46 < Static227.width; local46++) {
				...
				@Pc(100) int local100 = Static148.heightMask & arg0 + (local83 >> 12);
	...
	public int[] getMonochromeOutput(@OriginalArg(1) int y) {
		...
		if (super.monochromeImageCache.invalid) {
			@Pc(26) int[] local26 = this.getChildMonochromeOutput(1, y);
			@Pc(32) int[] local32 = this.getChildMonochromeOutput(2, y);
			for (@Pc(34) int local34 = 0; local34 < Static227.width; local34++) {
				...
				@Pc(86) int local86 = Static148.heightMask & y + (local69 >> 12);
