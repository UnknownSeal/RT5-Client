...
public final class Class112 {
	...
	private void method2918(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class112 arg1) {
		...
		@Pc(94) int local94;
		if (this.anInt2875 != 0) {
			local79 = Class19.SINE[this.anInt2875];
		...
		if (this.anInt2871 != 0) {
			local79 = Class19.SINE[this.anInt2871];
		...
		@Pc(147) Model local147 = Static157.aModel_4.method3799((byte) 0, 25600, true);
		if (arg0.method2829()) {
			local147.method3815((short) 0, (short) this.anInt2876);
		} else {
			local147.method3837((short) 127, Static274.anInterface2_7.method2658(this.anInt2876).aShort87);
			local147.method3815((short) 0, (short) -1);
		}
		arg0.method2838(1.0F);
		arg0.method2832(16777215, 1.0F, 1.0F, (float) local31, (float) local33, (float) local35);
		local84 = this.anInt2874 * 1024 / (local147.method3821() - local147.method3805());
		if (this.anInt2882 != 0) {
		...
		local223.method3921(0, 0, arg0.method2814() - local147.method3811());
	...
	private void method2919(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class112 arg1) {
		...
		local85 = local172.method3821() - local172.method3805();
		local89 = local172.method3816() - local172.method3801();
		local99 = local172.method3805() + local85 / 2;
		@Pc(198) int local198 = local172.method3801() + local89 / 2;
	...
	public boolean method2926(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (local143 > arg3) {
			local143 = Static351.method5854(arg3);
		}
		if (local143 > 512) {
			local143 = 512;
		}
