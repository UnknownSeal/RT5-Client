...
public final class Class130_Sub3 extends Class130 {
	...
	@Override
	protected void method5901(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class78 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg5 == null) {
			this.method5891(arg0, arg1, arg2, arg3, arg4);
			return;
		}
		...
		if (arg4) {
			this.method5403(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray395[arg0], arg5, arg6, arg7);
		} else {
			this.method5404(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, this.anIntArray394, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray395[arg0], arg5, arg6, arg7);
		}
	}

	@OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[I[IIIIIII)V")
	private void method5402(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	@Override
	protected void method5891(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		arg1 += this.anIntArray393[arg0];
		arg2 += this.anIntArray392[arg0];
		...
		if (arg4) {
			this.method5405(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, arg3, local41, local33, local18, local23, local37, local39);
		} else {
			this.method5402(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, this.anIntArray394, local41, local33, local18, local23, local37, local39);
		}
	}

	@OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[IIIIIIII)V")
	private void method5405(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		@Pc(4) int local4 = -(arg5 >> 2);
		@Pc(9) int local9 = -(arg5 & 0x3);
