...
public final class Class2_Sub3_Sub2 extends Class2_Sub3 {
	...
	public int[] method6484(@OriginalArg(1) int arg0) {
		...
		if (super.aClass158_41.aBoolean265) {
			...
			if (this.aBoolean15) {
				...
				Static403.method4604(local33, 0, local16, 0, Static227.anInt4036);
			}
		}
		return local16;
	}
	...
	public void method6483(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 == 0) {
			this.aBoolean15 = arg1.method4814() == 1;
		} else if (arg0 == 1) {
			this.aBoolean16 = arg1.method4814() == 1;
		} else if (arg0 == 2) {
			super.aBoolean487 = arg1.method4814() == 1;
		}
	}
	...
	public int[][] method6478(@OriginalArg(0) int arg0) {
		...
		if (super.aClass243_41.aBoolean478) {
			@Pc(34) int[][] local34 = this.method6482(0, this.aBoolean16 ? Static148.anInt2718 - arg0 : arg0);
