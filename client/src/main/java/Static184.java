...
public final class Static184 {
	...
	public static void method3396(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class11_Sub5_Sub2_Sub1 arg1) {
		...
		if (arg1.anInt4173 == 0) {
			...
			@Pc(109) String local109 = Static106.aClass50_1 == Static343.aClass50_4 ? Static367.A_TRANSLATABLE_STRING___142.getLocalisedText(Static295.anInt5581) : Static33.A_TRANSLATABLE_STRING___96.getLocalisedText(Static295.anInt5581);
			if (arg1.anInt4171 <= arg1.anInt4179) {
				local146 = arg1.method4071() + (local23 ? Static178.method2343(Static17.aClass11_Sub5_Sub2_Sub1_3.anInt4179, arg1.anInt4179) : "<col=ffffff>") + " (" + local109 + arg1.anInt4179 + ")";
			} else {
				local146 = arg1.method4071() + (local23 ? Static178.method2343(Static17.aClass11_Sub5_Sub2_Sub1_3.anInt4179, arg1.anInt4179) : "<col=ffffff>") + " (" + local109 + arg1.anInt4179 + "+" + (arg1.anInt4171 - arg1.anInt4179) + ")";
			}
		} else {
			local146 = arg1.method4071() + " (" + Static5.A_TRANSLATABLE_STRING___2.getLocalisedText(Static295.anInt5581) + arg1.anInt4173 + ")";
		}
		if (Static330.aBoolean419) {
			...
			for (@Pc(272) int local272 = 7; local272 >= 0; local272--) {
				if (Static243.aStringArray44[local272] != null) {
					...
					if (Static343.aClass50_4 == Static249.aClass50_3 && Static243.aStringArray44[local272].equalsIgnoreCase(Static378.A_TRANSLATABLE_STRING___146.getLocalisedText(Static295.anInt5581))) {
		...
		for (@Pc(385) Class2_Sub5 local385 = (Class2_Sub5) Static129.aClass135_19.method3550(); local385 != null; local385 = (Class2_Sub5) Static129.aClass135_19.method3551()) {
