...
public final class Static184 {
	...
	public static void method3396(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class11_Sub5_Sub2_Sub1 arg1) {
		...
		if (arg1.anInt4173 == 0) {
			...
			@Pc(109) String local109 = Static106.aClass50_1 == client.game ? Static367.A_TRANSLATABLE_STRING___142.getLocalisedText(client.language) : Static33.A_TRANSLATABLE_STRING___96.getLocalisedText(client.language);
		...
		if (Static330.aBoolean419) {
			...
			for (@Pc(272) int local272 = 7; local272 >= 0; local272--) {
				if (Static243.aStringArray44[local272] != null) {
					...
					if (client.game == Static249.aClass50_3 && Static243.aStringArray44[local272].equalsIgnoreCase(Static378.A_TRANSLATABLE_STRING___146.getLocalisedText(client.language))) {
