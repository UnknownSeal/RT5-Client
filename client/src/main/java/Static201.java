	...
	public static void method3652(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Component[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		...
		for (@Pc(13) int local13 = 0; local13 < arg2.length; local13++) {
			...
			if (local19 != null && (local19.layer == arg1 || arg1 == -1412584499 && local19 == Static375.aComponent_14)) {
				@Pc(66) int local66;
				if (arg7 == -1) {
					IdentityKitTypeList.aRectangleArray1[Static154.anInt2806].setBounds(local19.x + arg8, local19.y - -arg4, local19.width, local19.height);
						...
						if (Static20.aBooleanArray6[local66] || Static154.rectDebug > 1) {
							if (local19.type == 3) {
								...
								if (local955 != null) {
									...
									if (local19.objId != -1) {
										@Pc(981) ObjType local981 = ObjTypeList.objTypeList.get(local19.objId);
								...
								if (local19.type == 5) {
									if (local19.anInt4280 < 0) {
										...
										if (local19.objId == -1) {
											...
											@Pc(1121) PlayerAppearance local1121 = local19.objWearColor ? Static17.self.appearance : null;
											local1139 = ObjTypeList.objTypeList.method2758(local19.anInt4306, local19.objId, local1121, Static190.aClass19_8, local19.graphicShadow | 0xFF000000, local19.outline, local19.objCount);
										}
										if (local1139 != null) {
									...
									if (local1477 != null) {
										...
										local588 = local19.modelZoom * Class19.SINE[local19.modelXAngle << 3] >> 15;
