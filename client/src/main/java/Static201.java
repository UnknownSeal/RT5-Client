...
public final class Static201 {
	...
	public static void method3652(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Component[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		...
		for (@Pc(13) int local13 = 0; local13 < arg2.length; local13++) {
			...
			if (local19 != null && (local19.layer == arg1 || arg1 == -1412584499 && local19 == Static375.aComponent_14)) {
				@Pc(66) int local66;
				if (arg7 == -1) {
					Class55.aRectangleArray1[Static154.anInt2806].setBounds(local19.anInt4305 + arg8, local19.anInt4254 - -arg4, local19.width, local19.height);
					local66 = Static154.anInt2806++;
				} else {
					local66 = arg7;
				}
				local19.rectangle = local66;
				local19.rectangleLoop = Static114.loop;
				if (!Static45.method1403(local19)) {
					...
					if (Static18.aBoolean30 && (Static45.method1404(local19).anInt1758 != 0 || local19.type == 0) && local98 > 127) {
						local98 = 127;
					}
					@Pc(151) int local151;
					@Pc(155) int local155;
					if (Static375.aComponent_14 == local19) {
						if (arg1 != -1412584499 && (Static83.anInt1838 == local19.anInt4285 || local19.anInt4285 == Static164.anInt3138)) {
							...
							Static57.aComponentArray1 = arg2;
							continue;
						}
						if (Static57.aBoolean124 && Static278.aBoolean377) {
							...
							if (Static301.aComponent_13.width + Static4.anInt88 < local151 - -local19.width) {
								local151 = Static301.aComponent_13.width + Static4.anInt88 - local19.width;
							}
							local90 = local151;
							if (local155 + local19.height > Static100.anInt2111 - -Static301.aComponent_13.height) {
								local155 = Static100.anInt2111 + Static301.aComponent_13.height - local19.height;
							}
							local95 = local155;
						}
					...
					if (local275 > local151 && local155 < local286) {
						...
						if (local19.anInt4273 != 0) {
							if (local19.anInt4273 == Static199.anInt5755 || Static147.anInt2708 == local19.anInt4273) {
								Static171.method3257(local95, local90, Static147.anInt2708 == local19.anInt4273, local19.width, local19.height);
							...
							if (local19.anInt4273 == Static135.anInt2521) {
								if (local19.method4108(Static190.aClass19_8) != null) {
									Static37.method1135();
									Static92.render(local19, Static190.aClass19_8, local95, local90);
							...
							if (local19.anInt4273 == Static91.anInt1909) {
								Static284.method4880(Static128.anInterface2_4, local19.height, local95, local19.width, local90, Static190.aClass19_8);
								Static357.aBooleanArray59[local66] = true;
								Static190.aClass19_8.method2895(arg5, arg3, arg6, arg0);
								continue;
							}
							if (Static56.anInt1462 == local19.anInt4273) {
								Static257.method3927(local90, local19.height, local95, local19.width, Static190.aClass19_8);
								Static357.aBooleanArray59[local66] = true;
								Static190.aClass19_8.method2895(arg5, arg3, arg6, arg0);
								continue;
							}
						...
						if (local19.type == 0) {
							...
							method3652(local286, local19.id, arg2, local155, local95 - local19.scrollY, local151, local275, local66, local90 - local19.scrollX);
							if (local19.aComponentArray2 != null) {
								method3652(local286, local19.id, local19.aComponentArray2, local155, local95 - local19.scrollY, local151, local275, local66, local90 - local19.scrollX);
							}
						...
						if (Static20.aBooleanArray6[local66] || Static154.anInt2807 > 1) {
							if (local19.type == 3) {
								...
								if (local955 != null) {
									...
									local955.method5892(0, local19.textLineHeight, local90, local19.anInt4298, local19.textShadow ? 255 - (local98 & 0xFF) << 24 : -1, null, 0, null, local19.height, local970, local19.anInt4293, local95, Static124.aClass13Array27, local248 | 255 - (local98 & 0xFF) << 24, local19.width);
									if (Static88.aBoolean134) {
										Static190.aClass19_8.method2895(arg5, arg3, arg6, arg0);
									}
								...
								if (local19.type == 5) {
									if (local19.anInt4280 < 0) {
										...
										if (local19.anInt4300 == -1) {
											...
											local1139 = Static313.aClass107_2.method2758(local19.anInt4306, local19.anInt4300, local1121, Static190.aClass19_8, local19.graphicShadow | 0xFF000000, local19.outline, local19.anInt4240);
										}
										if (local1139 != null) {
												...
												if (local19.angle != 0) {
													...
													for (local564 = 0; local564 < local514; local564++) {
														for (local588 = 0; local588 < local516; local588++) {
															local1139.method6385((float) (local248 * local564 + local90) + (float) local248 / 2.0F, (float) local1161 / 2.0F + (float) (local588 * local1161 + local95), 4096, local19.angle);
														}
													}
												} else if (local98 == 0) {
													local1139.method6396(local90, local95, local19.width, local19.height, 0, 0);
												} else {
													local1139.method6396(local90, local95, local19.width, local19.height, 1, 255 - (local98 & 0xFF) << 24 | 0xFFFFFF);
												}
												Static190.aClass19_8.method2895(arg5, arg3, arg6, arg0);
											} else if (local98 != 0) {
												local514 = 255 - (local98 & 0xFF) << 24 | 0xFFFFFF;
												if (local19.angle != 0) {
													local1139.method6399((float) local90 + (float) local19.width / 2.0F, (float) local19.height / 2.0F + (float) local95, local19.width * 4096 / local248, local19.angle, local514);
												} else if (local19.width == local248 && local1161 == local19.height) {
													local1139.method6400(local90, local95, 1, local514);
												} else {
													local1139.method6394(local90, local95, local19.width, local19.height, 1, local514, 1);
												}
											} else if (local19.angle != 0) {
												local1139.method6385((float) local19.width / 2.0F + (float) local90, (float) local19.height / 2.0F + (float) local95, local19.width * 4096 / local248, local19.angle);
											} else if (local248 == local19.width && local19.height == local1161) {
												local1139.method6384(local90, local95);
											} else {
												local1139.method6387(local90, local95, local19.width, local19.height);
											}
										} else if (Static86.aBoolean133) {
											Static200.redraw(local19);
										}
									...
									if (local19.anInt4300 != -1) {
										...
										local1477 = local19.method4104(0, -1, Static313.aClass107_2, Static214.aClass226_1, null, Static59.aClass7_1, Static17.self.appearance, Static6.aClass219_1, -1, Static39.aClass85_1, 1024, Static21.aClass55_1, Static190.aClass19_8);
										if (local1477 == null && Static86.aBoolean133) {
											Static200.redraw(local19);
										}
									} else {
										@Pc(1640) Class157 local1640 = Static39.aClass85_1.method2371(local19.modelSeqID);
										local1477 = local19.method4104(local19.anInt4283, local19.anInt4316, Static313.aClass107_2, Static214.aClass226_1, local1640, Static59.aClass7_1, Static17.self.appearance, Static6.aClass219_1, local19.anInt4247, Static39.aClass85_1, 1024, Static21.aClass55_1, Static190.aClass19_8);
										if (local1477 == null && Static86.aBoolean133) {
											Static200.redraw(local19);
										}
									}
									if (local1477 != null) {
										...
										local588 = local19.modelZoom * Class19.anIntArray178[local19.anInt4320 << 3] >> 15;
										local590 = local19.modelZoom * Class19.COSINE[local19.anInt4320 << 3] >> 15;
										Static190.aClass19_8.method2821(local516, local564, local1161, local514);
										Static190.aClass19_8.method2823((float) local19.aShort61, local19.modelOrthographic ? (float) local19.aShort62 : (float) local19.aShort62 * 1.5F);
										...
										if (local19.modelOrthographic) {
											local1477.method3843(Static232.aClass14_4, null, local19.modelZoom);
										} else {
