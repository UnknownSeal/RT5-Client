...
public abstract class Class130 {
	...
	private void method5886(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		Static25.anInt643 = -1;
	...
	public final void method5888(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4) {
		if (arg1 == null) {
			return;
		}
		this.method5886(-16777216, arg0);
		...
		this.method5889(arg3 - this.aClass239_8.method6125(arg1) / 2, null, local24, arg2, null, arg1, local21);
	}

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "(BI[I[II[Lclient!jd;Ljava/lang/String;[I)V")
	private void method5889(@OriginalArg(1) int arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class13[] arg4, @OriginalArg(6) String arg5, @OriginalArg(7) int[] arg6) {
		...
		for (@Pc(30) int local30 = 0; local30 < local28; local30++) {
			...
			if (local41 == '<') {
						...
						if (!local63.equals("reg")) {
							if (local63.startsWith("img=")) {
								try {
									...
									local25++;
									@Pc(144) int local144 = Static146.parseInt(local63.substring(4));
									@Pc(148) Class13 local148 = arg4[local144];
									@Pc(157) int local157 = arg1 == null ? local148.method6383() : arg1[local144];
									local148.method6400(local121 + arg0, local131 + -local157 + local19 + this.aClass239_8.anInt6841, 0, 0);
									local23 = -1;
									arg0 += arg4[local144].method6398();
								} catch (@Pc(186) Exception local186) {
								}
							} else {
								this.method5893(local63);
							}
							continue;
						}
						local41 = '®';
				...
				if (local21 == -1) {
					if (local23 != -1) {
						arg0 += this.aClass239_8.method6124(local23, local41);
					}
					@Pc(229) int local229;
					if (arg6 == null) {
						local229 = 0;
					...
					if (local41 != ' ') {
						if ((Static94.anInt1979 & 0xFF000000) != 0) {
							this.method5891(local41, local229 + arg0 + 1, local121 + 1 + local19, Static94.anInt1979, true);
						}
						this.method5891(local41, local229 + arg0, local19 - -local121, Static280.anInt5197, false);
					...
					local25++;
					local131 = this.aClass239_8.method6121(local41);
	...
	private void method5890(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1) {
		@Pc(7) int local7 = 0;
	...
	public final int method5892(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class78 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) String arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) Class13[] arg12, @OriginalArg(14) int arg13, @OriginalArg(15) int arg14) {
		...
		@Pc(67) int local67 = this.aClass239_8.method6118(Static257.aStringArray34, arg9, local54, arg12);
		...
		for (local164 = 0; local164 < local67; local164++) {
			if (arg3 == 0) {
				this.method5903(local88, arg6, Static257.aStringArray34[local164], arg7, arg2, arg12, arg5, arg0);
			} else if (arg3 == 1) {
				this.method5903(local88, arg6, Static257.aStringArray34[local164], arg7, (arg14 - this.aClass239_8.method6125(Static257.aStringArray34[local164])) / 2 + arg2, arg12, arg5, arg0);
			} else if (arg3 == 2) {
				this.method5903(local88, arg6, Static257.aStringArray34[local164], arg7, arg14 + arg2 - this.aClass239_8.method6125(Static257.aStringArray34[local164]), arg12, arg5, arg0);
			} else if (local67 - 1 == local164) {
				this.method5903(local88, arg6, Static257.aStringArray34[local164], arg7, arg2, arg12, arg5, arg0);
			} else {
				this.method5890(arg14, Static257.aStringArray34[local164]);
				this.method5903(local88, arg6, Static257.aStringArray34[local164], arg7, arg2, arg12, arg5, arg0);
				Static120.anInt2387 = 0;
			}
			local88 += arg1;
	...
	private void method5893(@OriginalArg(0) String arg0) {
		try {
			if (arg0.startsWith("col=")) {
				Static280.anInt5197 = Static280.anInt5197 & 0xFF000000 | Static247.method4301(arg0.substring(4)) & 0xFFFFFF;
			} else if (arg0.equals("/col")) {
				Static280.anInt5197 = Static342.anInt5655 & 0xFFFFFF | Static280.anInt5197 & 0xFF000000;
			}
			if (arg0.startsWith("argb=")) {
				Static280.anInt5197 = Static247.method4301(arg0.substring(5));
			} else if (arg0.equals("/argb")) {
				Static280.anInt5197 = Static342.anInt5655;
			} else if (arg0.startsWith("str=")) {
				Static373.anInt7029 = Static247.method4301(arg0.substring(4)) | 0xFF000000;
			} else if (arg0.equals("str")) {
				Static373.anInt7029 = -8388608;
			} else if (arg0.equals("/str")) {
				Static373.anInt7029 = -1;
			} else if (arg0.startsWith("u=")) {
				Static25.anInt643 = Static247.method4301(arg0.substring(2)) | 0xFF000000;
				...
				Static94.anInt1979 = Static247.method4301(arg0.substring(5)) | 0xFF000000;
			} else if (arg0.equals("shad")) {
				Static94.anInt1979 = -16777216;
			} else if (arg0.equals("/shad")) {
				Static94.anInt1979 = Static248.anInt4661;
			} else if (arg0.equals("br")) {
				this.method5886(Static248.anInt4661, Static342.anInt5655);
			}
	...
	public final void method5894(@OriginalArg(0) int arg0, @OriginalArg(3) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) String arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		if (arg3 == null) {
			return;
		}
		this.method5886(-16777216, arg4);
		...
		this.method5889(arg1 - this.aClass239_8.method6125(arg3) / 2, null, local33, arg5, null, arg3, null);
	}

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIIIBLjava/lang/String;)V")
	public final void method5896(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) String arg4) {
		if (arg4 != null) {
			this.method5886(arg1, arg3);
			this.method5903(arg2, 0, arg4, null, arg0, null, null, 0);
		}
	}

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIILjava/lang/String;II)V")
	public final void method5897(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) String arg2, @OriginalArg(5) int arg3) {
		if (arg2 != null) {
			this.method5886(-1, arg3);
			this.method5903(arg1, 0, arg2, null, arg0 - this.aClass239_8.method6125(arg2), null, null, 0);
		}
	}

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "(II[Lclient!jd;Ljava/util/Random;III[ILjava/lang/String;I)I")
	public final int method5898(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class13[] arg2, @OriginalArg(3) Random arg3, @OriginalArg(5) int arg4, @OriginalArg(7) int[] arg5, @OriginalArg(8) String arg6) {
		if (arg6 == null) {
			return 0;
		}
		arg3.setSeed((long) arg1);
		@Pc(20) int local20 = (arg3.nextInt() & 0x1F) + 192;
		this.method5886((local20 | 0x0) << 24, local20 << 24 | 0xFFFFFF);
		...
		this.method5889(arg0, arg5, null, arg4, arg2, arg6, local43);
		return local45;
	}

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/lang/String;IZIII)V")
	public final void method5899(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (arg0 != null) {
			this.method5886(arg1, arg3);
			this.method5903(arg2, 0, arg0, null, arg4 - this.aClass239_8.method6125(arg0) / 2, null, null, 0);
		}
	}

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "([I[Lclient!jd;ILjava/lang/String;IIII)V")
	public final void method5900(@OriginalArg(0) int[] arg0, @OriginalArg(1) Class13[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) String arg3, @OriginalArg(4) int arg4, @OriginalArg(7) int arg5) {
		if (arg3 != null) {
			this.method5886(0, arg5);
			this.method5903(arg4, 0, arg3, null, arg2, arg1, arg0, 0);
		}
	}

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "(CIIIZLclient!kf;II)V")
	protected abstract void method5901(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class78 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILjava/lang/String;ILjava/util/Random;I[IIIII[Lclient!jd;II[IZ)I")
	public final int method5902(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Random arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) Class13[] arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int[] arg13) {
		if (arg1 == null) {
			return 0;
		}
		arg3.setSeed((long) arg9);
		@Pc(20) int local20 = (arg3.nextInt() & 0x1F) + 192;
		this.method5886(arg6 & 0xFFFFFF | local20 << 24, arg8 & 0xFFFFFF | local20 << 24);
		...
		if (arg12 == 1) {
			local86 = this.aClass239_8.method6125(arg1) + local45;
			local78 = arg0 + (arg7 - local86) / 2;
		} else if (arg12 == 2) {
			local86 = this.aClass239_8.method6125(arg1) + local45;
			local78 = arg0 + arg7 - local86;
		}
		this.method5889(local78, arg13, null, local84, arg10, arg1, local43);
		if (arg5 != null) {
			if (local86 == -1) {
				local86 = local45 + this.aClass239_8.method6125(arg1);
			}
			arg5[2] = local86;
	...
	private void method5903(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) Class78 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class13[] arg5, @OriginalArg(7) int[] arg6, @OriginalArg(8) int arg7) {
		...
		for (@Pc(24) int local24 = 0; local24 < local22; local24++) {
			...
			if (local35 == '<') {
					...
					if (local56.equals("lt")) {
						...
						if (!local56.equals("reg")) {
							if (local56.startsWith("img=")) {
								try {
									@Pc(122) int local122 = Static146.parseInt(local56.substring(4));
									@Pc(126) Class13 local126 = arg5[local122];
									@Pc(135) int local135 = arg6 == null ? local126.method6383() : arg6[local122];
									if ((-16777216 & Static280.anInt5197) == -16777216) {
										local126.method6400(arg4, this.aClass239_8.anInt6841 + local15 - local135, 0, 0);
									} else {
										local126.method6400(arg4, local15 + this.aClass239_8.anInt6841 - local135, 1, Static280.anInt5197 & 0xFF000000 | 0xFFFFFF);
									}
									arg4 += arg5[local122].method6398();
									local19 = -1;
								} catch (@Pc(185) Exception local185) {
								}
							} else {
								this.method5893(local56);
							}
							continue;
						}
						local35 = '®';
				...
				if (local17 == -1) {
					if (local19 != -1) {
						arg4 += this.aClass239_8.method6124(local19, local35);
					}
					if (local35 == ' ') {
						...
						if ((Static94.anInt1979 & 0xFF000000) != 0) {
							this.method5891(local35, arg4 + 1, local15 + 1, Static94.anInt1979, true);
						}
						this.method5891(local35, arg4, local15, Static280.anInt5197, false);
					} else {
						if ((Static94.anInt1979 & 0xFF000000) != 0) {
							this.method5901(local35, arg4 + 1, local15 + 1, Static94.anInt1979, true, arg3, arg7, arg1);
						}
						this.method5901(local35, arg4, local15, Static280.anInt5197, false, arg3, arg7, arg1);
					}
					@Pc(310) int local310 = this.aClass239_8.method6121(local35);
					if (Static373.anInt7029 != -1) {
	...
	public final void method5904(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(6) int arg4) {
		if (arg2 == null) {
			return;
		}
		this.method5886(-16777216, arg0);
		...
		this.method5889(arg4 - this.aClass239_8.method6125(arg2) / 2, null, local19, arg3, null, arg2, null);
	}
}
