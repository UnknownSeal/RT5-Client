...
public final class Static293 {
	...
	private static void method5037(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int[] arg5) {
	...
	private static void method5040(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
	...
	private static boolean method5041(@OriginalArg(0) int arg0) {
	...
	private static void method5042() {
		anInt5517 = 0;
	}

	@OriginalMember(owner = "client!qs", name = "a", descriptor = "(II)V")
	private static void method5043(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		while (true) {
			if (arg1 >= arg0 + 8) {
	...
	private static void method5044(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		method5044(arg0, local7);
		method5044(local7 + 4, arg1);
	}

	@OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lclient!wm;[II)V")
	public static void method5045(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method5037(arg0, arg1, arg1.length, arg2, null, null);
	}

	@OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lclient!wm;[II[I[I)V")
	public static void method5046(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		method5037(arg0, arg1, arg1.length, arg2, arg3, arg4);
	}
}
