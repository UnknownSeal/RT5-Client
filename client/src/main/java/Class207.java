...
public final class Class207 {
	...
	public boolean method5258(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(3) int arg2) {
	...
	private boolean method5259(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) byte[] arg3) {
		...
		synchronized (this.aClass205_4) {
			try {
				@Pc(27) int local27;
				if (arg0) {
					if ((long) (arg2 * 6 + 6) > this.aClass205_3.method5217()) {
						return false;
					}
					this.aClass205_3.method5213((long) (arg2 * 6));
					this.aClass205_3.method5221(Static175.aByteArray35, 0, 6);
					local27 = (Static175.aByteArray35[5] & 0xFF) + ((Static175.aByteArray35[4] & 0xFF) << 8) + ((Static175.aByteArray35[3] & 0xFF) << 16);
					if (local27 <= 0 || (long) local27 > this.aClass205_4.method5217() / 520L) {
						return false;
					}
				} else {
					local27 = (int) ((this.aClass205_4.method5217() + 519L) / 520L);
					if (local27 == 0) {
						local27 = 1;
					}
				}
				...
				this.aClass205_3.method5213((long) (arg2 * 6));
				this.aClass205_3.method5214(0, Static175.aByteArray35, 6);
				...
				while (local168 < arg1) {
					...
					@Pc(209) int local209;
					if (arg0) {
						this.aClass205_4.method5213((long) (local27 * 520));
						try {
							this.aClass205_4.method5221(Static175.aByteArray35, 0, 8);
						...
						if (local174 < 0 || this.aClass205_4.method5217() / 520L < (long) local174) {
							return false;
						}
					}
					if (local174 == 0) {
						arg0 = false;
						local174 = (int) ((this.aClass205_4.method5217() + 519L) / 520L);
						if (local174 == 0) {
							local174++;
						}
						if (local174 == local27) {
					...
					this.aClass205_4.method5213((long) (local27 * 520));
					this.aClass205_4.method5214(0, Static175.aByteArray35, 8);
					local209 = arg1 - local168;
					if (local209 > 512) {
						local209 = 512;
					}
					this.aClass205_4.method5214(local168, arg3, local209);
					local168 += local209;
					local27 = local174;
					local170++;
				}
	...
	public byte[] method5260(@OriginalArg(1) int arg0) {
		@Pc(8) Class205 local8 = this.aClass205_4;
		synchronized (this.aClass205_4) {
			try {
				if (this.aClass205_3.method5217() < (long) (arg0 * 6 + 6)) {
					return null;
				}
				this.aClass205_3.method5213((long) (arg0 * 6));
				this.aClass205_3.method5221(Static175.aByteArray35, 0, 6);
				...
				if (local65 < 0 || local65 > this.anInt5776) {
					return null;
				} else if (local88 > 0 && this.aClass205_4.method5217() / 520L >= (long) local88) {
					...
					while (local65 > local130) {
						...
						this.aClass205_4.method5213((long) (local88 * 520));
						@Pc(163) int local163 = local65 - local130;
						if (local163 > 512) {
							local163 = 512;
						}
						this.aClass205_4.method5221(Static175.aByteArray35, 0, local163 + 8);
						...
						if (arg0 == local191 && local206 == local140 && this.anInt5772 == local234) {
							if (local228 >= 0 && this.aClass205_4.method5217() / 520L >= (long) local228) {
