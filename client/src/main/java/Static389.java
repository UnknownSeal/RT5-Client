...
public final class Static389 {
	...
	public static void method4487(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) long arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) boolean arg7, @OriginalArg(9) boolean arg8, @OriginalArg(10) String arg9) {
		...
		local28.method4841(10);
		local28.method4842((arg7 ? 4 : 0) | (arg8 ? 2 : 0) | (arg3 ? 1 : 0));
		local28.method4831(arg4);
		local28.method4812(local8[0]);
		local28.method4821(arg0);
		local28.method4812(local8[1]);
		local28.method4842(Static165.anInt3149);
		local28.method4841(arg1);
		local28.method4841(arg6);
		local28.method4812(local8[2]);
		local28.method4842(arg5);
		local28.method4842(arg2);
		local28.method4812(local8[3]);
		local28.method4833(Static320.aBigInteger2, Static194.aBigInteger1);
		@Pc(118) Class2_Sub4 local118 = new Class2_Sub4(350);
		local118.method4821(arg9);
		@Pc(131) int local131 = 8 - Static27.method872(arg9) % 8;
		for (@Pc(133) int local133 = 0; local133 < local131; local133++) {
			local118.method4841((int) (Math.random() * 255.0D));
		}
		local118.method4861(local8);
		Static257.aClass2_Sub4_Sub2_4.anInt5300 = 0;
		Static257.aClass2_Sub4_Sub2_4.method4841(Static43.aClass242_8.anInt7038);
		Static257.aClass2_Sub4_Sub2_4.method4842(local28.anInt5300 + local118.anInt5300 + 2);
		Static257.aClass2_Sub4_Sub2_4.method4842(578);
		Static257.aClass2_Sub4_Sub2_4.method4856(local28.aByteArray73, local28.anInt5300);
		Static257.aClass2_Sub4_Sub2_4.method4856(local118.aByteArray73, local118.anInt5300);
