...
public final class Static107 {
	...
	public static Class31 method2237(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class31 arg8, @OriginalArg(9) int arg9) {
		...
		if (local12 == null) {
			...
			Static133.aClass98_17.method2624(local6, local12);
		}
