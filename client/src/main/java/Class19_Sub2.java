...
public final class Class19_Sub2 extends Class19 {
	...
	private SoftLruHashTable aSoftLruHashTable_25;
	...
	private final SoftLruHashTable aSoftLruHashTable_24 = new SoftLruHashTable(16);
	...
	public Class19_Sub2(@OriginalArg(0) Canvas arg0, @OriginalArg(1) Interface2 arg1, @OriginalArg(2) int arg2) {
		super(arg2, arg1);
		this.aCanvas3 = arg0;
		this.aClass155_1 = Static351.method5855(this.aCanvas3);
	...
	public void method2881(@OriginalArg(0) Model[] arg0, @OriginalArg(1) Class14 arg1, @OriginalArg(2) Class12_Sub2[] arg2, @OriginalArg(3) int arg3) {
		@Pc(3) Model_Sub1[] local3 = new Model_Sub1[arg0.length];
		for (@Pc(5) int local5 = 0; local5 < arg0.length; local5++) {
			if (arg0[local5] != null) {
				local3[local5] = (Model_Sub1) arg0[local5];
			}
		}
		@Pc(26) Model_Sub1 local26 = Static38.method1259(this, local3);
	...
	public void method2824(@OriginalArg(0) Model arg0, @OriginalArg(1) Class224 arg1, @OriginalArg(2) Class14 arg2, @OriginalArg(3) Class12_Sub2 arg3) {
		((Model_Sub1) arg0).method1249(arg2, arg3, arg1, 0);
	}
		...
		try {
			...
			for (@Pc(16) int local16 = 0; local16 < arg1; local16++) {
				...
				if (local21.x <= this.anInt2863 && local21.y <= this.anInt2861 && local21.x + local21.width > 0 && local21.y + local21.height > 0) {
					this.aClass155_1.method5150(local21.height, local21.x, local21.y, local14, local21.width);
				}
			}
	...
	public void method2893(@OriginalArg(0) int arg0) {
		this.aClass250Array1[arg0].method6449(Thread.currentThread());
	}
	...
	public void method2865(@OriginalArg(0) int arg0) {
		this.aClass250Array1[arg0].method6449(null);
	}
	...
	public void method2883() {
		...
		try {
			@Pc(14) Graphics local14 = this.aCanvas3.getGraphics();
			this.aClass155_1.method5151(local14);
	...
	public void method2803() {
		...
		for (@Pc(22) int local22 = 0; local22 < this.anInt2846; local22++) {
			this.aClass250Array1[local22].method6456();
		}
		this.method2898();
	}
	...
	public void method2848(@OriginalArg(0) int arg0) {
		...
		for (@Pc(9) Object local9 = this.aSoftLruHashTable_25.method2619(); local9 != null; local9 = this.aSoftLruHashTable_25.method2618()) {
		...
		this.anInt2849 = arg0;
		this.aSoftLruHashTable_24.clean(5);
	}
	...
	private void method2915() {
		this.aSoftLruHashTable_25 = new SoftLruHashTable(20);
