...
public final class Resampler {
	...
	public Resampler(@OriginalArg(0) int inputRate, @OriginalArg(1) int outputRate) {
		if (outputRate != inputRate) {
			@Pc(12) int gcd = gcd(outputRate, inputRate);
			@Pc(16) int local16 = outputRate / gcd;
			@Pc(20) int local20 = inputRate / gcd;
	...
	public int method6444(@OriginalArg(0) int arg0) {
	...
	public byte[] method6445(@OriginalArg(1) byte[] arg0) {
		if (this.anIntArrayArray61 != null) {
	...
	public int method6446(@OriginalArg(1) int arg0) {
		if (this.anIntArrayArray61 != null) {
