...
public final class Static118 {
	...
	public static final LocalisedText A_TRANSLATABLE_STRING___76 = new LocalisedText("Connected to update server", "Verbindung zum Update-Server hergestellt.", "Connecté au serveur de mise à jour", "Conectado ao servidor de atualização");
	...
	public static final LocalisedText A_TRANSLATABLE_STRING___77 = new LocalisedText("Loading textures - ", "Lade Texturen - ", "Chargement des textures - ", "Carregando texturas - ");
