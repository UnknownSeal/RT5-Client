...
public final class Static317 {
	...
	public static void method5547(@OriginalArg(0) Class11_Sub5_Sub2 arg0, @OriginalArg(2) boolean arg1) {
		...
		if (arg0.anInt4597 != -1 && arg0.anInt4590 == 0) {
			@Pc(39) SeqType local39 = SeqTypeList.seqTypeList.get(arg0.anInt4597);
		...
		if (arg0.spotAnimID != -1 && arg0.anInt4595 <= Static114.loop) {
			@Pc(97) Class91 local97 = Static322.aClass211_2.get(arg0.spotAnimID);
			if (local97.loop && local97.anInt2448 != -1) {
				@Pc(111) SeqType local111 = SeqTypeList.seqTypeList.get(local97.anInt2448);
		...
		@Pc(289) byte local289 = arg0.movementQueueSpeed[arg0.movementQueueSize - 1];
