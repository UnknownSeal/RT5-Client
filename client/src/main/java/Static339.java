...
public final class Static339 {
	...
	public static void method5759(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (arg3 == arg5 && arg0 == arg2 && arg1 == arg4 && arg8 == arg6) {
			Static327.method5575(arg4, arg3, arg6, arg2, arg7);
			return;
		}
		...
		for (@Pc(103) int local103 = 128; local103 <= 4096; local103 += 128) {
			...
			Static327.method5575(local152, local28, local162, local30, arg7);
			local28 = local152;
			local30 = local162;
		}
	}
