...
public final class Class200 {
	...
	private void method5115() {
		...
		@Pc(16) int local16;
		for (@Pc(11) Class2_Sub38 local11 = (Class2_Sub38) this.aLinkedList_33.head(); local11 != null; local11 = (Class2_Sub38) this.aLinkedList_33.next()) {
			local16 = local11.method6300();
			if (local16 > local1) {
				local1 = local16;
			}
			local3 += local11.method6302();
			local5 |= local11.method6301();
		}
		@Pc(45) int local45;
		if (local1 == 2) {
			local45 = 34836;
	...
	public void method5116() {
		...
		for (@Pc(27) Class2_Sub38 local27 = (Class2_Sub38) this.aLinkedList_33.head(); local27 != null; local27 = local35) {
			local35 = (Class2_Sub38) this.aLinkedList_33.next();
			...
			for (@Pc(41) int local41 = 0; local41 < local39; local41++) {
				...
				if (local35 == null && local41 == local39 - 1) {
					...
					this.aClass228_2.method5795(local21);
					local7.glBegin(GL.GL_QUADS);
					local7.glTexCoord2f(0.0F, 0.0F);
					local7.glMultiTexCoord2f(GL.GL_TEXTURE1, 0.0F, 0.0F);
	...
	public void method5119() {
		if (this.aClass228_2 != null) {
			...
			if (!this.aLinkedList_33.method3549()) {
				for (@Pc(33) Node local33 = this.aLinkedList_33.head(); local33 != this.aLinkedList_33.sentinel; local33 = local33.next) {
	...
	public boolean method5120(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (this.anInt5603 != arg2 || this.anInt5605 != arg3) {
			this.anInt5603 = arg2;
			this.anInt5605 = arg3;
			for (@Pc(30) Node local30 = this.aLinkedList_33.head(); local30 != this.aLinkedList_33.sentinel; local30 = local30.next) {
		...
		if (this.aBoolean395) {
			if (this.aClass184_1 != null) {
				this.aClass184_1.method4649();
				this.aClass184_1 = null;
			}
			if (this.aClass8_Sub1_4 != null) {
				this.aClass8_Sub1_4.method6155();
				this.aClass8_Sub1_4 = null;
			}
			if (this.aBoolean396) {
		...
		if (this.aBoolean397) {
			if (this.aClass8_Sub1Array3[0] != null) {
				this.aClass8_Sub1Array3[0].method6155();
				this.aClass8_Sub1Array3[0] = null;
			}
			if (this.aClass8_Sub1Array3[1] != null) {
				this.aClass8_Sub1Array3[1].method6155();
		...
		@Pc(194) int local194 = this.aClass19_Sub1_32.method821().method5792();
		this.aClass19_Sub1_32.method808(this.aClass228_2);
		if (this.aBoolean394) {
			this.aClass228_2.method5797(0);
			this.aClass228_2.method5797(1);
			this.aClass228_2.method5797(8);
			if (this.aClass8_Sub1Array3[0] != null) {
				this.aClass228_2.method5793(0, this.aClass8_Sub1Array3[0]);
			}
			if (this.aClass8_Sub1Array3[1] != null) {
				this.aClass228_2.method5793(1, this.aClass8_Sub1Array3[1]);
			}
			if (this.aClass8_Sub1_4 != null) {
				this.aClass228_2.method5793(8, this.aClass8_Sub1_4);
			}
			if (this.aClass184_1 != null) {
				this.aClass228_2.method5799(this.aClass184_1);
			}
			this.aClass228_2.method5795(0);
			this.aBoolean394 = false;
			local11 = true;
		}
		if (!local11 || this.aClass228_2.method5798()) {
			this.anInt5606 = arg0;
			this.anInt5604 = arg1;
	...
	public void method5121(@OriginalArg(0) Class2_Sub38 arg0) {
		this.method5117(arg0);
	}
}
