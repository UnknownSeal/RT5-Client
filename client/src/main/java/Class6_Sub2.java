...
public final class Class6_Sub2 extends Class6 {
	...
	@Override
	public void method5722(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	private void method5732(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4, @OriginalArg(8) Class81 arg5, @OriginalArg(9) int[] arg6, @OriginalArg(10) int[] arg7) {
				...
				if (arg4[local22 - arg0][local25 - arg1]) {
					...
					if (this.aClass38ArrayArray1[local22][local25] != null) {
						...
						if (local50.aShort11 != -1 && (local50.aByte5 & 0x2) == 0 && local50.anInt1252 == -1) {
							...
							arg5.method2286(local20 - 4, local20 - 4, local20, local16 + 4, local16, local16 + 4, Static253.method4367(local69, local50.aShort15 & 0xFFFF), Static253.method4367(local69, local50.aShort12 & 0xFFFF), Static253.method4367(local69, local50.aShort14 & 0xFFFF));
							arg5.method2286(local20, local20, local20 - 4, local16, local16 + 4, local16, Static253.method4367(local69, local50.aShort13 & 0xFFFF), Static253.method4367(local69, local50.aShort14 & 0xFFFF), Static253.method4367(local69, local50.aShort12 & 0xFFFF));
						...
						for (@Pc(297) int local297 = 0; local297 < local249.aShort9; local297++) {
							...
							if (local249.anIntArray82 != null && local249.anIntArray82[local297] != -1) {
								...
								arg5.method2286(local329, local333, local337, local317, local321, local325, Static253.method4367(local351, local249.aShortArray16[local303]), Static253.method4367(local351, local249.aShortArray16[local308]), Static253.method4367(local351, local249.aShortArray16[local313]));
	...
	@Override
	public int method5727(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@Override
	public Class2_Sub2_Sub4 method5729(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub4 arg2) {
		return null;
	}

	@OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)Z")
	private boolean method5733(@OriginalArg(0) int arg0) {
	...
	@Override
	public int method5718(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@Override
	public boolean method5730(@OriginalArg(0) Class2_Sub2_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return false;
	}

	@OriginalMember(owner = "client!tn", name = "b", descriptor = "(II)V")
	@Override
	public void method5719(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass201ArrayArray1 != null) {
			this.method5734(arg0, arg1, this.aClass19_Sub2_9.aBoolean199, local4.aClass81_2, local4.anIntArray508, local4.anIntArray516, local4.anIntArray504);
		} else if (this.aClass38ArrayArray1 != null) {
			this.method5735(arg0, arg1, local4.aClass81_2, local4.anIntArray508, local4.anIntArray516, local4.anIntArray504);
		}
	}

	@OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIZLclient!gf;[I[I[I)V")
	private void method5734(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class81 arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6) {
		...
		if (local6 == null) {
				...
				if (local1426.aShortArray59 != null) {
					...
					for (local36 = 0; local36 < local1426.aShort42; local36++) {
						...
						if ((local163 - local56) * (local616 - local227) - (local222 - local227) * (local61 - local56) > 0) {
							...
							if (local1886 < 765) {
								if (local1930 != -1 && this.method5733(this.aClass19_Sub2_9.anInterface2_5.method2658(local1930).aByte67)) {
									arg3.anInt2264 = 100;
								}
								if (local1886 > 0) {
									if (local1930 != -1) {
										...
										arg3.method2289(local222, local227, local616, local163, local56, local61, Static231.method4023(local1426.anIntArray209[local38], arg6[local38] << 24 | this.aClass19_Sub2_9.anInt2853), Static231.method4023(local1426.anIntArray209[local40], arg6[local40] << 24 | this.aClass19_Sub2_9.anInt2853), Static231.method4023(local1426.anIntArray209[local42], arg6[local42] << 24 | this.aClass19_Sub2_9.anInt2853));
									}
								} else if (local1930 != -1) {
					...
					if ((local244 - local300) * (local328 - local272) - (local412 - local272) * (local356 - local300) > 0) {
						...
						if (local384 >= 765) {
							...
							if ((local1426.anIntArray209[local339] & 0xFFFFFF) != 0) {
								arg3.method2289(local412, local272, local328, local244, local300, local356, Static263.method4466(arg6[local339], this.aClass19_Sub2_9.anInt2853, local1426.anIntArray209[local339]), Static263.method4466(arg6[local395], this.aClass19_Sub2_9.anInt2853, local1426.anIntArray209[local395]), Static263.method4466(arg6[local451], this.aClass19_Sub2_9.anInt2853, local1426.anIntArray209[local451]));
							}
			...
			@Pc(1038) boolean local1038 = local6.aShort84 != -1 && this.method5733(this.aClass19_Sub2_9.anInterface2_5.method2658(local6.aShort84).aByte67);
				...
				if (local61 < 765) {
					...
					if (local61 > 0) {
						if (local6.aShort84 >= 0) {
							...
							arg3.method2289(local395, local451, local339, local367, local423, local311, Static231.method4023(local6.anInt5612, local40 << 24 | this.aClass19_Sub2_9.anInt2853), Static231.method4023(local6.anInt5611, local42 << 24 | this.aClass19_Sub2_9.anInt2853), Static231.method4023(local6.anInt5609, local38 << 24 | this.aClass19_Sub2_9.anInt2853));
						}
				...
				if (local61 < 765) {
					...
					if (local61 > 0) {
						if (local6.aShort84 >= 0) {
							...
							arg3.method2289(local283, local339, local451, local255, local311, local423, Static231.method4023(local6.anInt5610, local36 << 24 | this.aClass19_Sub2_9.anInt2853), Static231.method4023(local6.anInt5609, local38 << 24 | this.aClass19_Sub2_9.anInt2853), Static231.method4023(local6.anInt5611, local42 << 24 | this.aClass19_Sub2_9.anInt2853));
						}
					} else if (local6.aShort84 >= 0) {
	...
	private void method5735(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class81 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5) {
		...
		if (local6 == null) {
					...
					for (local46 = 0; local46 < local996.aShort9; local46++) {
						...
						if ((local1363 - local1367) * (local1383 - local1379) - (local1375 - local1379) * (local1371 - local1367) > 0) {
							...
							if (local1427 == -1) {
								...
								if (local1482 != -1) {
									arg2.method2286(local1375, local1379, local1383, local1363, local1367, local1371, Static253.method4367(local1482, local996.aShortArray16[local1349]), Static253.method4367(local1482, local996.aShortArray16[local1354]), Static253.method4367(local1482, local996.aShortArray16[local1359]));
								}
							} else {
								if (this.method5733(this.aClass19_Sub2_9.anInterface2_5.method2658(local1427).aByte67)) {
									arg2.anInt2264 = 100;
								}
				...
				for (local209 = 0; local209 < local996.aShort9; local209++) {
					...
					if ((local170 - local226) * (local254 - local198) - (local338 - local198) * (local282 - local226) > 0) {
						...
						if (local310 != -1) {
							...
							arg2.method2286(local338, local198, local254, local170, local226, local282, Static253.method4367(local310, local996.aShortArray16[local1528]), Static253.method4367(local310, local996.aShortArray16[local1533]), Static253.method4367(local310, local996.aShortArray16[local1538]));
						}
					}
				}
			}
			...
			if ((local293 - local349) * (local265 - local377) - (local321 - local377) * (local237 - local349) > 0) {
				...
				if (local6.aShort11 >= 0) {
					if (this.method5733(this.aClass19_Sub2_9.anInterface2_5.method2658(local6.aShort11).aByte67)) {
						arg2.anInt2264 = 100;
					}
	...
	@Override
	public void method5721(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		@Pc(4) Class250 local4 = this.aClass19_Sub2_9.method2905(Thread.currentThread());
		@Pc(7) Class81 local7 = local4.aClass81_2;
		local7.anInt2264 = 0;
		local7.aBoolean169 = false;
		if (this.aClass201ArrayArray1 != null) {
			this.method5736(arg0, arg1, arg2, arg3, arg4, local7, local4.anIntArray508, local4.anIntArray516);
		} else if (this.aClass38ArrayArray1 != null) {
			this.method5732(arg0, arg1, arg2, arg3, arg4, local7, local4.anIntArray508, local4.anIntArray516);
		}
	}

	@OriginalMember(owner = "client!tn", name = "b", descriptor = "(IIIIIII[[ZLclient!gf;[I[I)V")
	private void method5736(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4, @OriginalArg(8) Class81 arg5, @OriginalArg(9) int[] arg6, @OriginalArg(10) int[] arg7) {
		@Pc(7) int local7 = (arg3 - arg1) * 1024 / 256;
		arg5.aBoolean168 = false;
		@Pc(16) int local16 = 0;
		@Pc(20) int local20 = local7;
				...
				if (arg4[local22 - arg0][local25 - arg1]) {
					...
					if (this.aClass201ArrayArray1[local22][local25] != null) {
						...
						if (local50.aShort84 != -1 && (local50.aByte60 & 0x2) == 0 && local50.anInt5613 == 0) {
							...
							arg5.method2286(local20 - 4, local20 - 4, local20, local16 + 4, local16, local16 + 4, Static253.method4367(local68, local50.anInt5612), Static253.method4367(local68, local50.anInt5611), Static253.method4367(local68, local50.anInt5609));
							arg5.method2286(local20, local20, local20 - 4, local16, local16 + 4, local16, Static253.method4367(local68, local50.anInt5610), Static253.method4367(local68, local50.anInt5609), Static253.method4367(local68, local50.anInt5611));
							...
							arg5.method2289(local20 - 4, local20 - 4, local20, local16 + 4, local16, local16 + 4, Static231.method4023(local68, local50.anInt5612 & 0xFF000000), Static231.method4023(local68, local50.anInt5611 & 0xFF000000), Static231.method4023(local68, local50.anInt5609 & 0xFF000000));
							arg5.method2289(local20, local20, local20 - 4, local16, local16 + 4, local16, Static231.method4023(local68, local50.anInt5610 & 0xFF000000), Static231.method4023(local68, local50.anInt5609 & 0xFF000000), Static231.method4023(local68, local50.anInt5611 & 0xFF000000));
						}
						...
						for (@Pc(307) int local307 = 0; local307 < local259.aShort42; local307++) {
							...
							if (local259.anIntArray210 != null && local259.anIntArray210[local307] != 0 && (local259.aShortArray59 == null || local259.aShortArray59 != null && local259.aShortArray59[local307] == -1)) {
								...
								arg5.method2289(local336, local340, local344, local324, local328, local332, Static231.method4023(local369, -(local259.anIntArray209[local312] & -16777216) - 16777216), Static231.method4023(local369, -(local259.anIntArray209[local316] & -16777216) - 16777216), Static231.method4023(local369, -(local259.anIntArray209[local320] & -16777216) - 16777216));
	...
	@Override
	public void method5723(@OriginalArg(0) Class2_Sub2_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	}
	...
	public void method5726(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		...
		if (local102) {
			...
			if (local342 == -1 || (local334.aByte60 & 0x2) != 0 || this.aClass19_Sub2_9.anInterface2_5.method2658(local342).aBoolean438) {
				...
				local334.anInt5610 = Static263.method4466(local527, arg10, Static407.method5731(arg6[local104] >> 8, this.aByteArrayArray20[arg0][arg1] - this.aByteArrayArray19[arg0][arg1]));
				...
				local334.anInt5609 = Static263.method4466(local527, arg10, Static407.method5731(arg6[local106] >> 8, this.aByteArrayArray20[arg0 + 1][arg1] - this.aByteArrayArray19[arg0 + 1][arg1]));
				if (local334.anInt5613 != 0) {
				...
				local334.anInt5612 = Static263.method4466(local527, arg10, Static407.method5731(arg6[local108] >> 8, this.aByteArrayArray20[arg0 + 1][arg1 + 1] - this.aByteArrayArray19[arg0 + 1][arg1 + 1]));
				if (local334.anInt5613 != 0) {
				...
				local334.anInt5611 = Static263.method4466(local527, arg10, Static407.method5731(arg6[local110] >> 8, this.aByteArrayArray20[arg0][arg1 + 1] - this.aByteArrayArray19[arg0][arg1 + 1]));
				if (local334.anInt5613 != 0) {
		...
		for (local244 = 0; local244 < local888.aShort41; local244++) {
			...
			local888.aShortArray63[local244] = (short) (this.method5727(local1150, local1158) + (arg3 == null ? 0 : arg3[local244]));
			if (local958 < 0) {
				local958 = 0;
			}
			if (arg8[local244] != -1 && !this.aClass19_Sub2_9.anInterface2_5.method2658(arg8[local244]).aBoolean438) {
				...
				local888.anIntArray209[local244] = Static263.method4466(local1226, arg10, Static407.method5731(arg6[local244] >> 8, local958));
				if (arg7 != null) {
	...
	@Override
	public void method5716(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15) {
		...
		if (!local26) {
			...
			for (@Pc(124) int local124 = 0; local124 < local99; local124++) {
				...
				local95.anIntArray79[local124] = this.method5727(local288, local335) + (arg3 == null ? 0 : arg3[local124]);
			...
			local70 = arg11[0];
			if (arg10 != null) {
				local641.anInt1252 = Static253.method4367(Static26.method863(arg10[0]), this.aByteArrayArray20[arg0][arg1] - this.aByteArrayArray19[arg0][arg1]);
				if (local64 == -1) {
			...
			if (local70 == -1 || (local641.aByte5 & 0x2) != 0 || this.aClass19_Sub2_9.anInterface2_5.method2658(local70).aBoolean438) {
				...
				local641.aShort13 = (short) Static253.method4367(local842, this.aByteArrayArray20[arg0][arg1] - this.aByteArrayArray19[arg0][arg1]);
				local641.aShort14 = (short) Static253.method4367(local842, this.aByteArrayArray20[arg0 + 1][arg1] - this.aByteArrayArray19[arg0 + 1][arg1]);
				local641.aShort15 = (short) Static253.method4367(local842, this.aByteArrayArray20[arg0 + 1][arg1 + 1] - this.aByteArrayArray19[arg0 + 1][arg1 + 1]);
				local641.aShort12 = (short) Static253.method4367(local842, this.aByteArrayArray20[arg0][arg1 + 1] - this.aByteArrayArray19[arg0][arg1 + 1]);
				local641.aShort11 = -1;
			} else {
	...
	@Override
	public void method5728(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
