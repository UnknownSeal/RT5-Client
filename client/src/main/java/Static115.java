...
public final class Static115 {
	...
	public static void method3808(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1008) {
			Static198.method3595(Static138.aClass16_3, arg0, arg2);
		} else if (arg1 == 1002) {
			Static198.method3595(Static192.aClass16_5, arg0, arg2);
		} else if (arg1 == 1012) {
			Static198.method3595(Static250.aClass16_6, arg0, arg2);
		} else if (arg1 == 1003) {
			Static198.method3595(Static320.aClass16_8, arg0, arg2);
		} else if (arg1 == 1007) {
			Static198.method3595(Static135.aClass16_2, arg0, arg2);
		}
	}
	...
	public static void method3846(@OriginalArg(0) int arg0, @OriginalArg(1) Class161[] arg1) {
		for (@Pc(3) int local3 = 0; local3 < arg1.length; local3++) {
			@Pc(9) Class161 local9 = arg1[local3];
			if (local9 != null) {
				if (local9.anInt4272 == 0) {
					if (local9.aClass161Array2 != null) {
						method3846(arg0, local9.aClass161Array2);
					}
