...
public final class Class171 {
	...
	public void method4369(@OriginalArg(1) Class2_Sub4 arg0) {
		while (true) {
			@Pc(12) int local12 = arg0.method4814();
			if (local12 == 0) {
				return;
			}
			this.method4373(local12, arg0);
		}
	}

	@OriginalMember(owner = "client!ok", name = "a", descriptor = "(IILclient!bt;)V")
	private void method4373(@OriginalArg(1) int arg0, @OriginalArg(2) Class2_Sub4 arg1) {
		if (arg0 == 5) {
			this.anInt4700 = arg1.method4828();
		}
	}
}
