...
public final class Class2_Sub2_Sub14 extends Class2_Sub2 {
	...
	public Class2_Sub2_Sub14(@OriginalArg(0) Class2_Sub4 arg0) {
		@Pc(7) int local7 = arg0.method4814();
		@Pc(9) int local9 = 0;
		@Pc(11) int local11 = 0;
		...
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			...
			for (local50 = 0; local50 < local43; local50++) {
				local14[local20][local50] = arg0.method4814();
			}
		...
		this.aClass2_Sub3_3 = this.aClass2_Sub3Array30[arg0.method4814()];
		this.aClass2_Sub3_1 = this.aClass2_Sub3Array30[arg0.method4814()];
		this.aClass2_Sub3_2 = this.aClass2_Sub3Array30[arg0.method4814()];
	}

	@OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZLclient!r;Lclient!ci;ZII)[F")
	public float[] method4955(@OriginalArg(1) Class197 arg0, @OriginalArg(2) Interface2 arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub3Array30.length; local11++) {
			this.aClass2_Sub3Array30[local11].method6474(arg3, arg4);
		}
		...
		for (@Pc(55) int local55 = 0; local55 < arg3; local55++) {
			...
			if (this.aClass2_Sub3_3.aBoolean487) {
				...
				@Pc(67) int[][] local67 = this.aClass2_Sub3_3.method6478(local55);
				local71 = local67[0];
				local75 = local67[2];
				local79 = local67[1];
			}
		...
		for (@Pc(236) int local236 = 0; local236 < this.aClass2_Sub3Array30.length; local236++) {
			this.aClass2_Sub3Array30[local236].method6476();
		}
		return local38;
	}

	@OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILclient!ci;Lclient!r;)Z")
	public boolean method4956(@OriginalArg(1) Interface2 arg0, @OriginalArg(2) Class197 arg1) {
		@Pc(9) int local9;
		if (Static123.anInt2421 >= 0) {
			for (local9 = 0; local9 < this.anIntArray371.length; local9++) {
				if (!arg1.method5087(this.anIntArray371[local9], Static123.anInt2421)) {
					return false;
				}
			}
		} else {
			for (local9 = 0; local9 < this.anIntArray371.length; local9++) {
				if (!arg1.method5086(this.anIntArray371[local9])) {
					return false;
				}
			}
		}
	...
	public int[] method4957(@OriginalArg(0) boolean arg0, @OriginalArg(1) double arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class197 arg4, @OriginalArg(5) boolean arg5, @OriginalArg(7) Interface2 arg6) {
		...
		for (@Pc(19) int local19 = 0; local19 < this.aClass2_Sub3Array30.length; local19++) {
			this.aClass2_Sub3Array30[local19].method6474(arg3, arg2);
		}
		...
		for (@Pc(69) int local69 = 0; local69 < arg3; local69++) {
			...
			if (this.aClass2_Sub3_3.aBoolean487) {
				...
				@Pc(99) int[][] local99 = this.aClass2_Sub3_3.method6478(local69);
				local87 = local99[0];
				local89 = local99[1];
				local91 = local99[2];
			}
		...
		for (@Pc(229) int local229 = 0; local229 < this.aClass2_Sub3Array30.length; local229++) {
			this.aClass2_Sub3Array30[local229].method6476();
		}
		return local47;
	}

	@OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lclient!ci;Lclient!r;DIZII)[I")
	public int[] method4959(@OriginalArg(0) Interface2 arg0, @OriginalArg(1) Class197 arg1, @OriginalArg(2) double arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		Static111.aClass197_24 = arg1;
		Static259.anInterface2_6 = arg0;
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub3Array30.length; local11++) {
			this.aClass2_Sub3Array30[local11].method6474(arg5, arg4);
		}
		...
		for (@Pc(54) int local54 = 0; local54 < arg5; local54++) {
			...
			if (this.aClass2_Sub3_3.aBoolean487) {
				...
				@Pc(80) int[][] local80 = this.aClass2_Sub3_3.method6478(local54);
				local68 = local80[0];
				local70 = local80[1];
				local72 = local80[2];
			}
		...
		for (@Pc(261) int local261 = 0; local261 < this.aClass2_Sub3Array30.length; local261++) {
			this.aClass2_Sub3Array30[local261].method6476();
		}
		return local45;
	}
}
