...
public final class Class11_Sub5_Sub5 extends Class11_Sub5 implements Interface6 {
	...
	public Class12_Sub4 method6072(@OriginalArg(0) Class19 arg0) {
		@Pc(16) Model local16 = this.aClass192_4.method4940(true, false, arg0, 1024, super.zFine, super.xFine);
		if (local16 == null) {
			return null;
		}
		@Pc(23) Class14 local23 = arg0.method2808();
		local23.method3921(super.xFine, super.anInt6782, super.zFine);
	...
	public void method6069(@OriginalArg(0) Class19 arg0) {
		@Pc(16) Model local16 = this.aClass192_4.method4940(true, true, arg0, 131072, super.zFine, super.xFine);
		if (local16 != null) {
	...
	public boolean method6067(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19 arg2) {
		@Pc(23) Model local23 = this.aClass192_4.method4940(false, false, arg2, 65536, super.zFine, super.xFine);
		if (local23 == null) {
			return false;
		} else {
			@Pc(30) Class14 local30 = arg2.method2808();
			local30.method3921(super.xFine, super.anInt6782, super.zFine);
