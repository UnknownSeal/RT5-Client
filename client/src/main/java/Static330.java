...
public final class Static330 {
	...
	public static Class235 method5654(@OriginalArg(0) int arg0) {
		@Pc(10) Class235 local10 = (Class235) Static233.aClass98_37.method2612((long) arg0);
		if (local10 != null) {
			return local10;
		}
		@Pc(28) byte[] local28 = Static289.aClass197_73.method5088(arg0, 0);
		local10 = new Class235();
		if (local28 != null) {
			local10.method5932(new Class2_Sub4(local28));
		}
		local10.method5930();
	...
	public static void method5655(@OriginalArg(0) Class210 arg0) {
		...
		if (Static19.aClass210_1 == arg0) {
			local12 = Static212.aClass2_Sub4_Sub2_3.method4814();
			local23 = Static67.anInt1637 * 2 + (local12 >> 4 & 0xF);
			local32 = Static7.anInt7240 * 2 + (local12 & 0xF);
			local40 = local23 + Static212.aClass2_Sub4_Sub2_3.method4824();
			local49 = local32 + Static212.aClass2_Sub4_Sub2_3.method4824();
			local53 = Static212.aClass2_Sub4_Sub2_3.method4822();
			local57 = Static212.aClass2_Sub4_Sub2_3.method4828();
			local63 = Static212.aClass2_Sub4_Sub2_3.method4814() * 4;
			local69 = Static212.aClass2_Sub4_Sub2_3.method4814() * 4;
			local73 = Static212.aClass2_Sub4_Sub2_3.method4828();
			local77 = Static212.aClass2_Sub4_Sub2_3.method4828();
			local81 = Static212.aClass2_Sub4_Sub2_3.method4814();
			local85 = Static212.aClass2_Sub4_Sub2_3.method4814();
			if (local81 == 255) {
				local81 = -1;
			}
			if (local23 >= 0 && local32 >= 0 && Static373.anInt7033 * 2 > local23 && Static373.anInt7033 * 2 > local32 && local40 >= 0 && local49 >= 0 && Static242.anInt4449 * 2 > local40 && local49 < Static242.anInt4449 * 2 && local57 != 65535) {
				...
				local23 = local23 * 64;
				local32 *= 64;
				local181 = new Class11_Sub5_Sub3(local57, Static243.anInt4502, local23, local32, Static386.method6031(local23, local32, Static243.anInt4502) - local63, local73 - -Static114.anInt2348, Static114.anInt2348 + local77, local81, local85, local53, local69);
				local181.method4396(Static386.method6031(local40, local49, Static243.anInt4502) - local69, local40, Static114.anInt2348 + local73, local49);
				Static332.aClass135_38.method3539(new Class2_Sub2_Sub9(local181));
			}
		} else if (arg0 == Static285.aClass210_12) {
			local12 = Static212.aClass2_Sub4_Sub2_3.method4814();
			local23 = (local12 >> 4 & 0x7) + Static67.anInt1637;
			local32 = (local12 & 0x7) + Static7.anInt7240;
			local40 = Static212.aClass2_Sub4_Sub2_3.method4828();
			local49 = Static212.aClass2_Sub4_Sub2_3.method4828();
			local53 = Static212.aClass2_Sub4_Sub2_3.method4828();
			if (Static120.aClass4_49 != null && local23 >= 0 && local32 >= 0 && local23 < Static373.anInt7033 && Static242.anInt4449 > local32) {
				...
				if (local269 != null) {
					for (@Pc(277) Class2_Sub8 local277 = (Class2_Sub8) local269.aClass135_34.method3550(); local277 != null; local277 = (Class2_Sub8) local269.aClass135_34.method3551()) {
			...
			if (Static374.aClass210_16 == arg0) {
				...
				local40 = Static212.aClass2_Sub4_Sub2_3.method4824() + local23;
				local49 = local32 + Static212.aClass2_Sub4_Sub2_3.method4824();
				local53 = Static212.aClass2_Sub4_Sub2_3.method4822();
				local57 = Static212.aClass2_Sub4_Sub2_3.method4822();
				local63 = Static212.aClass2_Sub4_Sub2_3.method4828();
				local69 = Static212.aClass2_Sub4_Sub2_3.method4824();
				local73 = Static212.aClass2_Sub4_Sub2_3.method4814() * 4;
				local77 = Static212.aClass2_Sub4_Sub2_3.method4828();
				local81 = Static212.aClass2_Sub4_Sub2_3.method4828();
				local85 = Static212.aClass2_Sub4_Sub2_3.method4814();
				if (local85 == 255) {
					local85 = -1;
				}
				local403 = Static212.aClass2_Sub4_Sub2_3.method4814();
				if (local23 >= 0 && local32 >= 0 && local23 < Static373.anInt7033 * 2 && Static373.anInt7033 * 2 > local32 && local40 >= 0 && local49 >= 0 && local40 < Static242.anInt4449 * 2 && local49 < Static242.anInt4449 * 2 && local63 != 65535) {
					...
					if (local53 != 0) {
						...
						if (local491 != null) {
							@Pc(525) Class222 local525 = local491.method4331();
					...
					@Pc(628) Class11_Sub5_Sub3 local628 = new Class11_Sub5_Sub3(local63, Static243.anInt4502, local23, local32, Static386.method6031(local23, local32, Static243.anInt4502) - local69, Static114.anInt2348 + local77, local81 + Static114.anInt2348, local85, local403, local57, local73);
					local628.method4396(Static386.method6031(local40, local49, Static243.anInt4502) - local73, local40, Static114.anInt2348 + local77, local49);
					Static332.aClass135_38.method3539(new Class2_Sub2_Sub9(local628));
				}
			} else if (Static27.aClass210_2 == arg0) {
				local12 = Static212.aClass2_Sub4_Sub2_3.method4803();
				local23 = (local12 >> 4 & 0x7) + Static67.anInt1637;
				local32 = Static7.anInt7240 + (local12 & 0x7);
				local40 = Static212.aClass2_Sub4_Sub2_3.method4852();
				if (local23 >= 0 && local32 >= 0 && local23 < Static373.anInt7033 && local32 < Static242.anInt4449) {
					...
					if (local713 != null) {
						for (@Pc(721) Class2_Sub8 local721 = (Class2_Sub8) local713.aClass135_34.method3550(); local721 != null; local721 = (Class2_Sub8) local713.aClass135_34.method3551()) {
							if ((local40 & 0x7FFF) == local721.anInt1717) {
								local721.method6467();
								break;
							}
						}
						if (local713.aClass135_34.method3549()) {
							local713.method6467();
						}
						Static165.method3153(local23, Static243.anInt4502, local32);
					}
				...
				local12 = Static212.aClass2_Sub4_Sub2_3.method4802();
				local23 = Static212.aClass2_Sub4_Sub2_3.method4852();
				local32 = Static212.aClass2_Sub4_Sub2_3.method4810();
				local40 = (local32 >> 4 & 0x7) + Static67.anInt1637;
				local49 = Static7.anInt7240 + (local32 & 0x7);
				local53 = Static212.aClass2_Sub4_Sub2_3.method4852();
				...
				local49 = Static212.aClass2_Sub4_Sub2_3.method4805();
				local53 = Static212.aClass2_Sub4_Sub2_3.method4814();
				...
				@Pc(916) byte local916 = Static212.aClass2_Sub4_Sub2_3.method4800();
				local23 = Static212.aClass2_Sub4_Sub2_3.method4814();
				local32 = (local23 >> 4 & 0x7) + Static67.anInt1637;
				local40 = (local23 & 0x7) + Static7.anInt7240;
				local49 = Static212.aClass2_Sub4_Sub2_3.method4849();
				@Pc(942) byte local942 = Static212.aClass2_Sub4_Sub2_3.method4840();
				local57 = Static212.aClass2_Sub4_Sub2_3.method4852();
				local63 = Static212.aClass2_Sub4_Sub2_3.method4852();
				@Pc(954) byte local954 = Static212.aClass2_Sub4_Sub2_3.method4800();
				@Pc(958) byte local958 = Static212.aClass2_Sub4_Sub2_3.method4800();
				local77 = Static212.aClass2_Sub4_Sub2_3.method4862();
				local81 = local77 >> 2;
				local85 = local77 & 0x3;
				local403 = Static212.aClass2_Sub4_Sub2_3.method4828();
				...
				local12 = Static212.aClass2_Sub4_Sub2_3.method4828();
				local23 = Static212.aClass2_Sub4_Sub2_3.method4814();
				Static359.aClass202_4.method5162(local12).method1521(local23);
			} else if (Static110.aClass210_5 == arg0) {
				Static212.aClass2_Sub4_Sub2_3.method4814();
				local12 = Static212.aClass2_Sub4_Sub2_3.method4814();
				local23 = (local12 >> 4 & 0x7) + Static67.anInt1637;
				local32 = Static7.anInt7240 + (local12 & 0x7);
				local40 = Static212.aClass2_Sub4_Sub2_3.method4828();
				local49 = Static212.aClass2_Sub4_Sub2_3.method4814();
				local53 = Static212.aClass2_Sub4_Sub2_3.method4832();
				@Pc(1055) String local1055 = Static212.aClass2_Sub4_Sub2_3.method4808();
				...
				local12 = Static212.aClass2_Sub4_Sub2_3.method4805();
				if (local12 == 65535) {
					local12 = -1;
				}
				local23 = Static212.aClass2_Sub4_Sub2_3.method4810();
				local32 = Static67.anInt1637 + (local23 >> 4 & 0x7);
				local40 = (local23 & 0x7) + Static7.anInt7240;
				local49 = Static212.aClass2_Sub4_Sub2_3.method4810();
				local53 = local49 >> 2;
				local57 = local49 & 0x3;
				...
				if (local23 >= 0 && local32 >= 0 && Static373.anInt7033 > local23 && Static242.anInt4449 > local32) {
					...
					@Pc(1208) Class11_Sub5_Sub4 local1208 = new Class11_Sub5_Sub4(local40, local53, Static114.anInt2348, Static243.anInt4502, local57, Static386.method6031(local57, local63, Static243.anInt4502) - local49, local63, local23, local23, local32, local32);
					Static129.aClass135_20.method3539(new Class2_Sub2_Sub1(local1208));
				}
				...
				local57 = local49 & 0x7;
				local63 = Static212.aClass2_Sub4_Sub2_3.method4814();
				local69 = Static212.aClass2_Sub4_Sub2_3.method4814();
				...
				local12 = Static212.aClass2_Sub4_Sub2_3.method4862();
				local23 = Static67.anInt1637 + (local12 >> 4 & 0x7);
				local32 = (local12 & 0x7) + Static7.anInt7240;
				local40 = Static212.aClass2_Sub4_Sub2_3.method4803();
				local49 = local40 >> 2;
				local53 = local40 & 0x3;
				...
				if (local23 >= 0 && local32 >= 0 && Static373.anInt7033 > local23 && local32 < Static242.anInt4449 && local40 >= 0 && local49 >= 0 && local40 < Static373.anInt7033 && local49 < Static242.anInt4449 && local57 != 65535) {
					...
					local181 = new Class11_Sub5_Sub3(local57, Static243.anInt4502, local23, local32, Static386.method6031(local23, local32, Static243.anInt4502) - local63, local73 + Static114.anInt2348, local77 + Static114.anInt2348, local81, local85, local53, local69);
					local181.method4396(Static386.method6031(local40, local49, Static243.anInt4502) - local69, local40, Static114.anInt2348 + local73, local49);
					Static332.aClass135_38.method3539(new Class2_Sub2_Sub9(local181));
				}
			} else if (Static109.aClass210_4 == arg0) {
				local12 = Static212.aClass2_Sub4_Sub2_3.method4828();
				local23 = Static212.aClass2_Sub4_Sub2_3.method4805();
				local32 = Static212.aClass2_Sub4_Sub2_3.method4814();
				local40 = (local32 >> 4 & 0x7) + Static67.anInt1637;
				local49 = Static7.anInt7240 + (local32 & 0x7);
				...
				Static262.method6252(null, "T3 - " + arg0);
				Static99.method2144();
			}
		}
	}
