...
public final class Static244 {
	...
	public static Class166 method4240(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class35[] arg1) {
		for (@Pc(1) int local1 = 0; local1 < arg1.length; local1++) {
			if (arg1[local1] == null || arg1[local1].id <= 0) {
				return null;
			}
		}
		...
		for (local26 = 0; local26 < arg1.length; local26++) {
			local21.glAttachObjectARB(local24, arg1[local26].id);
		}
		...
		if (anIntArray293[0] == 0) {
			...
			if (anIntArray293[0] == 0) {
				for (local26 = 0; local26 < arg1.length; local26++) {
					local21.glDetachObjectARB(local24, arg1[local26].id);
				}
