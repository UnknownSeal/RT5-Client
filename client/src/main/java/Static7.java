...
public final class Static7 {
	...
	public static void method6463(@OriginalArg(0) Class2_Sub4_Sub2 arg0, @OriginalArg(2) int arg1) {
		@Pc(15) boolean local15 = arg0.method4867(1) == 1;
		if (local15) {
			Static52.anIntArray100[Static325.anInt6079++] = arg1;
		}
		@Pc(30) int local30 = arg0.method4867(2);
		...
		if (local30 != 0) {
			...
			if (local30 == 1) {
				...
				if (local15) {
					...
					local34.method4067(local146, local141, Static335.aByteArray92[arg1]);
				}
			} else if (local30 == 2) {
				local136 = arg0.method4867(4);
				local141 = local34.anIntArray316[0];
				local146 = local34.anIntArray317[0];
				if (local136 == 0) {
					local141 -= 2;
				...
				local136 = arg0.method4867(1);
				@Pc(411) int local411;
				@Pc(419) int local419;
				@Pc(432) int local432;
				@Pc(439) int local439;
				if (local136 == 0) {
					local141 = arg0.method4867(12);
					...
					if (local15) {
						...
						local34.method4067(local439, local432, Static335.aByteArray92[arg1]);
					}
			...
			if (arg0.method4867(1) != 0) {
				Static386.method6032(arg0, arg1);
			}
		}
	}
	...
	public static int method6465(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
	...
	public static void method6469(@OriginalArg(0) Class21 arg0, @OriginalArg(1) int arg1) {
		...
		Static1.aLong1 = Static204.method3684();
