...
public final class Class95 {
	...
	public void method2504(@OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1) {
		if (this.anInt2490 != 0 & (arg1 != this.anInt2491 | arg0)) {
			this.aClass33Array1[Integer.MAX_VALUE & this.anInt2490].method5711(arg1);
			this.anInt2491 = arg1;
		}
	}
	...
	public void method2505(@OriginalArg(0) boolean arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2) {
		...
		if (arg2 != this.anInt2490) {
			if (this.anInt2490 != 0) {
				this.aClass33Array1[Integer.MAX_VALUE & this.anInt2490].method5714();
			}
			if (arg2 != 0) {
				this.aClass33Array1[Integer.MAX_VALUE & arg2].method5713(arg1);
				this.aClass33Array1[Integer.MAX_VALUE & arg2].method5712(arg1);
			}
			this.anInt2490 = arg2;
			this.aClass8_1 = null;
	...
	public boolean method2506() {
		return this.aClass33Array1[3].method5710();
	}
	...
	public boolean method2507(@OriginalArg(0) Class8 arg0) {
		...
		if (arg0 != this.aClass8_1) {
			this.aClass33Array1[this.anInt2490 & Integer.MAX_VALUE].method5709(arg0);
			this.aClass8_1 = arg0;
		}
		return true;
	}
