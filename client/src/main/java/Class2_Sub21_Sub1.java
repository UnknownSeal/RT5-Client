...
public final class Class2_Sub21_Sub1 extends Class2_Sub21 {
	...
	public Class2_Sub21_Sub1 method3178(@OriginalArg(0) Resampler arg0) {
		this.aByteArray31 = arg0.method6445(this.aByteArray31);
		this.anInt3176 = arg0.method6444(this.anInt3176);
		if (this.anInt3178 == this.anInt3177) {
			this.anInt3178 = this.anInt3177 = arg0.method6446(this.anInt3178);
		} else {
			this.anInt3178 = arg0.method6446(this.anInt3178);
			this.anInt3177 = arg0.method6446(this.anInt3177);
			if (this.anInt3178 == this.anInt3177) {
				this.anInt3178--;
			}
		}
