...
public final class Static90 {
	...
	public static void method5949(@OriginalArg(0) Class90 arg0, @OriginalArg(1) Class67 arg1) {
		...
		if (Static186.aClass6Array2 == Static365.aClass6Array4) {
			Static16.aClass19_10.method2866(Static330.aClass6Array3[0].method5727(local21, local27), Static357.method5986(local6, local9), Static168.method6475(local6, local9), Static51.method1548(local6, local9));
			local53 = 251.5F;
		} else {
		...
		if (arg1.aBoolean138) {
			...
			if (arg1.aClass67_1 != null) {
				...
				if (!Static35.method1106(local86.aByte7, local6, local9)) {
					Static365.aClass6Array4[local86.aByte7].method5719(local6, local9);
				}
				...
				if (local249 != null) {
					if (Static161.aBoolean208) {
						if ((local249.anInt3482 & arg1.aShort21) == 0) {
							...
							Static173.method3315(arg0, local249.anInt3482, local15, local6, local9);
						}
						Static16.aClass19_10.method2834(arg0.anInt7113, arg0.aClass2_Sub26_Sub1Array3);
					}
					local249.method6072(Static16.aClass19_10);
				}
				for (@Pc(286) Class22 local286 = local86.aClass22_2; local286 != null; local286 = local286.aClass22_1) {
					...
					if (local290 != null) {
						...
						local290.method6072(Static16.aClass19_10);
					}
				}
				Static16.aClass19_10.method2823(3000.0F, local53 * 1.5F);
			}
			...
			if (local330) {
				Static365.aClass6Array4[local15].method5719(local6, local9);
				...
				if (local341 != null && local341.aBoolean238) {
					...
					local377 = local341.method6072(Static16.aClass19_10);
					if (local377 != null) {
			...
			if (local411 != null) {
				...
				if ((local411.anInt3482 & local408) != 0 && !Static45.method1401(local15, local6, local9, local411.anInt3482)) {
					...
					@Pc(563) Class12_Sub4 local563 = local411.method6072(Static16.aClass19_10);
					if (local563 != null) {
				...
				if (local584 != null && (local584.anInt3482 & local408) != 0 && !Static45.method1401(local15, local6, local9, local584.anInt3482)) {
					...
					local616 = local584.method6072(Static16.aClass19_10);
					if (local616 != null) {
			...
			if (local414 != null && !Static65.method1734(local15, local6, local9, local414.method5747())) {
				...
				if ((local414.anInt6346 & local408) != 0) {
					...
					local616 = local414.method6072(Static16.aClass19_10);
					if (local616 != null) {
					...
					if (local735 < local723) {
						local759 = local414.method6072(Static16.aClass19_10);
						if (local759 != null) {
						...
						local759 = local647.method6072(Static16.aClass19_10);
						if (local759 != null) {
			...
			if (local330) {
				...
				if (local814 != null && !local814.aBoolean238) {
					...
					local616 = local814.method6072(Static16.aClass19_10);
					if (local616 != null) {
				...
				if (local880 != null && !local880.aBoolean259) {
					...
					@Pc(903) Class12_Sub4 local903 = local880.method6072(Static16.aClass19_10);
					if (local903 != null) {
		...
		if (arg1.aByte9 != 0) {
			...
			if (local330) {
				...
				if (!Static45.method1401(local15, local6, local9, local1057.anInt3482)) {
					...
					@Pc(1216) Class12_Sub4 local1216 = local1057.method6072(Static16.aClass19_10);
					if (local1216 != null) {
		...
		if (arg1.aBoolean137) {
			try {
				...
				while (local1245 > 0) {
					...
					if (!Static305.method5222(local15, local1384.aShort103, local1384.aShort104, local1384.aShort101, local1384.aShort102, local1384.method6079())) {
						if (Static161.aBoolean208) {
							if (local1384.aByte77 == 0) {
								Static324.method5535(arg0, local12, local1384.aShort103, local1384.aShort101, local1384.aShort104, local1384.aShort102);
							} else {
								Static156.method2796(arg0, local12, local6, local9);
								...
								if (local1384.aByte77 == 2) {
									if (local711 > -local706) {
										Static296.method5102(arg0, local12, local6, local9 - 1, local6 - 1, local9);
									} else {
										Static296.method5102(arg0, local12, local6, local9 + 1, local6 + 1, local9);
									}
						...
						local616 = local1384.method6072(Static16.aClass19_10);
						if (local616 != null) {
		...
		if (arg1.aClass224_1 != null && arg1.aByte13 == (byte) (Static292.anInt5512 & 0xFF)) {
			...
			local406 = Static365.aClass6Array4[local12].method5718(local6, local9);
			if (local12 < Static92.anInt1914 - 1) {
				local408 = Static365.aClass6Array4[local12].method5718(local6, local9) - Static365.aClass6Array4[local12 + 1].method5718(local6, local9);
			} else {
				local408 = 1024;
			}
			Static51.aClass14_2.method3933(local21, local406, local27, arg0.anIntArray487);
			local1074 = arg0.anIntArray487[2];
			Static51.aClass14_2.method3933(local21, local406 - local408, local27, arg0.anIntArray487);
		...
		if (local1862 != null && local1862.aBoolean259) {
			...
			@Pc(1885) Class12_Sub4 local1885 = local1862.method6072(Static16.aClass19_10);
			if (local1885 != null) {
		...
		if (arg1.aShort21 != 0) {
			...
			if (local1909 != null && !Static65.method1734(local15, local6, local9, local1909.method5747())) {
				if ((local1909.anInt6346 & arg1.aShort21) != 0) {
					if (Static161.aBoolean208) {
						Static156.method2796(arg0, local12, local6, local9);
						Static16.aClass19_10.method2834(arg0.anInt7113, arg0.aClass2_Sub26_Sub1Array3);
					}
					local377 = local1909.method6072(Static16.aClass19_10);
					if (local377 != null) {
					...
					if (local706 > local1333) {
						local2027 = local1909.method6072(Static16.aClass19_10);
						if (local2027 != null) {
						...
						local2027 = local2019.method6072(Static16.aClass19_10);
						if (local2027 != null) {
			...
			if (local411 != null && (local411.anInt3482 & arg1.aShort21) != 0 && !Static45.method1401(local15, local6, local9, local411.anInt3482)) {
				if (Static161.aBoolean208) {
					Static173.method3315(arg0, local411.anInt3482, local12, local6, local9);
					Static16.aClass19_10.method2834(arg0.anInt7113, arg0.aClass2_Sub26_Sub1Array3);
				}
				local2112 = local411.method6072(Static16.aClass19_10);
				if (local2112 != null) {
			...
			if (local1057 != null && (local1057.anInt3482 & arg1.aShort21) != 0 && !Static45.method1401(local15, local6, local9, local1057.anInt3482)) {
				if (Static161.aBoolean208) {
					Static173.method3315(arg0, local1057.anInt3482, local12, local6, local9);
					Static16.aClass19_10.method2834(arg0.anInt7113, arg0.aClass2_Sub26_Sub1Array3);
				}
				local2112 = local1057.method6072(Static16.aClass19_10);
				if (local2112 != null) {
