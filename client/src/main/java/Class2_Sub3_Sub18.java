...
public final class Class2_Sub3_Sub18 extends Class2_Sub3 {
	...
	public void method6483(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 == 0) {
			this.anInt3263 = this.anInt3265 = arg1.method4814();
		} else if (arg0 == 1) {
			this.anInt3261 = arg1.method4814();
		} else if (arg0 == 2) {
			this.anInt3257 = arg1.method4828();
		} else if (arg0 == 3) {
			this.anInt3264 = arg1.method4814();
		} else if (arg0 == 4) {
			this.anInt3256 = arg1.method4814();
		} else if (arg0 == 5) {
			this.anInt3263 = arg1.method4814();
		} else if (arg0 == 6) {
			this.anInt3265 = arg1.method4814();
		}
	}
	...
	private void method3258() {
		...
		if (this.anInt3257 > 0) {
			for (@Pc(24) int local24 = 0; local24 < 512; local24++) {
				this.aShortArray55[local24] = (short) Static382.method6360(this.anInt3257, local12);
			}
		}
	}
	...
	public int[] method6484(@OriginalArg(1) int arg0) {
		...
		if (super.aClass158_41.aBoolean265) {
			@Pc(30) int local30 = this.anInt3265 * Static16.anIntArray322[arg0] + 2048;
