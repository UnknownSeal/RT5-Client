...
public final class Static235 {
	...
	public static void method3338(@OriginalArg(0) Class152 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class2_Sub4 arg2) {
		...
		local9.anInt7154 = arg2.method4814();
		local9.anInt7156 = arg2.method4835();
		...
		for (@Pc(56) int local56 = 0; local56 < local9.anInt7154; local56++) {
			try {
				@Pc(62) int local62 = arg2.method4814();
				@Pc(78) String local78;
				@Pc(82) String local82;
				@Pc(84) int local84;
				if (local62 == 0 || local62 == 1 || local62 == 2) {
					local78 = arg2.method4808();
					local82 = arg2.method4808();
					local84 = 0;
					if (local62 == 1) {
						local84 = arg2.method4835();
					}
	...
	public static boolean method3340() {
		try {
			...
			Static262.method6252(local21, local81);
			Static99.method2144();
			return true;
		}
	}
