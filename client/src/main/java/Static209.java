...
public final class Static209 {
	...
	public static void method3713(@OriginalArg(1) Class19 arg0, @OriginalArg(2) Interface2 arg1) {
		...
		if (Static355.loadPercentage == 10) {
			Static344.anInt6057 = Static344.aMap_3.anInt6870 >> 6 << 6;
			Static344.anInt6055 = Static344.aMap_3.anInt6863 >> 6 << 6;
			Static344.anInt6056 = (Static344.aMap_3.anInt6868 >> 6 << 6) + 64 - Static344.anInt6057;
			Static344.anInt6052 = (Static344.aMap_3.anInt6874 >> 6 << 6) + 64 - Static344.anInt6055;
			@Pc(80) int[] local80 = new int[3];
			@Pc(82) int local82 = -1;
			@Pc(84) int local84 = -1;
			if (Static344.aMap_3.method6144(Static17.self.aByte78, local80, Static164.originX + (Static17.self.xFine >> 7), Static148.originZ + (Static17.self.zFine >> 7))) {
			...
			if (!Static299.aBoolean399 && local82 >= 0 && Static344.anInt6056 > local82 && local84 >= 0 && Static344.anInt6052 > local84) {
				...
				Static344.aMap_3.method6150(Static184.anInt3436, Static18.anInt519, local80);
				Static18.anInt519 = -1;
			...
			if (Static344.archive.isGroupNameValid(Static344.aMap_3.aString67 + "_staticelements")) {
				if (!Static344.archive.isGroupReady(Static344.aMap_3.aString67 + "_staticelements")) {
					return;
				}
				Static344.labels = MapElementList.create(Static344.archive, Static344.aMap_3.aString67 + "_staticelements", Static206.mapMembers);
			} else {
