...
public final class Class143 {
	...
	private void method3685(@OriginalArg(0) Class19_Sub1 arg0) {
		arg0.method817(true);
	...
	private void method3686(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1) {
		...
		this.aClass2_Sub4_Sub1_2.anInt5300 = 0;
		@Pc(83) int local83;
		@Pc(98) int local98;
		@Pc(104) int local104;
			...
			for (local83 = arg1 - 1; local83 >= 0; local83--) {
				...
				if (local98 > 0) {
					for (local104 = local98 - 1; local104 >= 0; local104--) {
						...
						this.aClass2_Sub4_Sub1_2.method4841(local121);
						this.aClass2_Sub4_Sub1_2.method4841(local126);
						this.aClass2_Sub4_Sub1_2.method4841(local129);
						this.aClass2_Sub4_Sub1_2.method4841(local134);
					...
					if (this.anIntArray223[local83] > 64) {
						...
						for (local424 = this.anIntArray222[local104] - 1; local424 >= 0; local424--) {
							...
							this.aClass2_Sub4_Sub1_2.method4841(local129);
							this.aClass2_Sub4_Sub1_2.method4841(local134);
							this.aClass2_Sub4_Sub1_2.method4841(local454);
							this.aClass2_Sub4_Sub1_2.method3058(1.0F);
							this.aClass2_Sub4_Sub1_2.method3058(0.0F);
			...
			for (local83 = arg1 - 1; local83 >= 0; local83--) {
				...
				if (local98 > 0) {
					for (local104 = local98 - 1; local104 >= 0; local104--) {
						...
						local152 = local113.anInt4467 >> Static111.anInt2254;
						local157 = local113.anInt4472 >> Static111.anInt2254;
						this.aClass2_Sub4_Sub1_2.method3057(0.0F);
						this.aClass2_Sub4_Sub1_2.method3057(0.0F);
						this.aClass2_Sub4_Sub1_2.method3057(local140 + local40 * (float) -local157);
						this.aClass2_Sub4_Sub1_2.method3057(local146 + local44 * (float) -local157);
						this.aClass2_Sub4_Sub1_2.method3057(local152 + local48 * (float) -local157);
						this.aClass2_Sub4_Sub1_2.method4841(local121);
						this.aClass2_Sub4_Sub1_2.method4841(local126);
						this.aClass2_Sub4_Sub1_2.method4841(local129);
						this.aClass2_Sub4_Sub1_2.method4841(local134);
						this.aClass2_Sub4_Sub1_2.method3057(1.0F);
						this.aClass2_Sub4_Sub1_2.method3057(0.0F);
						this.aClass2_Sub4_Sub1_2.method3057(local140 + local52 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3057(local146 + local56 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3057(local152 + local60 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method4841(local121);
						this.aClass2_Sub4_Sub1_2.method4841(local126);
						this.aClass2_Sub4_Sub1_2.method4841(local129);
						this.aClass2_Sub4_Sub1_2.method4841(local134);
						...
						this.aClass2_Sub4_Sub1_2.method3057(0.0F);
						this.aClass2_Sub4_Sub1_2.method3057(1.0F);
						this.aClass2_Sub4_Sub1_2.method3057(local140 + local64 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3057(local146 + local68 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3057(local152 + local72 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method4841(local121);
						this.aClass2_Sub4_Sub1_2.method4841(local126);
						this.aClass2_Sub4_Sub1_2.method4841(local129);
						this.aClass2_Sub4_Sub1_2.method4841(local134);
					...
					if (this.anIntArray223[local83] > 64) {
						...
						for (local424 = this.anIntArray222[local104] - 1; local424 >= 0; local424--) {
							...
							this.aClass2_Sub4_Sub1_2.method3057(0.0F);
							this.aClass2_Sub4_Sub1_2.method3057(0.0F);
							this.aClass2_Sub4_Sub1_2.method3057(local146 + local40 * (float) -local477);
							this.aClass2_Sub4_Sub1_2.method3057(local152 + local44 * (float) -local477);
							this.aClass2_Sub4_Sub1_2.method3057(local472 + local48 * (float) -local477);
							this.aClass2_Sub4_Sub1_2.method4841(local126);
							this.aClass2_Sub4_Sub1_2.method4841(local129);
							this.aClass2_Sub4_Sub1_2.method4841(local134);
							this.aClass2_Sub4_Sub1_2.method4841(local454);
							this.aClass2_Sub4_Sub1_2.method3057(1.0F);
							this.aClass2_Sub4_Sub1_2.method3057(0.0F);
							this.aClass2_Sub4_Sub1_2.method3057(local146 + local52 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3057(local152 + local56 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3057(local472 + local60 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method4841(local126);
							this.aClass2_Sub4_Sub1_2.method4841(local129);
							this.aClass2_Sub4_Sub1_2.method4841(local134);
							this.aClass2_Sub4_Sub1_2.method4841(local454);
							...
							this.aClass2_Sub4_Sub1_2.method3057(0.0F);
							this.aClass2_Sub4_Sub1_2.method3057(1.0F);
							this.aClass2_Sub4_Sub1_2.method3057(local146 + local64 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3057(local152 + local68 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3057(local472 + local72 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method4841(local126);
							this.aClass2_Sub4_Sub1_2.method4841(local129);
							this.aClass2_Sub4_Sub1_2.method4841(local134);
							this.aClass2_Sub4_Sub1_2.method4841(local454);
		...
		if (this.aClass2_Sub4_Sub1_2.anInt5300 != 0) {
			this.anInterface5_5.method4601(24, this.aClass2_Sub4_Sub1_2.aByteArray73, this.aClass2_Sub4_Sub1_2.anInt5300);
			arg0.method790(this.aClass126_9, null, this.aClass126_7, this.aClass126_8);
			arg0.method835(this.aClass2_Sub4_Sub1_2.anInt5300 / 24);
		}
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lclient!bf;Lclient!tp;)V")
	public void method3687(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class224 arg1) {
	...
	private void method3688(@OriginalArg(0) Class19_Sub1 arg0) {
	...
	public void method3689(@OriginalArg(0) Class19_Sub1 arg0) {
