...
public final class Class221_Sub1 extends Class221 {
	...
	@Override
	public void method6331(@OriginalArg(0) int arg0) throws LineUnavailableException {
		try {
			@Pc(20) Info local20 = new Info(SourceDataLine.class, this.anAudioFormat1, arg0 << (Static354.aBoolean93 ? 2 : 1));
	...
	@Override
	public void method6326(@OriginalArg(0) Component arg0) {
	...
	@Override
	protected int method6320() {
		return this.anInt6765 - (this.aSourceDataLine1.available() >> (Static354.aBoolean93 ? 2 : 1));
	}
	...
	protected void method6321() throws LineUnavailableException {
		...
		this.aSourceDataLine1.close();
		this.aSourceDataLine1 = null;
		@Pc(33) Info local33 = new Info(SourceDataLine.class, this.anAudioFormat1, this.anInt6765 << (Static354.aBoolean93 ? 2 : 1));
