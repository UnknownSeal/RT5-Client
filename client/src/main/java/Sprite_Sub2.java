...
public final class Sprite_Sub2 extends Sprite {
	...
	@Override
	public void method6396(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_42.anOpengl1;
		@Pc(7) int local7 = arg0 + arg2;
		@Pc(11) int local11 = arg1 + arg3;
		this.aClass8_Sub1_Sub1_5.method6159(false);
		...
		@Pc(130) int local130 = this.method6398();
		@Pc(133) int local133 = this.method6383();
	...
	@Override
	public void method6400(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_42.anOpengl1;
		this.aClass8_Sub1_Sub1_5.method6159(false);
		this.aClass19_Sub1_42.method824();
		this.aClass19_Sub1_42.method779(1);
		...
		this.aClass8_Sub1_Sub1_4.method6159(false);
		local3.glBegin(GL.GL_QUADS);
	...
	@Override
	public void method6394(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_42.anOpengl1;
		this.aClass8_Sub1_Sub1_5.method6159(true);
		this.aClass19_Sub1_42.method824();
		this.aClass19_Sub1_42.method779(arg6);
		local3.glColor4ub((byte) (arg5 >> 16), (byte) (arg5 >> 8), (byte) arg5, (byte) (arg5 >> 24));
		if (this.aBoolean484) {
			@Pc(40) float local40 = (float) arg2 / (float) this.method6398();
			@Pc(47) float local47 = (float) arg3 / (float) this.method6383();
			...
			if (this.aClass8_Sub1_Sub1_4 == null) {
				...
				this.method6402(arg4);
				this.aClass8_Sub1_Sub1_4.method6159(true);
				local3.glBegin(GL.GL_QUADS);
				local3.glMultiTexCoord2f(GL.GL_TEXTURE1, 0.0F, this.aClass8_Sub1_Sub1_5.aFloat43);
				local3.glTexCoord2f(0.0F, this.aClass8_Sub1_Sub1_5.aFloat43);
				local3.glVertex2f(local56, local65);
	...
	@OriginalMember(owner = "client!wg", name = "a", descriptor = "()I")
	@Override
	public int method6381() {
		return this.aClass8_Sub1_Sub1_5.anInt3687;
	}

	@OriginalMember(owner = "client!wg", name = "a", descriptor = "(FFFFFFIII)V")
	@Override
	protected void method6393(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(6) float local6;
		@Pc(10) float local10;
		if (this.aBoolean484) {
			local6 = this.method6398();
			local10 = this.method6383();
	...
	@Override
	protected void method6386(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class78 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		@Pc(32) float local32;
		if (this.aBoolean484) {
			local10 = this.method6398();
			local14 = this.method6383();
	...
	@Override
	public void method6389(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.aClass8_Sub1_Sub1_5.method3635(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!wg", name = "a", descriptor = "(III)V")
	@Override
	public void method6391(@OriginalArg(2) int arg0) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_42.anOpengl1;
		...
		this.aClass8_Sub1_Sub1_4 = Static401.method3641(0, 0, this.aClass8_Sub1_Sub1_5.anInt3688, this.aClass8_Sub1_Sub1_5.anInt3687, this.aClass19_Sub1_42);
		this.anInt7161 = arg0;
	...
	@Override
	public void method6382(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class78 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
