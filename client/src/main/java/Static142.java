	...
	public static void method2663() {
		...
		try {
			...
			if (Static141.anInt2652 == 2) {
				...
				local119 = Static335.aBufferedSocket_4.method2800();
				if (Static303.aClass221_2 != null) {
					Static303.aClass221_2.method6324();
				}
				if (Static190.aClass221_1 != null) {
			...
			if (Static141.anInt2652 == 3) {
				...
				Static163.aStringArray23 = new String[Static335.aBufferedSocket_4.method2800()];
				Static141.anInt2652 = 4;
			}
			if (Static141.anInt2652 == 4 && Static335.aBufferedSocket_4.method2795() >= Static163.aStringArray23.length * 8) {
				Static212.aClass2_Sub4_Sub2_3.offset = 0;
				Static335.aBufferedSocket_4.method2793(Static212.aClass2_Sub4_Sub2_3.data, Static163.aStringArray23.length * 8, 0);
