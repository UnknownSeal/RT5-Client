...
public final class Static386 {
	...
	public static Class89 aClass89_236 = new Class89(67, -1);
	...
	public static boolean method6032(@OriginalArg(0) Class2_Sub4_Sub2 arg0, @OriginalArg(2) int arg1) {
		@Pc(8) int local8 = arg0.method4867(2);
		@Pc(31) int local31;
		@Pc(36) int local36;
		@Pc(103) int local103;
		@Pc(107) int local107;
		...
		if (local8 == 0) {
			...
			local31 = arg0.method4867(6);
			local36 = arg0.method4867(6);
			@Pc(48) boolean local48 = arg0.method4867(1) == 1;
			if (local48) {
