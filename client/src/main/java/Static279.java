...
public final class Static279 {
	...
	public static Class79 aClass79_111 = new Class79("Loading title screen - ", "Lade Titelbild - ", "Chargement de l'écran-titre - ", "Carregando tela título - ");
	...
	public static void method4723() {
		aClass2_Sub16_1 = null;
		aClass79_111 = null;
	}

	@OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILclient!wm;)V")
	public static void method4724(@OriginalArg(1) Class19 arg0) {
		...
		if (Static368.anInt6917 > 0) {
			...
			for (@Pc(137) int local137 = Static177.anInt3385; Static177.anInt3385 + local37 > local137 && Static368.anInt6917 > local137; local137++) {
				@Pc(148) String[] local148 = Static200.method3642('\b', Static124.aStringArray65[local137]);
				...
				for (@Pc(159) int local159 = 0; local159 < local148.length; local159++) {
					...
					Static276.aClass130_4.method5896(local168, -16777216, 350 - Static165.aClass239_3.anInt6846 - Static284.anInt5359 - Static78.anInt6309 * (local137 - Static177.anInt3385) - 2, -1, local148[local159]);
				}
			}
		}
		arg0.method2895(0, 0, Static250.anInt4665, 350);
