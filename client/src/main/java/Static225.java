...
public final class Static225 {
	...
	public static void method3953(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class14 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) byte[][][] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) byte arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) boolean arg17) {
		...
		for (@Pc(74) int local74 = 0; local74 < Static212.anInt3788 + Static212.anInt3788 + 2; local74++) {
			for (local77 = 0; local77 < Static212.anInt3788 + Static212.anInt3788 + 2; local77++) {
				...
				if (local84 >= 0 && local90 >= 0 && local84 < Static72.anInt1684 && local90 < Static210.anInt3773) {
					...
					@Pc(120) int local120 = Static330.aClass6Array3[Static330.aClass6Array3.length - 1].method5718(local84, local90) - 1000;
					@Pc(140) int local140 = Static186.aClass6Array2 == null ? Static330.aClass6Array3[0].method5718(local84, local90) + Static256.anInt4716 : Static186.aClass6Array2[0].method5718(local84, local90) + Static256.anInt4716;
		...
		if (Static161.aBoolean208) {
			for (local90 = 0; local90 < Static164.anInt3139; local90++) {
				Static306.aClass2_Sub26_Sub1Array2[local90].method4152(arg1, arg17);
			}
		}
		if (arg2 > 1) {
		...
		if (Static90.aClass67ArrayArrayArray4 != null) {
			...
			Static391.method6457(arg2, null, 0, (byte) 0, arg15, arg16);
			Static163.aClass15_1.method1586();
			Static163.aClass15_1.method1578(23);
			Static341.method5766(false);
		}
		Static391.method6457(arg2, arg7, arg13, arg14, arg15, arg16);
		Static163.aClass15_1.method1586();
	...
	public static void method3956() {
		...
		synchronized (Static349.A_SOFT_LRU_HASH_TABLE___58) {
			Static349.A_SOFT_LRU_HASH_TABLE___58.method2621();
		}
	}
}
