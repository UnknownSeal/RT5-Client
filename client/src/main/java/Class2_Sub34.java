...
public final class Class2_Sub34 extends Node {
	...
	public Class2_Sub34(@OriginalArg(0) Buffer arg0) {
		...
		local22 += arg0.offset - local46;
		@Pc(176) int local176 = arg0.offset;
		...
		@Pc(297) int local297 = arg0.offset;
		arg0.offset += local198;
		@Pc(306) int local306 = arg0.offset;
		arg0.offset += local39;
		@Pc(315) int local315 = arg0.offset;
		arg0.offset += local37;
		@Pc(324) int local324 = arg0.offset;
		arg0.offset += local35;
		@Pc(333) int local333 = arg0.offset;
		arg0.offset += local178;
		@Pc(342) int local342 = arg0.offset;
		arg0.offset += local182;
		@Pc(351) int local351 = arg0.offset;
		arg0.offset += local186;
		@Pc(360) int local360 = arg0.offset;
		arg0.offset += local31 + local33 + local39;
		@Pc(373) int local373 = arg0.offset;
		arg0.offset += local31;
		@Pc(382) int local382 = arg0.offset;
		arg0.offset += local200;
		@Pc(391) int local391 = arg0.offset;
		arg0.offset += local33;
		@Pc(400) int local400 = arg0.offset;
		arg0.offset += local180;
		@Pc(409) int local409 = arg0.offset;
		arg0.offset += local184;
		@Pc(418) int local418 = arg0.offset;
		arg0.offset += local188;
		@Pc(427) int local427 = arg0.offset;
		arg0.offset += local41;
		@Pc(436) int local436 = arg0.offset;
		arg0.offset += local35;
		@Pc(445) int local445 = arg0.offset;
		arg0.offset += local190;
		@Pc(454) int local454 = arg0.offset;
		arg0.offset += local192;
		@Pc(463) int local463 = arg0.offset;
		arg0.offset += local194;
		@Pc(472) int local472 = arg0.offset;
		arg0.offset += local196;
		@Pc(481) int local481 = arg0.offset;
		...
		label220: for (@Pc(548) int local548 = 0; local548 < local12; local548++) {
			...
			local499.offset += 4;
			@Pc(562) int local562 = local499.offset;
			...
			while (true) {
				while (true) {
					...
					if (local580 == 7) {
						...
						local499.p1(47);
						local499.p1(0);
						local499.psize4(local499.offset - local562);
						continue label220;
					}
					if (local580 == 23) {
						if (local587) {
	...
	public void method5448() {
		...
		this.aClass4_119 = new HashTable(16);
