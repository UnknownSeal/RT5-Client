...
public final class ParticleEmitterType {
	...
	private void decode(@OriginalArg(0) int opcode, @OriginalArg(2) Buffer buffer) {
		if (opcode == 1) {
			this.aShort93 = (short) buffer.g2();
			this.aShort95 = (short) buffer.g2();
			this.aShort94 = (short) buffer.g2();
			this.aShort96 = (short) buffer.g2();
			...
			this.anInt6612 = buffer.mg4();
			this.anInt6616 = buffer.mg4();
		} else if (opcode == 4) {
			this.anInt6595 = buffer.g1();
			this.anInt6580 = buffer.g1b();
		} else if (opcode == 5) {
			this.anInt6598 = this.anInt6610 = buffer.g2() << 12;
		} else if (opcode == 6) {
			this.anInt6592 = buffer.mg4();
			this.anInt6611 = buffer.mg4();
		} else if (opcode == 7) {
			this.anInt6586 = buffer.g2();
			this.anInt6570 = buffer.g2();
		} else if (opcode == 8) {
			this.anInt6566 = buffer.g2();
			this.anInt6573 = buffer.g2();
		} else {
			@Pc(145) int local145;
			@Pc(151) int local151;
			if (opcode == 9) {
				...
				for (local151 = 0; local151 < local145; local151++) {
					this.anIntArray456[local151] = buffer.g2();
				}
			} else if (opcode == 10) {
				local145 = buffer.g1();
				this.anIntArray458 = new int[local145];
				for (local151 = 0; local151 < local145; local151++) {
					this.anIntArray458[local151] = buffer.g2();
				}
			} else if (opcode == 12) {
				this.anInt6577 = buffer.g1b();
			} else if (opcode == 13) {
				this.anInt6587 = buffer.g1b();
			} else if (opcode == 14) {
				this.anInt6604 = buffer.g2();
			} else if (opcode == 15) {
				this.texture = buffer.g2();
			} else if (opcode == 16) {
				this.aBoolean454 = buffer.g1() == 1;
				this.anInt6597 = buffer.g2();
				this.anInt6601 = buffer.g2();
				this.aBoolean451 = buffer.g1() == 1;
			} else if (opcode == 17) {
				this.softwareID = buffer.g2();
			} else if (opcode == 18) {
				this.anInt6579 = buffer.mg4();
			} else if (opcode == 19) {
				this.anInt6578 = buffer.g1();
			} else if (opcode == 20) {
				this.anInt6574 = buffer.g1();
			} else if (opcode == 21) {
				this.anInt6617 = buffer.g1();
			} else if (opcode == 22) {
				this.anInt6596 = buffer.mg4();
			} else if (opcode == 23) {
				this.anInt6569 = buffer.g1();
			} else if (opcode == 24) {
				...
				for (local151 = 0; local151 < local145; local151++) {
					this.anIntArray459[local151] = buffer.g2();
				}
			} else if (opcode == 26) {
				this.aBoolean452 = false;
			} else if (opcode == 27) {
				this.anInt6614 = buffer.g2() << 12;
			} else if (opcode == 28) {
				this.anInt6600 = buffer.g1();
			} else if (opcode == 29) {
				buffer.g2b_dup();
			} else if (opcode == 30) {
				...
				this.anInt6598 = buffer.g2() << 12;
				this.anInt6610 = buffer.g2() << 12;
				return;
			}
		}
	}
