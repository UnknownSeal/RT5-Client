...
public final class Class33_Sub1 extends Class33 {
			...
			for (@Pc(54) int local54 = 0; local54 < 256; local54++) {
				...
				for (@Pc(67) int local67 = 0; local67 < 64; local67++) {
					if (this.aClass19_Sub1_35.aBoolean53) {
						...
						local52.method3057((float) local61[local67] / 4096.0F);
						local52.method3057((float) local65[local67] / 4096.0F);
						local52.method3057(1.0F);
						local52.method3057(1.0F);
					}
				}
			}
			@Pc(137) ByteBuffer local137 = ByteBuffer.allocateDirect(local52.anInt5300).order(ByteOrder.nativeOrder());
			local137.put(local52.aByteArray73, 0, local52.anInt5300);
			local137.flip();
	...
	public void method5713(@OriginalArg(0) boolean arg0) {
		...
		local7.glLoadMatrixf(this.aClass19_Sub1_35.aClass14_Sub2_1.method3940(), 0);
