...
public final class Class5_Sub3 extends Class5 {
	...
	@Override
	public int method4408(@OriginalArg(1) int arg0) {
		@Pc(4) long local4 = (long) arg0 * 1000000L;
		this.aLong139 += this.method4409();
		if (this.aLong139 < this.aLong140) {
			Static231.method4022((this.aLong140 - this.aLong139) / 1000000L);
