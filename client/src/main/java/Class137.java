...
public final class Class137 {
	...
	public Node method3559() {
		@Pc(23) Node local23;
		if (this.anInt3614 > 0 && this.aClass2_132 != this.aClass4_79.buckets[this.anInt3614 - 1]) {
			local23 = this.aClass2_132;
			this.aClass2_132 = local23.next;
			return local23;
		}
		while (this.anInt3614 < this.aClass4_79.bucketCount) {
			local23 = this.aClass4_79.buckets[this.anInt3614++].next;
			if (this.aClass4_79.buckets[this.anInt3614 - 1] != local23) {
				this.aClass2_132 = local23.next;
				return local23;
			}
		}
