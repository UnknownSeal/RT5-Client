...
public final class Class2_Sub3_Sub9 extends TextureOp {
	...
	public int[][] method6478(@OriginalArg(0) int arg0) {
		...
		if (super.aClass243_41.aBoolean478) {
			...
			for (@Pc(34) int local34 = 0; local34 < Static227.anInt4036; local34++) {
				...
				@Pc(47) int[][] local47 = this.method6482(0, Static216.anInt3798);
	...
	public int[] getMonochromeOutput(@OriginalArg(1) int y) {
		...
		if (super.aClass158_41.aBoolean265) {
			for (@Pc(25) int local25 = 0; local25 < Static227.anInt4036; local25++) {
				...
				@Pc(38) int[] local38 = this.method6472(0, Static216.anInt3798);
