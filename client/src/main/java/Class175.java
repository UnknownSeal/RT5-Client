...
public final class Class175 {
	...
	public Class175() {
		Static267.method4512(24);
		this.anInt4804 = Static267.method4512(16);
		this.anInt4805 = Static267.method4512(24);
		this.anIntArray329 = new int[this.anInt4805];
		@Pc(23) boolean local23 = Static267.method4521() != 0;
		@Pc(27) int local27;
		@Pc(32) int local32;
		@Pc(43) int local43;
		if (local23) {
			local27 = 0;
			local32 = Static267.method4512(5) + 1;
			while (local27 < this.anInt4805) {
				@Pc(41) int local41 = Static267.method4512(Static287.method4928(this.anInt4805 - local27));
			...
			@Pc(66) boolean local66 = Static267.method4521() != 0;
			for (local32 = 0; local32 < this.anInt4805; local32++) {
				if (local66 && Static267.method4521() == 0) {
					this.anIntArray329[local32] = 0;
				} else {
					this.anIntArray329[local32] = Static267.method4512(5) + 1;
				}
			}
		}
		this.method4439();
		local27 = Static267.method4512(4);
		if (local27 > 0) {
			@Pc(103) float local103 = Static267.method4511(Static267.method4512(32));
			@Pc(107) float local107 = Static267.method4511(Static267.method4512(32));
			local43 = Static267.method4512(4) + 1;
			@Pc(118) boolean local118 = Static267.method4521() != 0;
			@Pc(127) int local127;
			if (local27 == 1) {
				local127 = Static402.method4440(this.anInt4805, this.anInt4804);
			} else {
				local127 = this.anInt4805 * this.anInt4804;
			}
			this.anIntArray328 = new int[local127];
			for (@Pc(140) int local140 = 0; local140 < local127; local140++) {
				this.anIntArray328[local140] = Static267.method4512(local43);
			}
	...
	public float[] method4437() {
		return this.aFloatArrayArray7[this.method4438()];
	}

	@OriginalMember(owner = "client!p", name = "b", descriptor = "()I")
	public int method4438() {
		@Pc(1) int local1;
		for (local1 = 0; this.anIntArray330[local1] >= 0; local1 = Static267.method4521() == 0 ? local1 + 1 : this.anIntArray330[local1]) {
		}
