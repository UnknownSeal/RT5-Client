...
public final class Class2_Sub36 extends Class2 {
	...
	public void method5563(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(19) int local19;
		@Pc(38) int local38;
		if (this.anInt6095 != -1) {
	...
	public void method5566(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public void method5568(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(1) int local1 = 0;
		@Pc(3) Class2_Sub4 local3 = Static8.aClass2_Sub4_1;
		local3.anInt5300 = 0;
		@Pc(33) short[] local33;
		@Pc(22) int local22;
		@Pc(27) int local27;
				...
				if (local27 != 0 && local33 != null) {
					...
					while (local33.length > local45) {
						if ((0x1 << local43++ & local27) == 0) {
							...
							local1++;
							local3.method4842(local33[local45++] & 0xFFFF);
							local1++;
							local3.method4842(local33[local45++] & 0xFFFF);
							local1++;
							local3.method4842(local33[local45++] & 0xFFFF);
		...
		this.aClass180_Sub2_1.method6066(local3.aByteArray73, local3.anInt5300);
