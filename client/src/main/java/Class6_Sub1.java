...
public final class Class6_Sub1 extends Class6 {
	...
	public void method5716(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15) {
		...
		this.method5726(arg0, arg1, local7, local41, local12, local50, local17, local22, local27, local32, arg13, arg14, arg15, false);
	}
	...
	public void method5726(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		...
		for (@Pc(84) int local84 = 0; local84 < arg6.length; local84++) {
			...
			for (local121 = this.aClass4_7.get(local115); local121 != null; local121 = this.aClass4_7.nextWithKey()) {
	...
	public void method5728(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		...
		if (Static8.aClass2_Sub4_1.bytes.length < this.anInt180 * 2) {
	...
	public void method5717() {
		if (this.anInt185 > 0) {
			...
			for (local14 = 0; local14 < this.aClass2_Sub36Array1.length; local14++) {
				this.aClass2_Sub36Array1[local14].method5564(this.anInt185);
			}
			local14 = 24;
			if (this.anIntArrayArrayArray2 != null) {
				local14 += 4;
			...
			@Pc(149) HashTable local149 = new HashTable(Static351.method5854(this.anInt185));
					...
					if (this.anIntArrayArrayArray1[local155][local161] != null) {
						...
						for (@Pc(432) int local432 = 0; local432 < local208.length; local432++) {
							...
							if (local773 == null) {
								...
								local137.putFloat((float) (this.method5727(local445, local454) + local470));
							...
							for (local805 = 0; local805 < local386; local805++) {
								local153[local805].method5563(local502, local516, local500, local398);
							}
							this.anInt180++;
						}
					}
				...
				for (local161 = 0; local161 < this.anInt6319; local161++) {
					...
					if (local1145 != null) {
						...
						while (local1151 < local1145.length) {
							...
							if (local1180 != null) {
								local1180.method5566(local1149, local155, local161);
								local1190 = local1180;
							}
							if (local1184 != null) {
								local1184.method5566(local1149, local155, local161);
								if (local1190 == null || local1184.key < local1190.key) {
									local1190 = local1184;
								}
							}
							if (local1188 != null) {
								local1188.method5566(local1149, local155, local161);
							...
							if (local1190 != null) {
								if (local1180 != null) {
									local1190.method5567(local1162);
								}
								if (local1184 != null) {
									local1190.method5567(local1169);
								}
								if (local1188 != null) {
									local1190.method5567(local1176);
								}
								local1190.method5566(local1149, local155, local161);
							}
							local1149++;
						}
					}
			...
			for (@Pc(1359) int local1359 = 0; local1359 < this.aClass2_Sub36Array1.length; local1359++) {
				...
				local1369.method5565(this.anInt179);
			}
			Static367.method6143(this.aClass2_Sub36Array1, local1357);
			if (this.aClass100_1 != null) {
	...
	public void method5721(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		...
		if (Static8.aClass2_Sub4_1.bytes.length < this.anInt180 * 2) {
			...
			Static8.aClass2_Sub4_1.offset = 0;
		}
		...
		if (local288 > 0) {
			@Pc(418) Class180_Sub2 local418 = new Class180_Sub2(this.aClass19_Sub1_1, 5123, Static8.aClass2_Sub4_1.bytes, Static8.aClass2_Sub4_1.offset);
