...
public final class Class28 {
	...
	private void method947(@OriginalArg(0) Class2_Sub4 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt736 = arg0.method4828();
		} else if (arg1 == 2) {
			arg0.method4814();
		} else if (arg1 == 3) {
			this.anInt754 = arg0.method4835();
			this.anInt748 = arg0.method4835();
			this.anInt741 = arg0.method4835();
		} else if (arg1 == 4) {
			this.anInt753 = arg0.method4814();
			this.anInt750 = arg0.method4835();
		} else if (arg1 == 6) {
			this.anInt737 = arg0.method4814();
		} else if (arg1 == 8) {
			this.anInt743 = 1;
		} else if (arg1 == 9) {
			this.anInt746 = 1;
	...
	public void method949(@OriginalArg(1) Class2_Sub4 arg0) {
		while (true) {
			@Pc(14) int local14 = arg0.method4814();
			if (local14 == 0) {
				return;
			}
