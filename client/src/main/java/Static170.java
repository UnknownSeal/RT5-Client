...
public final class Static170 {
	...
	public static void method3230(@OriginalArg(1) Class29_Sub1 arg0, @OriginalArg(2) byte[][] arg1) {
		@Pc(8) int local8 = Static106.mapBytes.length;
		for (@Pc(18) int local18 = 0; local18 < local8; local18++) {
			@Pc(24) byte[] local24 = arg1[local18];
			if (local24 != null) {
				@Pc(37) int local37 = (Static291.mapSquares[local18] >> 8) * 64 - Static164.originX;
				@Pc(48) int local48 = (Static291.mapSquares[local18] & 0xFF) * 64 - Static148.originZ;
				Static37.method1135();
				arg0.method1109(Static171.collisionMap, local48, local24, local37, Static190.aClass19_8);
			}
		}
	}
}
