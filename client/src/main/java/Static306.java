...
public final class Static306 {
	...
	public static boolean method5251(@OriginalArg(1) Interface6 arg0) {
		...
		if (local10.anInt1316 == -1) {
			...
			return local22.anInt3751 == -1 ? true : local22.method3707();
		}
	}
	...
	public static void method5252(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(5) int arg3) {
		for (@Pc(6) Class12_Sub3 local6 = (Class12_Sub3) Static284.aClass36_7.method1415(); local6 != null; local6 = (Class12_Sub3) Static284.aClass36_7.method1420()) {
			if (Static114.loop >= local6.anInt3201) {
				...
				Static52.aClass130_1.method5899(local6.aString26, 0, arg0 + Static216.anIntArray231[1], local6.anInt3206 | 0xFF000000, Static216.anIntArray231[0] + arg3);
			}
		}
	}

	@OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIIB)V")
	public static void method5253(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
