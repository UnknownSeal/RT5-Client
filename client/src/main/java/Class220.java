...
public final class Class220 {
	...
	public void method5660(@OriginalArg(0) Class2_Sub4 arg0) {
		while (true) {
			@Pc(5) int local5 = arg0.method4814();
			if (local5 == 0) {
				return;
			}
			this.method5662(arg0, local5);
		}
	}

	@OriginalMember(owner = "client!te", name = "a", descriptor = "(ILclient!bt;I)V")
	private void method5662(@OriginalArg(1) Class2_Sub4 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.anInt6201 = arg0.method4828();
		} else if (arg1 == 2) {
			this.anInt6203 = arg0.method4814();
			this.anInt6200 = arg0.method4814();
		}
	}
}
