...
public final class Model_Sub1 extends Model {
	...
	public Model_Sub1(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) RawModel arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		this.aClass19_Sub2_3 = arg0;
		this.anInt984 = arg2;
		this.anInt982 = arg3;
		this.anInt983 = arg4;
		...
		if (arg1.anIntArray358 != null && (this.anInt984 & 0x20) != 0) {
			this.anIntArrayArray10 = arg1.method4660();
		}
		if (arg1.anIntArray357 != null && (this.anInt984 & 0x180) != 0) {
			this.anIntArrayArray12 = arg1.method4652();
		}
		@Pc(156) int local156;
	...
	private void method1240(@OriginalArg(0) Class14 arg0, @OriginalArg(1) Class12_Sub2 arg1, @OriginalArg(2) Class224 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		this.aClass250_2.anInt7222 = this.aClass81_1.anInt2265;
		...
		if (arg2 != null) {
			for (@Pc(1026) Class12_Sub1_Sub1 local1026 = (Class12_Sub1_Sub1) arg2.aClass191_1.method4889(); local1026 != null; local1026 = (Class12_Sub1_Sub1) arg2.aClass191_1.method4887()) {
	...
	public void method3814(@OriginalArg(0) int arg0) {
		...
		@Pc(13) int local13 = Class19.SINE[arg0];
	...
	public void method3844(@OriginalArg(0) int arg0) {
		if ((this.anInt984 & 0xD) != 13) {
			...
			@Pc(34) int local34 = Class19.SINE[arg0];
	...
	protected void method3833(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int[] arg7) {
		...
		if (arg0 == 2) {
			if (arg7 == null) {
				...
				local528 = Class19.SINE[arg2];
				local567 = Class19.COSINE[arg3];
				local571 = Class19.SINE[arg3];
				local575 = Class19.COSINE[arg4];
				local579 = Class19.SINE[arg4];
	...
	public void method3832(@OriginalArg(0) int arg0) {
		if ((this.anInt984 & 0x5) != 5) {
			...
			@Pc(31) int local31 = Class19.SINE[arg0];
	...
	public void method3818(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) Class6 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (arg0 == 1) {
			...
			if (arg0 == 2) {
				...
				this.method3847(local167, arg6, local175, arg5, arg2, arg4);
			} else if (arg0 == 4) {
			...
			if (local81 != 765) {
				if (local81 == 0) {
					...
					if (this.aShortArray11 != null && this.aShortArray11[arg0] != -1) {
						...
						this.aClass81_1.method2289(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], Static231.method4023(Static181.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local27 << 24 | this.aClass19_Sub2_3.anInt2853), Static231.method4023(Static181.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local46 << 24 | this.aClass19_Sub2_3.anInt2853), Static231.method4023(Static181.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local65 << 24 | this.aClass19_Sub2_3.anInt2853));
					} else {
						this.aClass81_1.method2289(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], Static231.method4023(Static181.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local27 << 24 | this.aClass19_Sub2_3.anInt2853), Static231.method4023(Static181.anIntArray204[this.anIntArray74[arg0] & 0xFFFF], local46 << 24 | this.aClass19_Sub2_3.anInt2853), Static231.method4023(Static181.anIntArray204[this.anIntArray52[arg0] & 0xFFFF], local65 << 24 | this.aClass19_Sub2_3.anInt2853));
					}
				}
			}
	...
	private void method1254(@OriginalArg(0) Class14_Sub1 arg0) {
		...
		for (local4 = 0; local4 < this.aClass163Array1.length; local4++) {
			...
			if (local332.aClass14_5 == null) {
				...
				local332.aClass14_5.method3923(arg0);
			}
				...
				for (@Pc(90) int local90 = 0; local90 < this.anInt986; local90++) {
					...
					if (local118 == -1) {
						...
						if (local96 == 0) {
							...
							this.anIntArray76[local90] = local228 << 17 | Static253.method4367(local163, local228);
							...
							local218 = local211 > 256 ? local61 : local70;
							local228 = (local52 >> 1) + (local218 * local211 >> 17);
							this.anIntArray74[local90] = local228 << 17 | Static253.method4367(local163, local228);
							...
							local218 = local211 > 256 ? local61 : local70;
							local228 = (local52 >> 1) + (local218 * local211 >> 17);
							this.anIntArray52[local90] = local228 << 17 | Static253.method4367(local163, local228);
						} else if (local96 == 1) {
							local146 = this.aShortArray8[local90] & 0xFFFF;
							local155 = (local146 & 0x7F) * this.anInt982 >> 7;
							local163 = Static26.method863(local146 & 0xFFFFFF80 | local155);
							...
							this.anIntArray76[local90] = local218 << 17 | Static253.method4367(local163, local218);
		...
		for (@Pc(8) int local8 = 0; local8 < this.anInt986; local8++) {
			...
			if (local19 == -1) {
				...
				if (this.anIntArray52[local8] == -1) {
					...
					this.anIntArray76[local8] = local59 | Static253.method4367(local46, local59 >> 17);
				} else if (this.anIntArray52[local8] != -2) {
					local59 = this.anIntArray76[local8] & 0xFFFE0000;
					this.anIntArray76[local8] = local59 | Static253.method4367(local46, local59 >> 17);
					local59 = this.anIntArray74[local8] & 0xFFFE0000;
					this.anIntArray74[local8] = local59 | Static253.method4367(local46, local59 >> 17);
					local59 = this.anIntArray52[local8] & 0xFFFE0000;
					this.anIntArray52[local8] = local59 | Static253.method4367(local46, local59 >> 17);
				}
			}
		}
		this.anInt979 = 2;
