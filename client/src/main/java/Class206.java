...
public final class Class206 implements Runnable {
	...
	public void run() {
		while (!this.aBoolean404) {
			...
			synchronized (this.aClass246_9) {
				local14 = (Class2_Sub2_Sub10_Sub2) this.aClass246_9.method6338();
				if (local14 == null) {
					try {
			...
			try {
				if (local14.anInt6199 == 2) {
					local14.aClass207_4.method5258(local14.aByteArray91.length, local14.aByteArray91, (int) local14.aLong215);
	...
	public Class2_Sub2_Sub10_Sub2 method5225(@OriginalArg(0) int arg0, @OriginalArg(2) Class207 arg1) {
	...
	public Class2_Sub2_Sub10_Sub2 method5226(@OriginalArg(0) int arg0, @OriginalArg(1) Class207 arg1) {
	...
	public Class2_Sub2_Sub10_Sub2 method5228(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class207 arg2) {
