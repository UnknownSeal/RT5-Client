...
public abstract class Model {
	...
	public abstract int method3804();
	...
	public final void method3810(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class2_Sub2_Sub13 arg8, @OriginalArg(9) Class2_Sub2_Sub13 arg9, @OriginalArg(10) int arg10, @OriginalArg(11) Class2_Sub2_Sub13 arg11, @OriginalArg(12) Class2_Sub2_Sub13 arg12, @OriginalArg(14) int arg13) {
		...
		if (arg2 == null || arg5 == -1) {
			...
			this.method3848(false, null, local36, arg2, local33, 65535, 0, arg1, arg4, local38, arg0);
			this.method3820(0, new int[0], 0, 0, 0, 0, arg4);
			this.method3848(true, null, local36, arg2, local63, 65535, 0, arg3, arg4, local65, arg10);
			this.method3835();
		}
	}

	@OriginalMember(owner = "client!gn", name = "h", descriptor = "()I")
	public abstract int method3811();

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(III)V")
	public abstract void method3812(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(I)V")
	public abstract void method3813(@OriginalArg(0) int arg0);
	...
	public abstract void method3815(@OriginalArg(0) short arg0, @OriginalArg(1) short arg1);

	@OriginalMember(owner = "client!gn", name = "i", descriptor = "()I")
	public abstract int method3816();

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lclient!nt;BI)V")
	public final void method3817(@OriginalArg(0) Class2_Sub2_Sub13 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == -1 || !this.method3803()) {
			return;
		}
		@Pc(19) Class159 local19 = arg0.aClass159Array1[arg1];
		@Pc(22) Class2_Sub18 local22 = local19.aClass2_Sub18_1;
		for (@Pc(28) int local28 = 0; local28 < local19.anInt4048; local28++) {
			@Pc(35) short local35 = local19.aShortArray82[local28];
			if (local22.aBooleanArray25[local35]) {
				if (local19.aShortArray89[local28] != -1) {
					this.method3824(0, 0, 0, 0);
				}
				this.method3824(local22.anIntArray168[local35], local19.aShortArray81[local28], local19.aShortArray87[local28], local19.aShortArray88[local28]);
			}
		}
		this.method3835();
	}
	...
	public abstract void method3818(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) Class6 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6);

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(IILclient!on;Z)Z")
	public abstract boolean method3819(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class14 arg2, @OriginalArg(3) boolean arg3);

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[IIIIIZ)V")
	protected abstract void method3820(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6);

	@OriginalMember(owner = "client!gn", name = "j", descriptor = "()I")
	public abstract int method3821();

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(IILclient!nt;IIIILclient!nt;ZZ[I)V")
	public final void method3822(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub13 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class2_Sub2_Sub13 arg6, @OriginalArg(8) boolean arg7, @OriginalArg(10) int[] arg8) {
		if (arg4 == -1 || !this.method3803()) {
			return;
		}
		...
		this.method3848(false, arg8, local19, null, local16, arg3, 0, arg1, arg7, local21, arg0);
		this.method3835();
	}

	@OriginalMember(owner = "client!gn", name = "d", descriptor = "(I)V")
	public abstract void method3823(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(IIII)V")
	protected abstract void method3824(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!gn", name = "k", descriptor = "()I")
	public abstract int method3825();
	...
	public final void method3827(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub2_Sub13 arg1, @OriginalArg(2) int arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class2_Sub2_Sub13 arg6, @OriginalArg(8) int arg7) {
		if (arg5 == -1 || !this.method3803()) {
			return;
		}
		...
		this.method3848(false, null, local25, null, local22, 65535, arg7, arg4, arg3, local27, arg0);
		this.method3835();
	}

	@OriginalMember(owner = "client!gn", name = "f", descriptor = "(I)V")
	public abstract void method3829(@OriginalArg(0) int arg0);
	...
	public abstract void method3834(@OriginalArg(0) Class14 arg0, @OriginalArg(1) Class12_Sub2 arg1, @OriginalArg(2) int arg2);
	...
	public abstract void method3837(@OriginalArg(0) short arg0, @OriginalArg(1) short arg1);

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lclient!kb;)Lclient!kb;")
	public abstract Class2_Sub2_Sub4 method3838(@OriginalArg(0) Class2_Sub2_Sub4 arg0);

	@OriginalMember(owner = "client!gn", name = "q", descriptor = "()[Lclient!nm;")
	public abstract Class163[] method3839();
	...
	public abstract void method3843(@OriginalArg(0) Class14 arg0, @OriginalArg(1) Class12_Sub2 arg1, @OriginalArg(2) int arg2);
	...
	private void method3845(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) boolean arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		@Pc(36) int local36;
		if (arg7 == 1) {
			if (arg1 == 0 || arg1 == 1) {
				local36 = -arg8;
		...
		if (arg3 == 65535) {
			this.method3820(arg1, arg5, arg8, arg0, arg4, arg7, arg6);
		} else {
			this.method3833(arg1, arg5, arg8, arg0, arg4, arg6, arg3, arg2);
		}
	}

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(IBIIILclient!tf;I)V")
	protected final void method3847(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class6 arg4, @OriginalArg(6) int arg5) {
		@Pc(14) int local14 = -arg0 / 2;
		@Pc(19) int local19 = -arg2 / 2;
		@Pc(29) int local29 = arg4.method5727(arg5 + local14, local19 + arg1);
		@Pc(33) int local33 = arg0 / 2;
		@Pc(38) int local38 = -arg2 / 2;
		@Pc(47) int local47 = arg4.method5727(local33 + arg5, local38 + arg1);
		@Pc(52) int local52 = -arg0 / 2;
		@Pc(56) int local56 = arg2 / 2;
		@Pc(65) int local65 = arg4.method5727(local52 + arg5, arg1 + local56);
		@Pc(69) int local69 = arg0 / 2;
		@Pc(73) int local73 = arg2 / 2;
		@Pc(82) int local82 = arg4.method5727(arg5 + local69, local73 + arg1);
		...
		if (local138 != 0) {
			this.method3812(0, local138, 0);
		}
	}

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z[ILclient!ib;[ZLclient!nd;IIIZBLclient!nd;I)V")
	private void method3848(@OriginalArg(0) boolean arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class2_Sub18 arg2, @OriginalArg(3) boolean[] arg3, @OriginalArg(4) Class159 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean arg8, @OriginalArg(10) Class159 arg9, @OriginalArg(11) int arg10) {
		@Pc(18) int local18;
		if (arg9 == null || arg7 == 0) {
			for (local18 = 0; local18 < arg4.anInt4048; local18++) {
				@Pc(25) short local25 = arg4.aShortArray82[local18];
				if (arg3 == null || arg0 == arg3[local25] || arg2.anIntArray168[local25] == 0) {
					@Pc(49) short local49 = arg4.aShortArray89[local18];
					if (local49 != -1) {
						this.method3845(0, 0, arg1, arg5 & arg2.anIntArray169[local49], 0, arg2.anIntArrayArray21[local49], arg8, arg6, 0);
					}
					this.method3845(arg4.aShortArray87[local18], arg2.anIntArray168[local25], arg1, arg5 & arg2.anIntArray169[local25], arg4.aShortArray88[local18], arg2.anIntArrayArray21[local25], arg8, arg6, arg4.aShortArray81[local18]);
				}
			}
			return;
		}
		...
		for (@Pc(121) int local121 = 0; local121 < arg2.anInt2679; local121++) {
			@Pc(125) boolean local125 = false;
			if (local18 < arg4.anInt4048 && arg4.aShortArray82[local18] == local121) {
				local125 = true;
			}
			@Pc(143) boolean local143 = false;
			if (arg9.anInt4048 > local119 && local121 == arg9.aShortArray82[local119]) {
				local143 = true;
			}
			if (local125 || local143) {
				if (arg3 == null || arg0 == arg3[local121] || arg2.anIntArray168[local121] == 0) {
					...
					if (local125) {
						local215 = arg4.aShortArray88[local18];
						local211 = arg4.aShortArray87[local18];
						local207 = arg4.aShortArray81[local18];
						local213 = arg4.aShortArray89[local18];
					...
					if (local143) {
						local250 = arg9.aShortArray87[local119];
						local255 = arg9.aShortArray89[local119];
						local260 = arg9.aByteArray44[local119];
						local265 = arg9.aShortArray88[local119];
						local270 = arg9.aShortArray81[local119];
						local119++;
					} else {
						local270 = local193;
						local260 = 0;
					...
					if (local213 != -1) {
						this.method3845(0, 0, arg1, arg2.anIntArray169[local213] & arg5, 0, arg2.anIntArrayArray21[local213], arg8, arg6, 0);
					} else if (local255 != -1) {
						this.method3845(0, 0, arg1, arg5 & arg2.anIntArray169[local255], 0, arg2.anIntArrayArray21[local255], arg8, arg6, 0);
					}
					@Pc(396) int local396;
					@Pc(406) int local406;
					@Pc(420) int local420;
					...
					this.method3845(local406, local198, arg1, arg5 & arg2.anIntArray169[local121], local420, arg2.anIntArrayArray21[local121], arg8, arg6, local396);
				} else {
					if (local143) {
						local119++;
					}
