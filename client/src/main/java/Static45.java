...
public final class Static45 {
	...
	public static void method1398() {
		...
		for (@Pc(111) int local111 = 0; local111 < Static166.size; local111++) {
			@Pc(118) Npc local118 = Static365.npcs[Static211.ids[local111]];
								...
								if (local6.anInt4273 != 0) {
									...
									if (local6.anInt4273 == Static135.anInt2521) {
										...
										if (Static343.aClass50_4 == Static106.aClass50_1) {
											Static1.method3(-1, true, local727, false, Static382.A_TRANSLATABLE_STRING___147.getLocalisedText(Static295.anInt5581), local719, 59, "", -1, 1L);
										}
