...
public final class Class173_Sub2 extends Class173 {
	...
	@Override
	public void method6249(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	}
	...
	public void method6250(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		Static312.method5310(local10, super.anInt6997, super.anInt6996, local29, local17, local36, super.anInt6998);
	}

	@OriginalMember(owner = "client!pd", name = "a", descriptor = "(IBI)V")
	@Override
	public void method6247(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		Static42.method5748(local31, local17, local10, local24, super.anInt6997);
	}
}
