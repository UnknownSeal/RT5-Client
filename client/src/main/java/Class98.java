...
public final class Class98 {
	...
	public Object method2612(@OriginalArg(1) long arg0) {
		...
		@Pc(25) Object local25 = local10.method5950();
		if (local25 == null) {
			local10.method6467();
			local10.method6142();
		...
		if (local10.method5953()) {
			...
			this.aClass246_2.method6340(local53);
			local53.aLong215 = 0L;
			local10.method6467();
			local10.method6142();
		} else {
			this.aClass246_2.method6340(local10);
			local10.aLong215 = 0L;
		}
		return local25;
	}
	...
	public int method2613() {
		@Pc(7) int local7 = 0;
		for (@Pc(18) Class2_Sub2_Sub6 local18 = (Class2_Sub2_Sub6) this.aClass246_2.method6336(); local18 != null; local18 = (Class2_Sub2_Sub6) this.aClass246_2.method6335()) {
			if (!local18.method5953()) {
				local7++;
			}
		}
		return local7;
	...
	public void method2615(@OriginalArg(0) int arg0) {
		...
		for (@Pc(9) Class2_Sub2_Sub6 local9 = (Class2_Sub2_Sub6) this.aClass246_2.method6336(); local9 != null; local9 = (Class2_Sub2_Sub6) this.aClass246_2.method6335()) {
			if (local9.method5953()) {
				if (local9.method5950() == null) {
					local9.method6467();
					local9.method6142();
					this.anInt2608++;
				}
			} else if (++local9.aLong215 > (long) arg0) {
				@Pc(35) Class2_Sub2_Sub6 local35 = Static308.aClass93_1.method3694(local9);
	...
	private void method2617(@OriginalArg(2) Object arg0, @OriginalArg(3) long arg1) {
		...
		while (this.anInt2608 < 0) {
			@Pc(36) Class2_Sub2_Sub6 local36 = (Class2_Sub2_Sub6) this.aClass246_2.method6338();
		...
		this.aClass246_2.method6340(local49);
		local49.aLong215 = 0;
	}
	...
	public Object method2618() {
		...
		while (local17 != null) {
			@Pc(23) Object local23 = local17.method5950();
			if (local23 != null) {
				return local23;
			}
	...
	public Object method2619() {
		...
		while (local11 != null) {
			@Pc(17) Object local17 = local11.method5950();
			if (local17 != null) {
				return local17;
			}
	...
	public void method2621() {
		for (@Pc(14) Class2_Sub2_Sub6 local14 = (Class2_Sub2_Sub6) this.aClass246_2.method6336(); local14 != null; local14 = (Class2_Sub2_Sub6) this.aClass246_2.method6335()) {
			if (local14.method5953()) {
				local14.method6467();
				local14.method6142();
