...
public final class Static49 {
	...
	public static Class145 aClass145_44 = new Class145(29, -1);

	@OriginalMember(owner = "client!cr", name = "g", descriptor = "Lclient!mc;")
	public static Class145 aClass145_45 = new Class145(35, 3);
			...
			for (@Pc(25) int local25 = local17; local25 < local17 + 104; local25++) {
				for (local29 = arg1; local29 <= 3; local29++) {
					if (Static142.method2661(local25, arg1, local29, local21)) {
						local40 = local29;
						if (Static325.method5544(local25, local21)) {
							local40 = local29 - 1;
						}
						if (local40 >= 0) {
							local19 &= Static235.method3339(local21, local40, local25);
						}
					}
				}
			}
		...
		for (@Pc(195) int local195 = local11; local195 < local11 + 104; local195 += Static285.anInt5368) {
			for (local199 = local17; local199 < local17 + 104; local199 += Static285.anInt5368) {
				...
				for (local216 = arg1; local216 <= 3; local216++) {
					...
					Static330.aClass6Array3[local216].method5721(local195, local199, local195 + Static285.anInt5368, Static285.anInt5368 + local199, local193);
						...
						for (local224 = -4; local224 < Static285.anInt5368; local224++) {
							for (local277 = -4; local277 < Static285.anInt5368; local277++) {
								...
								if (local11 <= local284 && local17 <= local288 && Static142.method2661(local288, arg1, local216, local284)) {
									local303 = local216;
									if (Static325.method5544(local288, local284)) {
										local303 = local216 - 1;
									}
									if (local303 >= 0) {
										Static282.method4873(local162, local40, local224 * 4, arg0, local284, (Static285.anInt5368 - local277) * 4 - 4, local303, local288);
									}
								}
							}
						}
							...
							if (local621 != null) {
								...
								if (!local662.aBoolean111 || Static206.aBoolean241) {
									...
									if (local284 >= 0) {
										...
										if (local284 >= 0) {
											@Pc(720) Class164 local720 = Static236.aClass125_1.method3378(local284);
				...
				for (local216 = 0; local216 < Static34.aClass103_3.anInt2702; local216++) {
					...
					if (Static17.aClass11_Sub5_Sub2_Sub1_3.aByte78 == local220 >> 28) {
						...
						if (local224 >= 0 && local224 < Static373.anInt7033 && local277 >= 0 && Static242.anInt4449 > local277) {
							Static56.aClass135_13.method3539(new Class2_Sub39(local216));
						} else {
