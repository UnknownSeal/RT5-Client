...
public final class Static240 {
	...
	public static void method4183(@OriginalArg(0) Class2_Sub20 arg0, @OriginalArg(1) Class164 arg1, @OriginalArg(2) Class19 arg2) {
		@Pc(10) Class13 local10 = arg1.method4182(arg2);
		if (local10 == null) {
			return;
		}
		@Pc(16) int local16 = local10.method6388();
		if (local10.method6381() > local16) {
			local16 = local10.method6381();
		}
		...
		if (arg1.aString48 != null) {
			local33 = Static52.aClass239_1.method6118(Static287.aStringArray52, arg1.aString48, null, null);
			for (local51 = 0; local51 < local33; local51++) {
				...
				local78 = Static2.aClass113_1.method2949(local57);
				if (local35 < local78) {
					local35 = local78;
				}
			}
			local37 = local33 * Static2.aClass113_1.method2947() + Static2.aClass113_1.method2946() / 2;
		}
		...
		local10.method6385((float) local16 / 2.0F + (float) local28, (float) local31 + (float) local16 / 2.0F, 4096, local78);
		...
		if (arg1.aString48 != null) {
			...
			local267 = local112 + Static2.aClass113_1.method2947() * local33 + 3;
			if (arg1.anInt4437 != 0) {
			...
			for (@Pc(335) int local335 = 0; local335 < local33; local335++) {
				...
				Static2.aClass113_1.method2950(arg2, local341, local51, local112, arg1.anInt4431);
				local112 += Static2.aClass113_1.method2947();
			}
		}
		...
		Static197.aClass135_24.method3539(local385);
	}
}
