	...
	public boolean method2268() {
		...
		synchronized (this.aClass55_2.aClass197_16) {
			for (@Pc(27) int local27 = 0; local27 < 5; local27++) {
				if (this.anIntArray141[local27] != -1 && !this.aClass55_2.aClass197_16.method5087(0, this.anIntArray141[local27])) {
					local7 = false;
				}
			}
			return local7;
	...
	public boolean method2270() {
		...
		synchronized (this.aClass55_2.aClass197_16) {
			for (@Pc(20) int local20 = 0; local20 < this.anIntArray142.length; local20++) {
				if (!this.aClass55_2.aClass197_16.method5087(0, this.anIntArray142[local20])) {
					local12 = false;
				}
			}
			return local12;
