...
public final class Class80 {
	...
	public Class185 method2273() {
		...
		@Pc(15) int local15 = 0;
		@Pc(19) Js5 local19 = this.aClass55_2.aJs5_16;
		synchronized (this.aClass55_2.aJs5_16) {
			for (@Pc(23) int local23 = 0; local23 < 5; local23++) {
				if (this.anIntArray141[local23] != -1) {
					local13[local15++] = Static298.method2426(this.aClass55_2.aJs5_16, this.anIntArray141[local23]);
				}
			}
		}
		...
		if (this.aShortArray43 != null) {
			for (local67 = 0; local67 < this.aShortArray43.length; local67++) {
				local62.method4662(this.aShortArray43[local67], this.aShortArray44[local67]);
			}
		}
		if (this.aShortArray45 != null) {
			for (local67 = 0; local67 < this.aShortArray45.length; local67++) {
				local62.method4657(this.aShortArray42[local67], this.aShortArray45[local67]);
			}
		}
		return local62;
	}
	...
	public Class185 method2275() {
		...
		@Pc(27) Js5 local27 = this.aClass55_2.aJs5_16;
		synchronized (this.aClass55_2.aJs5_16) {
			@Pc(31) int local31 = 0;
			while (true) {
				...
				local23[local31] = Static298.method2426(this.aClass55_2.aJs5_16, this.anIntArray142[local31]);
				local31++;
			}
		}
		...
		if (this.aShortArray43 != null) {
			for (local87 = 0; local87 < this.aShortArray43.length; local87++) {
				local73.method4662(this.aShortArray43[local87], this.aShortArray44[local87]);
			}
		}
		if (this.aShortArray45 != null) {
			for (local87 = 0; local87 < this.aShortArray45.length; local87++) {
				local73.method4657(this.aShortArray42[local87], this.aShortArray45[local87]);
			}
		}
		return local73;
	}
