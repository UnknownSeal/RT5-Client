...
public final class Class161 {
	...
	public void method4102(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		if (this.aStringArray40 == null || this.aStringArray40.length <= arg0) {
			@Pc(24) String[] local24 = new String[arg0 + 1];
			if (this.aStringArray40 != null) {
				for (@Pc(29) int local29 = 0; local29 < this.aStringArray40.length; local29++) {
					local24[local29] = this.aStringArray40[local29];
				}
			}
			this.aStringArray40 = local24;
		}
		this.aStringArray40[arg0] = arg1;
	}
	...
	public Class31 method4104(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class107 arg2, @OriginalArg(3) Interface11 arg3, @OriginalArg(5) Class157 arg4, @OriginalArg(6) Class7 arg5, @OriginalArg(7) Class117 arg6, @OriginalArg(8) Class219 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class85 arg9, @OriginalArg(11) int arg10, @OriginalArg(12) Class55 arg11, @OriginalArg(13) Class19 arg12) {
		...
		if (this.anInt4288 == 0) {
			...
			if (this.anInt4288 == 1) {
				...
				if (arg4 != null) {
					local61 = arg4.method3985(local61, arg8, arg10, arg0, arg1);
				}
				local61.method3813(1024);
				return local61;
			}
			@Pc(151) Class31 local151;
			if (this.anInt4288 == 2) {
				local151 = arg7.method5569(this.anInt4313).method2088(arg0, arg1, arg8, arg12, arg4, arg3, arg9);
				if (local151 == null) {
					Static86.aBoolean133 = true;
					return null;
				} else {
				...
				local151 = arg6.method3183(arg8, arg9, arg3, arg0, arg4, arg7, arg11, arg12, arg1, arg2);
				if (local151 == null) {
					Static86.aBoolean133 = true;
					return null;
				} else {
				...
				local61 = local205.method4775(arg0, 1024, arg1, arg4, arg12, 10, arg6, arg8);
				if (local61 == null) {
					Static86.aBoolean133 = true;
					return null;
				} else {
				...
				local151 = arg7.method5569(this.anInt4313).method2086(arg5, arg8, arg4, arg12, arg9, 0, 0, 0, null, 1024, null, arg0, arg3, arg1);
				if (local151 == null) {
					Static86.aBoolean133 = true;
					return null;
				} else {
				...
				@Pc(301) Class31 local301 = arg6.method3184(local284, local281, arg11, arg4, arg1, local276, arg9, arg12, arg8, arg0);
				if (local301 == null) {
					Static86.aBoolean133 = true;
					return null;
				} else {
	...
	public void method4105(@OriginalArg(1) Class2_Sub4 arg0) {
		arg0.anInt5300++;
		this.anInt4272 = arg0.method4814();
		if ((this.anInt4272 & 0x80) != 0) {
			this.anInt4272 &= 0x7F;
			this.aString43 = arg0.method4808();
		}
		this.anInt4273 = arg0.method4828();
		this.anInt4241 = arg0.method4822();
		this.anInt4249 = arg0.method4822();
		this.anInt4294 = arg0.method4828();
		this.anInt4289 = arg0.method4828();
		this.aByte47 = arg0.method4824();
		this.aByte44 = arg0.method4824();
		this.aByte45 = arg0.method4824();
		this.aByte46 = arg0.method4824();
		this.anInt4275 = arg0.method4828();
		if (this.anInt4275 == 65535) {
			this.anInt4275 = -1;
		} else {
			this.anInt4275 += this.anInt4317 & 0xFFFF0000;
		}
		this.aBoolean284 = arg0.method4814() == 1;
		if (this.anInt4272 == 0) {
			this.anInt4281 = arg0.method4828();
			this.anInt4266 = arg0.method4828();
			this.aBoolean295 = arg0.method4814() == 1;
		}
		@Pc(155) int local155;
		if (this.anInt4272 == 5) {
			this.anInt4295 = arg0.method4835();
			this.anInt4308 = arg0.method4828();
			local155 = arg0.method4814();
			this.aBoolean283 = (local155 & 0x2) != 0;
			this.aBoolean286 = (local155 & 0x1) != 0;
			this.anInt4311 = arg0.method4814();
			this.anInt4279 = arg0.method4814();
			this.anInt4252 = arg0.method4835();
			this.aBoolean281 = arg0.method4814() == 1;
			this.aBoolean285 = arg0.method4814() == 1;
			this.anInt4290 = arg0.method4835();
		}
		if (this.anInt4272 == 6) {
			this.anInt4288 = 1;
			this.anInt4313 = arg0.method4828();
			if (this.anInt4313 == 65535) {
				this.anInt4313 = -1;
			}
			this.anInt4307 = arg0.method4822();
			this.anInt4253 = arg0.method4822();
			this.anInt4320 = arg0.method4828();
			this.anInt4274 = arg0.method4828();
			this.anInt4319 = arg0.method4828();
			this.anInt4255 = arg0.method4828();
			this.anInt4299 = arg0.method4828();
			if (this.anInt4299 == 65535) {
				this.anInt4299 = -1;
			}
			this.aBoolean290 = arg0.method4814() == 1;
			this.aShort62 = (short) arg0.method4828();
			this.aShort61 = (short) arg0.method4828();
			this.aBoolean289 = arg0.method4814() == 1;
			if (this.aByte47 != 0) {
				this.anInt4251 = arg0.method4828();
			}
			if (this.aByte44 != 0) {
				this.anInt4269 = arg0.method4828();
			}
		}
		if (this.anInt4272 == 4) {
			this.anInt4318 = arg0.method4828();
			if (this.anInt4318 == 65535) {
				this.anInt4318 = -1;
			}
			this.aString47 = arg0.method4808();
			this.anInt4303 = arg0.method4814();
			this.anInt4298 = arg0.method4814();
			this.anInt4293 = arg0.method4814();
			this.aBoolean291 = arg0.method4814() == 1;
			this.anInt4290 = arg0.method4835();
		}
		if (this.anInt4272 == 3) {
			this.anInt4290 = arg0.method4835();
			this.aBoolean293 = arg0.method4814() == 1;
			this.anInt4311 = arg0.method4814();
		}
		if (this.anInt4272 == 9) {
			this.anInt4237 = arg0.method4814();
			this.anInt4290 = arg0.method4835();
			this.aBoolean292 = arg0.method4814() == 1;
		}
		local155 = arg0.method4832();
		@Pc(449) int local449 = arg0.method4814();
		@Pc(474) int local474;
		if (local449 != 0) {
			...
			while (local449 != 0) {
				...
				local449 = local449 << 8 | arg0.method4814();
				local449 &= 0xFFF;
				if (local449 == 4095) {
				...
				this.aByteArray49[local474] = arg0.method4824();
				if (this.aByteArray49[local474] != 0) {
					this.aBoolean282 = true;
				}
				this.aByteArray50[local474] = arg0.method4824();
				local449 = arg0.method4814();
			}
		}
		this.aString45 = arg0.method4808();
		local474 = arg0.method4814();
		@Pc(545) int local545 = local474 & 0xF;
		@Pc(556) int local556;
		if (local545 > 0) {
			this.aStringArray40 = new String[local545];
			for (local556 = 0; local556 < local545; local556++) {
				this.aStringArray40[local556] = arg0.method4808();
			}
		}
		@Pc(577) int local577 = local474 >> 4;
		if (local577 > 0) {
			local556 = arg0.method4814();
			...
			this.anIntArray279[local556] = arg0.method4828();
		}
		if (local577 > 1) {
			local556 = arg0.method4814();
			this.anIntArray279[local556] = arg0.method4828();
		}
		this.aString46 = arg0.method4808();
		if (this.aString46.equals("")) {
			this.aString46 = null;
		}
		this.anInt4239 = arg0.method4814();
		this.anInt4271 = arg0.method4814();
		this.anInt4285 = arg0.method4814();
		this.aString44 = arg0.method4808();
		local556 = -1;
		if (Static13.method346(local155) != 0) {
			local556 = arg0.method4828();
			if (local556 == 65535) {
				local556 = -1;
			}
			this.anInt4238 = arg0.method4828();
			if (this.anInt4238 == 65535) {
				this.anInt4238 = -1;
			}
			this.anInt4286 = arg0.method4828();
			if (this.anInt4286 == 65535) {
				this.anInt4286 = -1;
			}
		}
		this.aClass2_Sub10_1 = new Class2_Sub10(local155, local556);
		this.anObjectArray22 = this.method4106(arg0);
		this.anObjectArray13 = this.method4106(arg0);
		this.anObjectArray9 = this.method4106(arg0);
		this.anObjectArray32 = this.method4106(arg0);
		this.anObjectArray15 = this.method4106(arg0);
		this.anObjectArray10 = this.method4106(arg0);
		this.anObjectArray29 = this.method4106(arg0);
		this.anObjectArray5 = this.method4106(arg0);
		this.anObjectArray23 = this.method4106(arg0);
		this.anObjectArray27 = this.method4106(arg0);
		this.anObjectArray12 = this.method4106(arg0);
		this.anObjectArray14 = this.method4106(arg0);
		this.anObjectArray28 = this.method4106(arg0);
		this.anObjectArray30 = this.method4106(arg0);
		this.anObjectArray16 = this.method4106(arg0);
		this.anObjectArray31 = this.method4106(arg0);
		this.anObjectArray8 = this.method4106(arg0);
		this.anObjectArray21 = this.method4106(arg0);
		this.anObjectArray19 = this.method4106(arg0);
		this.anObjectArray7 = this.method4106(arg0);
		this.anIntArray273 = this.method4107(arg0);
		this.anIntArray281 = this.method4107(arg0);
		this.anIntArray274 = this.method4107(arg0);
		this.anIntArray278 = this.method4107(arg0);
		this.anIntArray277 = this.method4107(arg0);
	}

	@OriginalMember(owner = "client!nk", name = "b", descriptor = "(ILclient!bt;)[Ljava/lang/Object;")
	private Object[] method4106(@OriginalArg(1) Class2_Sub4 arg0) {
		...
		for (@Pc(28) int local28 = 0; local28 < local9; local28++) {
			...
			if (local34 == 0) {
				local19[local28] = Integer.valueOf(arg0.method4835());
			} else if (local34 == 1) {
				local19[local28] = arg0.method4808();
			}
		}
	...
	private int[] method4107(@OriginalArg(1) Class2_Sub4 arg0) {
		@Pc(9) int local9 = arg0.method4814();
		if (local9 == 0) {
			return null;
		}
		...
		for (@Pc(29) int local29 = 0; local29 < local9; local29++) {
			local27[local29] = arg0.method4835();
		}
		return local27;
	}

	@OriginalMember(owner = "client!nk", name = "a", descriptor = "(BLclient!wm;)Lclient!kf;")
	public Class78 method4108(@OriginalArg(1) Class19 arg0) {
