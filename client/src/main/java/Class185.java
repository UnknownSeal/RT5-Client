...
public final class Class185 {
		...
		for (@Pc(354) int local354 = 0; local354 < arg1; local354++) {
			...
			if (local365 != null) {
				for (@Pc(369) int local369 = 0; local369 < local365.anInt5071; local369++) {
					...
					this.aShortArray97[this.anInt5071] = (short) this.method4656(local361, local365.aShortArray97[local369], local365);
					this.aShortArray105[this.anInt5071] = (short) this.method4656(local361, local365.aShortArray105[local369], local365);
					this.aShortArray102[this.anInt5071] = (short) this.method4656(local361, local365.aShortArray102[local369], local365);
				...
				if (local365.aClass114Array3 != null) {
					for (local542 = 0; local542 < local365.aClass114Array3.length; local542++) {
						local555 = this.method4656(local361, local365.aClass114Array3[local542].anInt2918, local365);
						local566 = this.method4656(local361, local365.aClass114Array3[local542].anInt2926, local365);
						@Pc(577) int local577 = this.method4656(local361, local365.aClass114Array3[local542].anInt2920, local365);
				...
				if (local365.aClass163Array3 != null) {
					for (local542 = 0; local542 < local365.aClass163Array3.length; local542++) {
						local555 = this.method4656(local361, local365.aClass163Array3[local542].anInt4333, local365);
		...
		for (@Pc(658) int local658 = 0; local658 < arg1; local658++) {
			...
			if (local669 != null) {
				...
				for (local566 = 0; local566 < local669.anInt5072; local566++) {
					...
					if (local721 == 0) {
						this.aShortArray104[this.anInt5072] = (short) this.method4656(local665, local669.aShortArray104[local566], local669);
						this.aShortArray106[this.anInt5072] = (short) this.method4656(local665, local669.aShortArray106[local566], local669);
						this.aShortArray101[this.anInt5072] = (short) this.method4656(local665, local669.aShortArray101[local566], local669);
					}
	...
	private void method4651(@OriginalArg(1) byte[] arg0) {
		...
		this.anInt5075 = local10.method4828();
		this.anInt5071 = local10.method4828();
		this.anInt5072 = local10.method4814();
		@Pc(73) int local73 = local10.method4814();
		@Pc(82) boolean local82 = (local73 & 0x1) == 1;
		@Pc(93) boolean local93 = (local73 & 0x2) == 2;
		@Pc(97) int local97 = local10.method4814();
		@Pc(101) int local101 = local10.method4814();
		@Pc(105) int local105 = local10.method4814();
		@Pc(109) int local109 = local10.method4814();
		@Pc(113) int local113 = local10.method4814();
		@Pc(117) int local117 = local10.method4828();
		@Pc(121) int local121 = local10.method4828();
		@Pc(125) int local125 = local10.method4828();
		@Pc(129) int local129 = local10.method4828();
		@Pc(133) int local133 = local10.method4828();
		...
		if (this.anInt5072 > 0) {
			...
			for (local155 = 0; local155 < this.anInt5072; local155++) {
				@Pc(166) byte local166 = this.aByteArray67[local155] = local10.method4824();
				if (local166 == 0) {
					local135++;
				}
				if (local166 == 2) {
		...
		for (@Pc(545) int local545 = 0; local545 < this.anInt5075; local545++) {
			local551 = local10.method4814();
			@Pc(553) int local553 = 0;
			if ((local551 & 0x1) != 0) {
				local553 = local15.method4817();
			}
			@Pc(563) int local563 = 0;
			if ((local551 & 0x2) != 0) {
				local563 = local20.method4817();
			}
			@Pc(573) int local573 = 0;
			if ((local551 & 0x4) != 0) {
				local573 = local25.method4817();
			}
			...
			if (local113 == 1) {
				this.anIntArray358[local545] = local30.method4814();
			}
		}
		...
		for (local551 = 0; local551 < this.anInt5071; local551++) {
			this.aShortArray108[local551] = (short) local10.method4828();
			if (local82) {
				this.aByteArray64[local551] = local15.method4824();
			}
			if (local97 == 255) {
				this.aByteArray61[local551] = local20.method4824();
			}
			if (local101 == 1) {
				this.aByteArray63[local551] = local25.method4824();
			}
			if (local105 == 1) {
				this.anIntArray357[local551] = local30.method4814();
			}
			if (local109 == 1) {
				this.aShortArray98[local551] = (short) (local35.method4828() - 1);
			}
			if (this.aByteArray70 != null) {
				if (this.aShortArray98[local551] == -1) {
					this.aByteArray70[local551] = -1;
				} else {
					this.aByteArray70[local551] = (byte) (local48.method4814() - 1);
				}
			}
		}
		...
		for (@Pc(778) int local778 = 0; local778 < this.anInt5071; local778++) {
			local784 = local15.method4814();
			if (local784 == 1) {
				local770 = (short) (local776 + local10.method4817());
				local772 = (short) (local10.method4817() + local770);
				local774 = (short) (local10.method4817() + local772);
				local776 = local774;
			...
			if (local784 == 2) {
				local772 = local774;
				local774 = (short) (local10.method4817() + local776);
				local776 = local774;
				this.aShortArray97[local778] = local770;
				this.aShortArray105[local778] = local772;
				this.aShortArray102[local778] = local774;
		...
		for (local784 = 0; local784 < this.anInt5072; local784++) {
			...
			if (local1014 == 0) {
				this.aShortArray104[local784] = (short) local10.method4828();
				this.aShortArray106[local784] = (short) local10.method4828();
				this.aShortArray101[local784] = (short) local10.method4828();
			}
			if (local1014 == 1) {
				this.aShortArray104[local784] = (short) local15.method4828();
				this.aShortArray106[local784] = (short) local15.method4828();
				this.aShortArray101[local784] = (short) local15.method4828();
				this.aShortArray96[local784] = (short) local20.method4828();
				this.aShortArray99[local784] = (short) local20.method4828();
				this.aShortArray103[local784] = (short) local20.method4828();
				this.aByteArray68[local784] = local25.method4824();
				this.aByteArray66[local784] = local30.method4824();
				this.aByteArray65[local784] = local35.method4824();
			}
			if (local1014 == 2) {
				this.aShortArray104[local784] = (short) local15.method4828();
				this.aShortArray106[local784] = (short) local15.method4828();
				...
				this.aByteArray66[local784] = local30.method4824();
				this.aByteArray65[local784] = local35.method4824();
				this.aByteArray69[local784] = local35.method4824();
				this.aByteArray62[local784] = local35.method4824();
			}
			if (local1014 == 3) {
				this.aShortArray104[local784] = (short) local15.method4828();
				this.aShortArray106[local784] = (short) local15.method4828();
		...
		if (local1014 > 0) {
			...
			for (local1304 = 0; local1304 < local1014; local1304++) {
				local1310 = local10.method4828();
				@Pc(1314) int local1314 = local10.method4828();
		...
		local1304 = local10.method4814();
		if (local1304 <= 0) {
			return;
		}
		this.aClass163Array3 = new Class163[local1304];
		for (local1310 = 0; local1310 < local1304; local1310++) {
			this.aClass163Array3[local1310] = new Class163(local10.method4828(), local10.method4828());
		}
		return;
	}
	...
	private void method4653(@OriginalArg(1) byte[] arg0) {
		...
		this.anInt5075 = local14.method4828();
		this.anInt5071 = local14.method4828();
		this.anInt5072 = local14.method4814();
		@Pc(59) int local59 = local14.method4814();
		@Pc(63) int local63 = local14.method4814();
		@Pc(67) int local67 = local14.method4814();
		@Pc(71) int local71 = local14.method4814();
		@Pc(75) int local75 = local14.method4814();
		@Pc(79) int local79 = local14.method4828();
		@Pc(83) int local83 = local14.method4828();
		@Pc(87) int local87 = local14.method4828();
		@Pc(91) int local91 = local14.method4828();
		...
		for (@Pc(344) int local344 = 0; local344 < this.anInt5075; local344++) {
			local350 = local14.method4814();
			local352 = 0;
			if ((local350 & 0x1) != 0) {
				local352 = local19.method4817();
			}
			@Pc(365) int local365 = 0;
			if ((local350 & 0x2) != 0) {
				local365 = local24.method4817();
			}
			@Pc(378) int local378 = 0;
			if ((local350 & 0x4) != 0) {
				local378 = local29.method4817();
			}
			...
			if (local75 == 1) {
				this.anIntArray358[local344] = local34.method4814();
			}
		}
		...
		for (local350 = 0; local350 < this.anInt5071; local350++) {
			this.aShortArray108[local350] = (short) local14.method4828();
			if (local59 == 1) {
				local352 = local19.method4814();
				if ((local352 & 0x1) == 1) {
			...
			if (local63 == 255) {
				this.aByteArray61[local350] = local24.method4824();
			}
			if (local67 == 1) {
				this.aByteArray63[local350] = local29.method4824();
			}
			if (local71 == 1) {
				this.anIntArray357[local350] = local34.method4814();
			}
		}
		this.anInt5087 = -1;
		...
		for (@Pc(602) int local602 = 0; local602 < this.anInt5071; local602++) {
			local608 = local19.method4814();
			if (local608 == 1) {
				local594 = (short) (local600 + local14.method4817());
				local596 = (short) (local14.method4817() + local594);
				local598 = (short) (local596 + local14.method4817());
				local600 = local598;
			...
			if (local608 == 2) {
				local596 = local598;
				local598 = (short) (local14.method4817() + local600);
				local600 = local598;
				this.aShortArray97[local602] = local594;
				this.aShortArray105[local602] = local596;
				this.aShortArray102[local602] = local598;
			...
			if (local608 == 3) {
				local594 = local598;
				local598 = (short) (local600 + local14.method4817());
				local600 = local598;
				this.aShortArray97[local602] = local594;
				this.aShortArray105[local602] = local596;
				this.aShortArray102[local602] = local598;
		...
		for (local608 = 0; local608 < this.anInt5072; local608++) {
			...
			this.aShortArray104[local608] = (short) local14.method4828();
			this.aShortArray106[local608] = (short) local14.method4828();
			this.aShortArray101[local608] = (short) local14.method4828();
		}
		if (this.aByteArray70 != null) {
	...
	public int method4658(@OriginalArg(0) short arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(4) int arg3, @OriginalArg(5) byte arg4, @OriginalArg(6) int arg5, @OriginalArg(7) short arg6, @OriginalArg(8) byte arg7) {
	...
	public void method4663(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(7) int local7;
		@Pc(11) int local11;
		@Pc(13) int local13;
		@Pc(32) int local32;
	...
	public int method4664(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		for (@Pc(7) int local7 = 0; local7 < this.anInt5075; local7++) {
