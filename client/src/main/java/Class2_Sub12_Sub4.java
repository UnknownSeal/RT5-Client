...
public final class Class2_Sub12_Sub4 extends PcmStream {
	...
	public int method4975() {
		...
		if (this.anInt5486 == 0) {
			local6 -= local6 * this.anInt5490 / (((PcmSound) super.sound).aByteArray31.length << 8);
		} else if (this.anInt5486 >= 0) {
			local6 -= local6 * this.anInt5478 / ((PcmSound) super.sound).aByteArray31.length;
		}
	...
	public synchronized void read(@OriginalArg(0) int[] samples, @OriginalArg(1) int offset, @OriginalArg(2) int length) {
		...
		@Pc(13) PcmSound local13 = (PcmSound) super.sound;
	...
	private int method4994(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		do {
			if (this.anInt5483 <= 0) {
				if (this.anInt5489 == -256 && (this.anInt5490 & 0xFF) == 0) {
					if (AudioChannel.stereo) {
						return Static405.method5011(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, arg3, arg2, this);
					}
					return Static405.method4995(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, arg3, arg2, this);
				}
				if (AudioChannel.stereo) {
					return Static405.method5001(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, arg3, arg2, this, this.anInt5489, arg4);
				}
				return Static405.method4982(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, arg3, arg2, this, this.anInt5489, arg4);
			}
			...
			if (this.anInt5489 == -256 && (this.anInt5490 & 0xFF) == 0) {
				if (AudioChannel.stereo) {
					arg1 = Static405.method5016(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, this.anInt5484, this.anInt5485, local5, arg2, this);
				} else {
					arg1 = Static405.method5004(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, this.anInt5480, local5, arg2, this);
				}
			} else if (AudioChannel.stereo) {
				arg1 = Static405.method5012(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, this.anInt5484, this.anInt5485, local5, arg2, this, this.anInt5489, arg4);
			} else {
				arg1 = Static405.method4998(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, this.anInt5480, local5, arg2, this, this.anInt5489, arg4);
			}
			this.anInt5483 -= arg1;
			if (this.anInt5483 != 0) {
				return arg1;
	...
	public boolean method5000() {
		return this.anInt5490 < 0 || this.anInt5490 >= ((PcmSound) super.sound).aByteArray31.length << 8;
	}
	...
	public synchronized void skip(@OriginalArg(0) int length) {
		...
		@Pc(71) PcmSound local71 = (PcmSound) super.sound;
	...
	private int method5013(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		do {
			if (this.anInt5483 <= 0) {
				if (this.anInt5489 == 256 && (this.anInt5490 & 0xFF) == 0) {
					if (AudioChannel.stereo) {
						return Static405.method4979(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, arg3, arg2, this);
					}
					return Static405.method4992(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, arg3, arg2, this);
				}
				if (AudioChannel.stereo) {
					return Static405.method5002(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, arg3, arg2, this, this.anInt5489, arg4);
				}
				return Static405.method5007(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, arg3, arg2, this, this.anInt5489, arg4);
			}
			@Pc(5) int local5 = arg1 + this.anInt5483;
			if (local5 > arg3) {
				local5 = arg3;
			...
			if (this.anInt5489 == 256 && (this.anInt5490 & 0xFF) == 0) {
				if (AudioChannel.stereo) {
					arg1 = Static405.method4986(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, this.anInt5484, this.anInt5485, local5, arg2, this);
				} else {
					arg1 = Static405.method5008(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, this.anInt5480, local5, arg2, this);
				}
			} else if (AudioChannel.stereo) {
				arg1 = Static405.method4991(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5481, this.anInt5482, this.anInt5484, this.anInt5485, local5, arg2, this, this.anInt5489, arg4);
			} else {
				arg1 = Static405.method5010(((PcmSound) super.sound).aByteArray31, arg0, this.anInt5490, arg1, this.anInt5488, this.anInt5480, local5, arg2, this, this.anInt5489, arg4);
			}
			this.anInt5483 -= arg1;
			if (this.anInt5483 != 0) {
				return arg1;
	...
	public synchronized void method5014(@OriginalArg(0) int arg0) {
		@Pc(7) int local7 = ((PcmSound) super.sound).aByteArray31.length << 8;
		if (arg0 < -1) {
			arg0 = -1;
		}
		if (arg0 > local7) {
