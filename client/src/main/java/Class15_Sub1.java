	...
	public void method553(@OriginalArg(0) Class90_Sub1 arg0) {
		...
		try {
			...
			if (!local7) {
				...
				Static90.method5949(arg0, (Class67) arg0.anObject7);
			} else if (local45 == 20) {
				@Pc(167) Class67 local167 = (Class67) arg0.anObject7;
				if (local167.aClass11_Sub1_3 != null) {
					local167.aClass11_Sub1_3.method6069(Static16.aClass19_10);
				}
				if (local167.aClass11_Sub1_2 != null) {
					local167.aClass11_Sub1_2.method6069(Static16.aClass19_10);
				}
				if (local167.aClass11_Sub3_2 != null) {
					local167.aClass11_Sub3_2.method6069(Static16.aClass19_10);
				}
				if (local167.aClass11_Sub3_3 != null) {
					local167.aClass11_Sub3_3.method6069(Static16.aClass19_10);
				}
				if (local167.aClass11_Sub2_2 != null) {
					local167.aClass11_Sub2_2.method6069(Static16.aClass19_10);
				}
				for (@Pc(210) Class22 local210 = local167.aClass22_2; local210 != null; local210 = local210.aClass22_1) {
					local210.aClass11_Sub5_1.method6069(Static16.aClass19_10);
				}
			} else if (local45 >= 30 && local45 <= 33) {
				Static16.aClass19_10.method2823(3000.0F, local11 * 1.5F);
				((Class6) arg0.anObject7).method5728(Static248.anInt4650, Static211.anInt3780, Static212.anInt3788, Static6.aBooleanArrayArray1, local45 - 30 == 0);
			} else if (local45 >= 40 && local45 <= 43) {
				Static16.aClass19_10.method2823(3000.0F, local11 * 1.5F);
				((Class6) arg0.anObject7).method5728(Static248.anInt4650, Static211.anInt3780, Static212.anInt3788, Static364.aBooleanArrayArray5, local45 - 40 == 0);
			} else if (local45 == 22) {
	...
	public void method1582(@OriginalArg(1) int arg0) {
		...
		synchronized (this.anObject1) {
			...
			if (arg0 == this.anInt533) {
				...
				for (local18 = 0; local18 < this.anInt533; local18++) {
					this.aClass90_Sub1Array1[local18].method6345();
				}
				this.anInt533 = arg0;
				...
				for (@Pc(74) int local74 = 0; local74 < this.anInt533; local74++) {
					...
					this.aClass90_Sub1Array1[local74].method6344();
					this.method552(local7++);
				}
			}
		}
