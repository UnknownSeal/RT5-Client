...
public final class Static117 {
	...
	public static void method2367(@OriginalArg(1) Class19 arg0) {
		...
		if (Static197.aSprite_12 == null || Static138.aSprite_8 == null) {
			if (client.js5Archive8.isFileReady(Static186.anInt3731) && client.js5Archive8.isFileReady(Static67.anInt1636)) {
				Static197.aSprite_12 = arg0.method2891(Static396.loadSoftwareSprite(client.js5Archive8, Static186.anInt3731, 0));
				@Pc(44) SoftwareSprite local44 = Static396.loadSoftwareSprite(client.js5Archive8, Static67.anInt1636, 0);
				Static138.aSprite_8 = arg0.method2891(local44);
				local44.method1684();
				Static75.aSprite_5 = arg0.method2891(local44);
			} else {
		...
		@Pc(87) int local87;
		if (Static197.aSprite_12 != null && Static138.aSprite_8 != null) {
			local87 = (local11 - Static138.aSprite_8.method6388() * 2) / Static197.aSprite_12.method6388();
			for (local89 = 0; local89 < local87; local89++) {
				Static197.aSprite_12.method6384(local7 + Static138.aSprite_8.method6388() + Static197.aSprite_12.method6388() * local89, local9);
			}
			Static138.aSprite_8.method6384(local7, local9);
			Static75.aSprite_5.method6384(local7 + local11 - Static75.aSprite_5.method6388(), local9);
		}
		...
		if ((Static337.aSprite_17 == null || Static211.aSprite == null || Static35.aSprite_3 == null) && client.js5Archive8.isFileReady(Static74.anInt1722) && client.js5Archive8.isFileReady(Static363.anInt6804) && client.js5Archive8.isFileReady(Static390.anInt7211)) {
			@Pc(275) SoftwareSprite local275 = Static396.loadSoftwareSprite(client.js5Archive8, Static363.anInt6804, 0);
			Static211.aSprite = arg0.method2891(local275);
			local275.method1684();
			Static339.aSprite_18 = arg0.method2891(local275);
			Static337.aSprite_17 = arg0.method2891(Static396.loadSoftwareSprite(client.js5Archive8, Static74.anInt1722, 0));
			@Pc(300) SoftwareSprite local300 = Static396.loadSoftwareSprite(client.js5Archive8, Static390.anInt7211, 0);
			Static35.aSprite_3 = arg0.method2891(local300);
			local300.method1684();
			Static110.aSprite_6 = arg0.method2891(local300);
		}
		local169 = 0;
		@Pc(368) int local368;
		@Pc(333) int local333;
		if (Static337.aSprite_17 != null && Static211.aSprite != null && Static35.aSprite_3 != null) {
			local192 = (local11 - Static35.aSprite_3.method6388() * 2) / Static337.aSprite_17.method6388();
			for (local333 = 0; local333 < local192; local333++) {
				Static337.aSprite_17.method6384(Static35.aSprite_3.method6388() + local7 + local333 * Static337.aSprite_17.method6388(), local9 + local15 - Static337.aSprite_17.method6381());
			}
			local368 = (local15 - Static35.aSprite_3.method6381() - 20) / Static211.aSprite.method6381();
			for (@Pc(370) int local370 = 0; local370 < local368; local370++) {
				Static211.aSprite.method6384(local7, local9 + local370 * Static211.aSprite.method6381() + 20);
				Static339.aSprite_18.method6384(local11 + local7 - Static339.aSprite_18.method6388(), local370 * Static211.aSprite.method6381() + 20 + local9);
			}
			Static35.aSprite_3.method6384(local7, local9 + local15 - Static35.aSprite_3.method6381());
			Static110.aSprite_6.method6384(local7 + local11 - Static35.aSprite_3.method6388(), local15 + local9 + -Static35.aSprite_3.method6381());
		}
		for (@Pc(436) Class2_Sub5 local436 = (Class2_Sub5) Static129.A_LINKED_LIST___19.head(); local436 != null; local436 = (Class2_Sub5) Static129.A_LINKED_LIST___19.next()) {
			...
			if (Static298.method2425(local436.anInt1005)) {
				...
				if (local436.anInt1005 == 1010) {
					local540 = LocTypeList.locTypeList.method5162((int) local436.aLong30);
				} else {
					local540 = LocTypeList.locTypeList.method5162((int) (local436.aLong30 >>> 32 & 0x7FFFFFFFL));
				}
			...
			Static52.aClass130_1.method5900(Static72.anIntArray114, Static134.aSpriteArray12, local7 + 3, local607, local333, local368);
			local169++;
			if (local436.aBoolean82) {
				Static119.aSprite_7.method6384(local7 + Static113.aClass239_2.method6125(local607) + 5, local333 + -12);
			}
		}
