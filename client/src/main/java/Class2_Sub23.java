...
public final class Class2_Sub23 extends Node {
	...
	public Class2_Sub23(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class6_Sub1 arg1, @OriginalArg(2) Class2_Sub26 arg2, @OriginalArg(3) int[] arg3) {
			...
			if (local116 > 0 && this.aClass6_Sub1_2.anInt6319 - 1 > local116) {
				for (local131 = 0; local131 <= local71; local131++) {
					...
					if (local144 > 0 && this.aClass6_Sub1_2.anInt6320 - 1 > local144) {
						local171 = arg1.method5718(local144 + 1, local116) - arg1.method5718(local144 - 1, local116);
						local185 = arg1.method5718(local144, local116 + 1) - arg1.method5718(local144, local116 - 1);
		...
		if (local108 > 0) {
			...
			this.aClass4_78 = new HashTable(Static162.clp2(local108));
			local131 = 0;
			local116 = 0;
							...
							if (local411 != null && local404 != 0) {
								if (local404 == 1) {
									for (@Pc(567) int local567 = 0; local567 < local411.length; local567++) {
										this.method3526(local411[local567], local171, local144, local131, local185, local418[local567]);
									}
								} else if (local404 == 3) {
									this.method3526(0, local171, local144, local131, local185, 0);
									this.method3526(arg1.anInt182, local171, local144, local131, local185, 0);
									this.method3526(0, local171, local144, local131, local185, arg1.anInt182);
								} else if (local404 == 2) {
									this.method3526(arg1.anInt182, local171, local144, local131, local185, 0);
									this.method3526(arg1.anInt182, local171, local144, local131, local185, arg1.anInt182);
									this.method3526(0, local171, local144, local131, local185, 0);
								} else if (local404 == 5) {
									this.method3526(arg1.anInt182, local171, local144, local131, local185, arg1.anInt182);
									this.method3526(0, local171, local144, local131, local185, arg1.anInt182);
	...
	public void method3525(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) boolean[][] arg2, @OriginalArg(4) int arg3) {
	...
	private void method3526(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(1) long local1 = -1L;
		...
		if (this.aClass19_Sub1_20.aBoolean53) {
			...
			this.aClass2_Sub4_Sub1_1.method3057((float) local9);
			this.aClass2_Sub4_Sub1_1.method3057((float) local23);
			this.aClass2_Sub4_Sub1_1.method3057((float) local17);
		}
		if (local596 > 255) {
			local596 = 255;
		}
