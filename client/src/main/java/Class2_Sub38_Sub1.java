...
public final class Class2_Sub38_Sub1 extends Class2_Sub38 {
	...
	@Override
	public void method6305(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt7068 = arg0;
		this.anInt7071 = arg1;
		@Pc(10) int local10 = Static351.method5854(this.anInt7068);
		@Pc(15) int local15 = Static351.method5854(this.anInt7071);
		...
		if (this.aClass8_Sub1Array4 != null) {
			for (local28 = 0; local28 < this.aClass8_Sub1Array4.length; local28++) {
				this.aClass8_Sub1Array4[local28].method6155();
			}
	...
	public boolean method6299() {
		...
		this.aClass8_Sub1_7.method3637(false, false);
		this.aClass8_Sub1_6 = new Class8_Sub1(this.aClass19_Sub1_41, 3553, 34842, 256, 256);
		this.aClass8_Sub1_6.method3637(false, false);
		this.aClass19_Sub1_41.method808(this.aClass228_4);
		this.aClass228_4.method5793(0, this.aClass8_Sub1_7);
		this.aClass228_4.method5793(1, this.aClass8_Sub1_6);
		this.aClass228_4.method5795(0);
		if (!this.aClass228_4.method5798()) {
			this.aClass19_Sub1_41.method830(this.aClass228_4);
			return false;
		}
		this.aClass19_Sub1_41.method830(this.aClass228_4);
		this.aClass166_2 = Static244.method4240(this.aClass19_Sub1_41, new Class35[] { Static40.method1280(this.aClass19_Sub1_41, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
		this.aClass166_4 = Static244.method4240(this.aClass19_Sub1_41, new Class35[] { Static40.method1280(this.aClass19_Sub1_41, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
		this.aClass166_1 = Static244.method4240(this.aClass19_Sub1_41, new Class35[] { Static40.method1280(this.aClass19_Sub1_41, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") });
		this.aClass166_3 = Static244.method4240(this.aClass19_Sub1_41, new Class35[] { Static40.method1280(this.aClass19_Sub1_41, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") });
	...
	@Override
	public void method6306(@OriginalArg(0) int arg0) {
	...
	@Override
	public void method6308(@OriginalArg(0) int arg0, @OriginalArg(1) Class8_Sub1 arg1, @OriginalArg(2) Class8_Sub1 arg2) {
		...
		if (this.aClass8_Sub1Array4 == null) {
			...
			local34 = Static351.method5854(this.anInt7068);
			local39 = Static351.method5854(this.anInt7071);
			@Pc(41) int local41 = 0;
			while (local34 > 256 || local39 > 256) {
				local3.glViewport(0, 0, local34, local39);
				this.aClass228_3.method5793(0, this.aClass8_Sub1Array4[local41]);
				if (local41 == 0) {
					this.aClass19_Sub1_41.method848(arg1);
					local3.glBegin(GL.GL_QUADS);
					local3.glTexCoord2f(0.0F, 0.0F);
