...
public final class Class11_Sub5_Sub2_Sub1 extends Class11_Sub5_Sub2 {
	...
	public void method6069(@OriginalArg(0) Class19 arg0) {
		if (this.aClass117_1 != null && (super.aBoolean321 || this.method4066(arg0, 0))) {
			this.method4332(arg0, super.aClass31Array3, super.aBoolean321);
		}
	}
	...
	public void method4063(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass12_Sub5_3 != null) {
			super.aClass12_Sub5_3.method4358();
		}
	}
	...
	public void method4065(@OriginalArg(0) Class2_Sub4 arg0) {
		arg0.anInt5300 = 0;
		...
		this.aByte38 = arg0.method4824();
		this.anInt4188 = arg0.method4824();
		this.anInt4198 = arg0.method4824();
		this.anInt4193 = 0;
		...
		for (@Pc(118) int local118 = 0; local118 < 12; local118++) {
			@Pc(124) int local124 = arg0.method4814();
			if (local124 == 0) {
				local116[local118] = 0;
			} else {
				local136 = arg0.method4814();
				local143 = (local124 << 8) + local136;
				if (local118 == 0 && local143 == 65535) {
					local113 = arg0.method4828();
					this.anInt4193 = arg0.method4814();
					break;
				}
				if (local143 >= 32768) {
		...
		for (local136 = 0; local136 < 5; local136++) {
			local143 = arg0.method4814();
			if (local143 < 0 || local143 >= Static353.aShortArrayArray7[local136].length) {
				local143 = 0;
			}
			local207[local136] = local143;
		}
		this.anInt4195 = arg0.method4828();
		this.aString42 = arg0.method4808();
		if (local29) {
			this.aString41 = arg0.method4808();
		} else {
			this.aString41 = this.aString42;
		}
		this.anInt4179 = arg0.method4814();
		if (local37) {
			this.anInt4173 = arg0.method4828();
			this.anInt4191 = -1;
			this.anInt4171 = this.anInt4179;
		} else {
			this.anInt4173 = 0;
			this.anInt4171 = arg0.method4814();
			this.anInt4191 = arg0.method4814();
			if (this.anInt4191 == 255) {
				this.anInt4191 = -1;
			}
		}
		local143 = this.anInt4182;
		this.anInt4182 = arg0.method4814();
		@Pc(327) int local327;
		if (this.anInt4182 == 0) {
			...
			this.anInt4167 = arg0.method4828();
			this.anInt4187 = arg0.method4828();
			this.anInt4168 = arg0.method4828();
			this.anInt4196 = arg0.method4828();
			this.anInt4201 = arg0.method4814();
		...
		this.aClass117_1.method3179(local207, local116, this.aByte39 == 1, local113, this.method4328());
		...
		@Pc(513) Class222 local513 = this.method4331();
	...
	private boolean method4066(@OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(13) Class222 local13 = this.method4331();
		...
		super.anInt4630 = super.aClass31Array3[0].method3801();
		this.method4319(super.aClass31Array3[0]);
		...
		if (local51 == 0 && local54 == 0) {
			...
			if (super.anInt4589 != 0) {
				super.aClass31Array3[0].method3823(super.anInt4589);
			}
			if (super.anInt4596 != 0) {
				super.aClass31Array3[0].method3814(super.anInt4596);
			}
			if (super.anInt4608 != 0) {
				super.aClass31Array3[0].method3812(0, super.anInt4608, 0);
			}
		}
	...
	public Class12_Sub4 method6072(@OriginalArg(0) Class19 arg0) {
		if (this.aClass117_1 == null || !this.method4066(arg0, 1024)) {
			return null;
		}
		...
		if (Static218.aClass177_Sub1_2.aBoolean358) {
			@Pc(55) Class222 local55 = this.method4331();
			if (local55.aBoolean424 && (this.aClass117_1.anInt3185 == -1 || Static6.aClass219_1.method5569(this.aClass117_1.anInt3185).aBoolean142)) {
				...
				if (local189 != null && local189.anInt2361 != -1) {
					...
					if (local189.anInt2355 == 1 && local189.anInt2354 >= 0 && local189.anInt2354 < Static365.aClass11_Sub5_Sub2_Sub2Array1.length) {
						...
						if (local215 != null) {
							...
							this.method4072(local189.anInt2361, 360000, local228, local239, local19, super.aClass31Array3[0], arg0);
						}
					}
					if (local189.anInt2355 == 2) {
						...
						local239 *= local239;
						this.method4072(local189.anInt2361, local239, local273, local228, local19, super.aClass31Array3[0], arg0);
					}
		...
		if (super.aClass12_Sub5_3 == null) {
			...
			@Pc(419) Class224 local419 = super.aClass12_Sub5_3.method4357();
		...
		this.method4332(arg0, super.aClass31Array3, false);
		if (super.aClass31Array3[2] != null) {
			if (local24 != 0) {
				super.aClass31Array3[2].method3832(local24);
			}
			super.aClass31Array3[2].method3812(super.anInt6781 - super.aClass2_Sub6_3.anInt1104, super.anInt6782 + -super.aClass2_Sub6_3.anInt1114, -super.aClass2_Sub6_3.anInt1101 + super.anInt6783);
		}
	...
	public boolean method6067(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19 arg2) {
		if (this.aClass117_1 == null || !this.method4066(arg2, 65536)) {
			return true;
		}
		...
		for (@Pc(42) int local42 = 0; local42 < super.aClass31Array3.length; local42++) {
			if (super.aClass31Array3[local42] != null && super.aClass31Array3[local42].method3819(arg0, arg1, local19, true)) {
				return true;
			}
		}
		return false;
	...
	public int method4327() {
		return this.aClass117_1 == null || this.aClass117_1.anInt3185 == -1 ? super.method4327() : Static6.aClass219_1.method5569(this.aClass117_1.anInt3185).anInt2041;
	}
	...
	private void method4072(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class14 arg4, @OriginalArg(6) Class31 arg5, @OriginalArg(7) Class19 arg6) {
