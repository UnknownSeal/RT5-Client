...
public final class Class227 {
					...
					for (local117 = 0; local117 < local23; local117++) {
						...
						if (local126 != null) {
							for (local131 = 0; local131 < local126.length; local131++) {
								local91.method4842(local126[local131] & 0xFFFF);
							}
						}
					}
				}
	...
	public void method5786() {
		this.method5787(this.anInterface4_5, this.anInt6402);
	}

	@OriginalMember(owner = "client!u", name = "a", descriptor = "(ILclient!fd;I)V")
	private void method5787(@OriginalArg(1) Interface4 arg0, @OriginalArg(2) int arg1) {
		if (arg1 != 0) {
			this.method5789();
	...
	public void method5788(@OriginalArg(0) byte[] arg0, @OriginalArg(3) int arg1) {
		this.aClass180_Sub2_2.method6066(arg0, this.aClass19_Sub1_36.method798(5123) * arg1);
		this.method5787(this.aClass180_Sub2_2, arg1);
	}
	...
	private void method5789() {
		...
		if (this.aClass8_Sub1_5 == null) {
			...
			this.aClass8_Sub1_5.method3637(false, false);
			this.aClass8_Sub1_5.method6159(true);
		} else {
			this.aClass8_Sub1_5.method3634(128, 128, Static345.aByteArray93, 6406, false);
		}
	}
}
