...
public final class Class188 {
	...
	private void method4767(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 == 1) {
			this.anInt5237 = arg1.method4828();
		} else if (arg0 == 2) {
			this.aString55 = arg1.method4808();
		} else if (arg0 == 4) {
			this.anInt5241 = arg1.method4828();
		} else if (arg0 == 5) {
			this.anInt5245 = arg1.method4828();
		} else if (arg0 == 6) {
			this.anInt5215 = arg1.method4828();
		} else if (arg0 == 7) {
			this.anInt5252 = arg1.method4828();
			if (this.anInt5252 > 32767) {
				this.anInt5252 -= 65536;
			}
		} else if (arg0 == 8) {
			this.anInt5232 = arg1.method4828();
			...
			this.anInt5220 = arg1.method4835();
		} else if (arg0 == 16) {
			this.aBoolean382 = true;
		} else if (arg0 == 23) {
			this.anInt5205 = arg1.method4828();
		} else if (arg0 == 24) {
			this.anInt5248 = arg1.method4828();
		} else if (arg0 == 25) {
			this.anInt5250 = arg1.method4828();
		} else if (arg0 == 26) {
			this.anInt5211 = arg1.method4828();
		} else if (arg0 >= 30 && arg0 < 35) {
			this.aStringArray50[arg0 - 30] = arg1.method4808();
		} else if (arg0 >= 35 && arg0 < 40) {
			this.aStringArray51[arg0 - 35] = arg1.method4808();
		} else {
			@Pc(162) int local162;
			@Pc(172) int local172;
			if (arg0 == 40) {
				local162 = arg1.method4814();
				this.aShortArray112 = new short[local162];
				this.aShortArray113 = new short[local162];
				for (local172 = 0; local172 < local162; local172++) {
					this.aShortArray113[local172] = (short) arg1.method4828();
					this.aShortArray112[local172] = (short) arg1.method4828();
				}
			} else if (arg0 == 41) {
				local162 = arg1.method4814();
				...
				for (local172 = 0; local172 < local162; local172++) {
					this.aShortArray111[local172] = (short) arg1.method4828();
					this.aShortArray110[local172] = (short) arg1.method4828();
				}
			} else if (arg0 == 42) {
				local162 = arg1.method4814();
				this.aByteArray72 = new byte[local162];
				for (local172 = 0; local172 < local162; local172++) {
					this.aByteArray72[local172] = arg1.method4824();
				}
			} else if (arg0 == 65) {
				this.aBoolean381 = true;
			} else if (arg0 == 78) {
				this.anInt5201 = arg1.method4828();
			} else if (arg0 == 79) {
				this.anInt5207 = arg1.method4828();
			} else if (arg0 == 90) {
				this.anInt5208 = arg1.method4828();
			} else if (arg0 == 91) {
				this.anInt5200 = arg1.method4828();
			} else if (arg0 == 92) {
				this.anInt5251 = arg1.method4828();
			} else if (arg0 == 93) {
				this.anInt5243 = arg1.method4828();
			} else if (arg0 == 95) {
				this.anInt5249 = arg1.method4828();
			} else if (arg0 == 96) {
				this.anInt5214 = arg1.method4814();
			} else if (arg0 == 97) {
				this.anInt5202 = arg1.method4828();
			} else if (arg0 == 98) {
				this.anInt5258 = arg1.method4828();
			} else if (arg0 >= 100 && arg0 < 110) {
				if (this.anIntArray365 == null) {
					this.anIntArray366 = new int[10];
					this.anIntArray365 = new int[10];
				}
				this.anIntArray365[arg0 - 100] = arg1.method4828();
				this.anIntArray366[arg0 - 100] = arg1.method4828();
			} else if (arg0 == 110) {
				this.anInt5233 = arg1.method4828();
			} else if (arg0 == 111) {
				this.anInt5226 = arg1.method4828();
			} else if (arg0 == 112) {
				this.anInt5261 = arg1.method4828();
			} else if (arg0 == 113) {
				this.anInt5256 = arg1.method4824();
			} else if (arg0 == 114) {
				this.anInt5199 = arg1.method4824() * 5;
			} else if (arg0 == 115) {
				this.anInt5257 = arg1.method4814();
			} else if (arg0 == 121) {
				this.anInt5246 = arg1.method4828();
			} else if (arg0 == 122) {
				this.anInt5235 = arg1.method4828();
			} else if (arg0 == 125) {
				this.anInt5213 = arg1.method4824();
				this.anInt5206 = arg1.method4824();
				this.anInt5260 = arg1.method4824();
			} else if (arg0 == 126) {
				this.anInt5222 = arg1.method4824();
				this.anInt5231 = arg1.method4824();
				this.anInt5254 = arg1.method4824();
			} else if (arg0 == 127) {
				this.anInt5216 = arg1.method4814();
				this.anInt5238 = arg1.method4828();
			} else if (arg0 == 128) {
				this.anInt5218 = arg1.method4814();
				this.anInt5225 = arg1.method4828();
			} else if (arg0 == 129) {
				this.anInt5244 = arg1.method4814();
				this.anInt5204 = arg1.method4828();
			} else if (arg0 == 130) {
				this.anInt5221 = arg1.method4814();
				this.anInt5240 = arg1.method4828();
			} else if (arg0 == 132) {
				local162 = arg1.method4814();
				this.anIntArray364 = new int[local162];
				for (local172 = 0; local172 < local162; local172++) {
					this.anIntArray364[local172] = arg1.method4828();
				}
			} else if (arg0 == 249) {
				local162 = arg1.method4814();
				if (this.aClass4_103 == null) {
					local172 = Static162.method2976(local162);
					this.aClass4_103 = new Class4(local172);
				}
				for (local172 = 0; local172 < local162; local172++) {
					@Pc(503) boolean local503 = arg1.method4814() == 1;
					@Pc(507) int local507 = arg1.method4832();
					@Pc(516) Class2 local516;
					if (local503) {
						local516 = new Class2_Sub40(arg1.method4808());
					} else {
						local516 = new Class2_Sub39(arg1.method4835());
					}
	...
	public boolean method4769(@OriginalArg(1) boolean arg0) {
	...
	public void method4770(@OriginalArg(1) Class2_Sub4 arg0) {
		while (true) {
			@Pc(11) int local11 = arg0.method4814();
			if (local11 == 0) {
				return;
			}
			this.method4767(local11, arg0);
		}
	}
	...
	private void method4773(@OriginalArg(0) int arg0, @OriginalArg(2) int[] arg1) {
	...
	private int[] method4774(@OriginalArg(1) int arg0, @OriginalArg(2) int[] arg1) {
	...
	public Class31 method4775(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class157 arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class117 arg6, @OriginalArg(8) int arg7) {
		@Pc(15) int local15;
		if (this.anIntArray365 != null && arg5 > 1) {
			...
			if (local15 != -1) {
				return this.aClass107_1.method2759(local15).method4775(arg0, arg1, arg2, arg3, arg4, 1, arg6, arg7);
			}
		}
		local15 = arg1;
		if (arg3 != null) {
		...
		@Pc(85) Class98 local85 = this.aClass107_1.aClass98_22;
		@Pc(102) Class31 local102;
		synchronized (this.aClass107_1.aClass98_22) {
			local102 = (Class31) this.aClass107_1.aClass98_22.method2612((long) (arg4.anInt2836 << 29 | this.anInt5255));
		}
		if (local102 == null || arg4.method2863(local102.method3826(), local15) != 0) {
			if (local102 != null) {
				local15 = arg4.method2806(local15, local102.method3826());
			}
			...
			if (this.aShortArray113 != null) {
				for (local229 = 0; local229 < this.aShortArray113.length; local229++) {
					if (this.aByteArray72 == null || this.aByteArray72.length <= local229) {
						local102.method3837(this.aShortArray113[local229], this.aShortArray112[local229]);
					} else {
						local102.method3837(this.aShortArray113[local229], Static147.aShortArray54[this.aByteArray72[local229] & 0xFF]);
					}
				}
			}
			if (this.aShortArray111 != null) {
				for (local229 = 0; local229 < this.aShortArray111.length; local229++) {
					local102.method3815(this.aShortArray111[local229], this.aShortArray110[local229]);
				}
			}
			if (arg6 != null) {
			...
			@Pc(371) Class98 local371 = this.aClass107_1.aClass98_22;
			synchronized (this.aClass107_1.aClass98_22) {
				this.aClass107_1.aClass98_22.method2624((long) (this.anInt5255 | arg4.anInt2836 << 29), local102);
			}
		}
		if (arg3 != null) {
			local102 = arg3.method3985(local102, arg7, local15, arg0, arg2);
		}
		local102.method3813(arg1);
		return local102;
	}
	...
	public Class185 method4777(@OriginalArg(1) boolean arg0) {
		...
		if (this.aShortArray113 != null) {
			for (local66 = 0; local66 < this.aShortArray113.length; local66++) {
				local32.method4662(this.aShortArray113[local66], this.aShortArray112[local66]);
			}
		}
		if (this.aShortArray111 != null) {
			for (local66 = 0; local66 < this.aShortArray111.length; local66++) {
				local32.method4657(this.aShortArray110[local66], this.aShortArray111[local66]);
			}
		}
		return local32;
	}
	...
	public Class185 method4778(@OriginalArg(1) boolean arg0) {
		...
		if (!arg0 && (this.anInt5213 != 0 || this.anInt5206 != 0 || this.anInt5260 != 0)) {
			local46.method4655(this.anInt5213, this.anInt5260, this.anInt5206);
		}
		if (arg0 && (this.anInt5222 != 0 || this.anInt5231 != 0 || this.anInt5254 != 0)) {
			local46.method4655(this.anInt5222, this.anInt5254, this.anInt5231);
		}
		@Pc(171) int local171;
		if (this.aShortArray113 != null) {
			for (local171 = 0; local171 < this.aShortArray113.length; local171++) {
				local46.method4662(this.aShortArray113[local171], this.aShortArray112[local171]);
			}
		}
		if (this.aShortArray111 != null) {
			for (local171 = 0; local171 < this.aShortArray111.length; local171++) {
				local46.method4657(this.aShortArray110[local171], this.aShortArray111[local171]);
			}
		}
		return local46;
	}

	@OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILclient!qf;Lclient!qf;)V")
	public void method4779(@OriginalArg(1) Class188 arg0, @OriginalArg(2) Class188 arg1) {
	...
	public int[] method4780(@OriginalArg(0) Class130 arg0, @OriginalArg(1) Class117 arg1, @OriginalArg(3) Class19 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) boolean arg8) {
		...
		if (this.aShortArray113 != null) {
			for (local23 = 0; local23 < this.aShortArray113.length; local23++) {
				if (this.aByteArray72 == null || this.aByteArray72.length <= local23) {
					local14.method4662(this.aShortArray113[local23], this.aShortArray112[local23]);
				} else {
					local14.method4662(this.aShortArray113[local23], Static147.aShortArray54[this.aByteArray72[local23] & 0xFF]);
				}
			}
		}
		if (this.aShortArray111 != null) {
			for (local23 = 0; local23 < this.aShortArray111.length; local23++) {
				local14.method4657(this.aShortArray110[local23], this.aShortArray111[local23]);
			}
		}
		if (arg1 != null) {
		...
		@Pc(210) Class31 local210 = arg4.method2864(local14, local174, 0, this.anInt5256 + 64, this.anInt5199 + 768);
		if (!local210.method3800()) {
			return null;
		}
		if (local176) {
		...
		local210.method3834(local333, null, 1);
		arg4.method2872(local392, local395);
		@Pc(427) int[] local427 = arg4.method2850();
		if (arg6 >= 1) {
			local427 = this.method4774(-16777214, local427);
			if (arg6 >= 2) {
				local427 = this.method4774(-1, local427);
			}
		}
		if (arg3 != 0) {
			this.method4773(arg3, local427);
		}
		arg4.method2884(local427, 36, 36, 32).method6384(0, 0);
		if (this.anInt5258 != -1) {
			local227.method6384(0, 0);
		} else if (this.anInt5235 != -1) {
			local227.method6384(0, 0);
		}
		if (arg5 == 1 || arg5 == 2 && (this.anInt5247 == 1 || arg7 != 1) && arg7 != -1) {
			arg0.method5896(0, -16777215, 9, -256, this.method4785(arg7));
		}
	...
	@OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)Lclient!qf;")
	public Class188 method4781(@OriginalArg(0) int arg0) {
		if (this.anIntArray365 != null && arg0 > 1) {
			...
			if (local13 != -1) {
				return this.aClass107_1.method2759(local13);
			}
		}
		return this;
	}
	...
	public void method4783(@OriginalArg(0) Class188 arg0, @OriginalArg(1) Class188 arg1) {
	...
	private String method4785(@OriginalArg(0) int arg0) {
		if (arg0 < 100000) {
