...
public final class Static173 {
	...
	public static void method3314(@OriginalArg(1) Class11_Sub5_Sub2 arg0) {
		...
		if (arg0.anInt4585 != -1) {
			...
			if (local20 == null || local20.frames == null) {
				...
				label297: {
					arg0.anInt4629++;
					if (local20.frames.length > arg0.anInt4626 && arg0.anInt4629 > local20.frameDelay[arg0.anInt4626]) {
						arg0.anInt4626++;
						arg0.anInt4593++;
						arg0.anInt4629 = 1;
						Static1.method4(local20, Static17.self == arg0, arg0.aByte78, arg0.xFine, arg0.zFine, arg0.anInt4626);
					}
					if (local20.frames.length <= arg0.anInt4626) {
						arg0.anInt4626 = 0;
						arg0.anInt4629 = 0;
						if (arg0.aBoolean317) {
							arg0.anInt4585 = arg0.method4331().method5695();
							if (arg0.anInt4585 == -1) {
								arg0.aBoolean317 = false;
								break label297;
							}
					...
					if (local20.frames.length <= arg0.anInt4593) {
						arg0.anInt4593 = 0;
					}
				}
			}
				...
				label299: {
					...
					if (local184.aBoolean177) {
						if (local196.looptype == 3) {
							...
							arg0.anInt4595 = Static114.loop + 1;
							break label299;
						}
					}
					if (local196 == null || local196.frames == null) {
						...
						arg0.anInt4620++;
						if (arg0.anInt4582 < local196.frames.length && local196.frameDelay[arg0.anInt4582] < arg0.anInt4620) {
							arg0.anInt4620 = 1;
							arg0.anInt4582++;
						...
						if (arg0.anInt4612 >= local196.frames.length) {
							if (local184.aBoolean177) {
								...
								if (arg0.anInt4602 + 1 >= local196.replaycount) {
									arg0.anInt4612 = -1;
								} else if (arg0.anInt4612 < 0 || local196.frames.length <= arg0.anInt4612) {
									arg0.anInt4612 = -1;
								}
							} else {
								arg0.anInt4612 = -1;
		...
		if (arg0.anInt4597 != -1 && arg0.anInt4590 <= 1) {
			...
			} else if (local20.looptype == 1 && arg0.anInt4642 > 0 && arg0.anInt4622 <= Static114.loop && Static114.loop > arg0.anInt4584) {
				arg0.anInt4590 = 2;
			}
		}
		if (arg0.anInt4597 != -1 && arg0.anInt4590 == 0) {
			...
			if (local20 == null || local20.frames == null) {
				...
				arg0.anInt4624++;
				if (local20.frames.length > arg0.anInt4607 && local20.frameDelay[arg0.anInt4607] < arg0.anInt4624) {
					arg0.anInt4624 = 1;
					arg0.anInt4607++;
					Static1.method4(local20, arg0 == Static17.self, arg0.aByte78, arg0.xFine, arg0.zFine, arg0.anInt4607);
				}
				if (arg0.anInt4607 >= local20.frames.length) {
					arg0.anInt4598++;
					arg0.anInt4607 -= local20.replayOff;
					if (arg0.anInt4598 >= local20.replaycount) {
						arg0.anInt4597 = -1;
					} else if (arg0.anInt4607 >= 0 && local20.frames.length > arg0.anInt4607) {
						Static1.method4(local20, arg0 == Static17.self, arg0.aByte78, arg0.xFine, arg0.zFine, arg0.anInt4607);
					} else {
						arg0.anInt4597 = -1;
					}
				...
				if (local20.frames.length <= arg0.anInt4592) {
					arg0.anInt4592 -= local20.replayOff;
					if (arg0.anInt4598 + 1 >= local20.replaycount) {
						arg0.anInt4592 = -1;
					} else if (arg0.anInt4592 < 0 || local20.frames.length <= arg0.anInt4592) {
						arg0.anInt4592 = -1;
					}
				}
			...
			if (local777 != null) {
				if (local777.anInt629 > 0) {
					...
					if (local196 == null || local196.frames == null) {
						...
						local777.anInt625++;
						if (local777.anInt628 < local196.frames.length && local196.frameDelay[local777.anInt628] < local777.anInt625) {
							local777.anInt625 = 1;
							local777.anInt628++;
							Static1.method4(local196, Static17.self == arg0, arg0.aByte78, arg0.xFine, arg0.zFine, local777.anInt628);
						}
						if (local777.anInt628 >= local196.frames.length) {
							local777.anInt626++;
							local777.anInt628 -= local196.replayOff;
							if (local777.anInt626 >= local196.replaycount) {
								arg0.aClass20Array3[local765] = null;
							} else if (local777.anInt628 >= 0 && local777.anInt628 < local196.frames.length) {
						...
						if (local777.anInt627 >= local196.frames.length) {
							local777.anInt627 -= local196.replayOff;
							if (local196.replaycount <= local777.anInt626 + 1) {
								local777.anInt627 = -1;
							} else if (local777.anInt627 < 0 || local777.anInt627 >= local196.frames.length) {
								local777.anInt627 = -1;
							}
						}
					}
	...
	public static void method3315(@OriginalArg(0) Class90 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 == 1 && arg3 > 0) {
