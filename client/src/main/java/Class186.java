...
public final class Class186 {
	...
	private final int anInt5099 = Static267.method4512(16);

	@OriginalMember(owner = "client!pt", name = "c", descriptor = "I")
	private final int anInt5100 = Static267.method4512(24);

	@OriginalMember(owner = "client!pt", name = "f", descriptor = "I")
	private final int anInt5103 = Static267.method4512(24);

	@OriginalMember(owner = "client!pt", name = "d", descriptor = "I")
	private final int anInt5101 = Static267.method4512(24) + 1;

	@OriginalMember(owner = "client!pt", name = "g", descriptor = "I")
	private final int anInt5104 = Static267.method4512(6) + 1;

	@OriginalMember(owner = "client!pt", name = "e", descriptor = "I")
	private final int anInt5102 = Static267.method4512(8);
	...
	public Class186() {
		...
		for (@Pc(35) int local35 = 0; local35 < this.anInt5104; local35++) {
			local38 = 0;
			@Pc(41) int local41 = Static267.method4512(3);
			@Pc(47) boolean local47 = Static267.method4521() != 0;
			if (local47) {
				local38 = Static267.method4512(5);
			}
			local33[local35] = local38 << 3 | local41;
		}
		this.anIntArray359 = new int[this.anInt5104 * 8];
		for (local38 = 0; local38 < this.anInt5104 * 8; local38++) {
			this.anIntArray359[local38] = (local33[local38 >> 3] & 0x1 << (local38 & 0x7)) == 0 ? -1 : Static267.method4512(8);
		}
	}

	@OriginalMember(owner = "client!pt", name = "a", descriptor = "([FIZ)V")
	public void method4676(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		for (@Pc(35) int local35 = 0; local35 < 8; local35++) {
			...
			while (local38 < local30) {
				...
				@Pc(51) int local51;
				if (local35 == 0) {
					local47 = Static267.aClass175Array1[this.anInt5102].method4438();
					...
					if (local90 >= 0) {
						...
						if (this.anInt5099 == 0) {
							...
							for (@Pc(115) int local115 = 0; local115 < local113; local115++) {
								@Pc(119) float[] local119 = local104.method4437();
							...
							while (local113 < this.anInt5101) {
								@Pc(153) float[] local153 = local104.method4437();
