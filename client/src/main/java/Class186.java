...
public final class Class186 {
	...
	private final int anInt5100 = Static267.readBits(24);
	...
	private final int anInt5101 = Static267.readBits(24) + 1;

	@OriginalMember(owner = "client!pt", name = "g", descriptor = "I")
	private final int anInt5104 = Static267.readBits(6) + 1;

	@OriginalMember(owner = "client!pt", name = "e", descriptor = "I")
	private final int anInt5102 = Static267.readBits(8);
	...
	public Class186() {
		...
		for (local38 = 0; local38 < this.anInt5104 * 8; local38++) {
			this.anIntArray359[local38] = (local33[local38 >> 3] & 0x1 << (local38 & 0x7)) == 0 ? -1 : Static267.readBits(8);
		}
	}
	...
	public void method4676(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		@Pc(19) int local19 = Static267.aVorbisCodebookArray1[this.anInt5102].dimensions;
		...
		for (@Pc(35) int local35 = 0; local35 < 8; local35++) {
			...
			while (local38 < local30) {
				...
				@Pc(51) int local51;
				if (local35 == 0) {
					local47 = Static267.aVorbisCodebookArray1[this.anInt5102].decodeScalar();
				...
				for (local47 = 0; local47 < local19; local47++) {
					...
					if (local90 >= 0) {
						...
						@Pc(104) VorbisCodebook local104 = Static267.aVorbisCodebookArray1[local90];
						@Pc(113) int local113;
						if (this.anInt5099 == 0) {
							local113 = this.anInt5101 / local104.dimensions;
