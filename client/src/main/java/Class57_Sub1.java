...
public class Class57_Sub1 extends Class57 {
	...
	protected final void method6016() {
		...
		this.method6019(this.anInt6728++, (byte) (this.anInt6726 >> 4));
		this.anInt6726 = 0;
	}

	@OriginalMember(owner = "client!eb", name = "a", descriptor = "(III)V")
	@Override
	protected final void method6010(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		this.anInt6726 += this.anIntArray466[arg0] * arg1 >> 12;
	}

	@OriginalMember(owner = "client!eb", name = "a", descriptor = "(IB)V")
	protected void method6019(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
