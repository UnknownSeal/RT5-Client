...
public final class Static396 {
	...
	private static Class48[] method1679(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(14) int local14 = local4.method4828();
		@Pc(17) Class48[] local17 = new Class48[local14];
		for (@Pc(19) int local19 = 0; local19 < local14; local19++) {
			local17[local19] = new Class48();
		}
		local4.anInt5300 = arg0.length - local14 * 8 - 7;
		@Pc(44) int local44 = local4.method4828();
		@Pc(48) int local48 = local4.method4828();
		@Pc(56) int local56 = (local4.method4814() & 0xFF) + 1;
		for (@Pc(58) int local58 = 0; local58 < local14; local58++) {
			local17[local58].anInt1535 = local4.method4828();
		}
		for (@Pc(72) int local72 = 0; local72 < local14; local72++) {
			local17[local72].anInt1530 = local4.method4828();
		}
		for (@Pc(86) int local86 = 0; local86 < local14; local86++) {
			local17[local86].anInt1531 = local4.method4828();
		}
		for (@Pc(100) int local100 = 0; local100 < local14; local100++) {
			local17[local100].anInt1533 = local4.method4828();
		}
		...
		for (@Pc(162) int local162 = 1; local162 < local56; local162++) {
			local160[local162] = local4.method4832();
		...
		for (@Pc(198) int local198 = 0; local198 < local14; local198++) {
			...
			@Pc(217) int local217 = local4.method4814();
			@Pc(245) int local245;
			if ((local217 & 0x2) == 0) {
				@Pc(227) int local227;
				if ((local217 & 0x1) == 0) {
					for (local227 = 0; local227 < local209; local227++) {
						local203.aByteArray21[local227] = local4.method4824();
					}
				} else {
					for (local227 = 0; local227 < local203.anInt1531; local227++) {
						for (local245 = 0; local245 < local203.anInt1533; local245++) {
							local203.aByteArray21[local227 + local245 * local203.anInt1531] = local4.method4824();
						}
					}
				}
			} else {
				...
				if ((local217 & 0x1) == 0) {
					for (local245 = 0; local245 < local209; local245++) {
						local203.aByteArray21[local245] = local4.method4824();
					}
					for (local295 = 0; local295 < local209; local295++) {
						@Pc(305) byte local305 = local203.aByteArray20[local295] = local4.method4824();
						local271 |= local305 != -1;
					}
				} else {
					for (local245 = 0; local245 < local203.anInt1531; local245++) {
						for (local295 = 0; local295 < local203.anInt1533; local295++) {
							local203.aByteArray21[local245 + local295 * local203.anInt1531] = local4.method4824();
						}
					}
					for (local295 = 0; local295 < local203.anInt1531; local295++) {
						for (@Pc(352) int local352 = 0; local352 < local203.anInt1533; local352++) {
							@Pc(367) byte local367 = local203.aByteArray20[local295 + local352 * local203.anInt1531] = local4.method4824();
							local271 |= local367 != -1;
						}
					}
				}
