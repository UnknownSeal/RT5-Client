...
public final class Class130_Sub4 extends Class130 {
	...
	protected void method5891(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		if ((arg3 & -16777216) == -16777216) {
			...
			this.method5905(this.aByteArrayArray21[arg0], this.aClass19_Sub2_10.anIntArray179, arg3, local41, local33, local18, local23, local37, local39);
		}
	}

	@OriginalMember(owner = "client!uj", name = "a", descriptor = "([B[IIIIIIII)V")
	private void method5905(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	protected void method5901(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class78 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if ((arg3 & -16777216) == -16777216) {
			this.method5906(this.aByteArrayArray21[arg0], this.aClass19_Sub2_10.anIntArray179, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray452[arg0], arg5, arg6, arg7);
		} else {
