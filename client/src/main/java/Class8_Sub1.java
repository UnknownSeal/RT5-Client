...
public class Class8_Sub1 extends Class8 {
	...
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7) {
		...
		if (arg5 && this.anInt6882 != 34037) {
			Static187.method6152(local20, arg1, arg2, arg3, arg4, arg7, arg6);
			this.method6164(true);
		} else {
			...
			this.method6164(false);
		}
		this.method6159(true);
	}
	...
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) boolean arg7) {
		...
		this.aClass19_Sub1_40.method848(this);
		if (arg5 && this.anInt6882 != 34037) {
			Static187.method6163(local20, this.anInt6882, this.anInt6883, this.anInt3684, this.anInt3685, this.aClass19_Sub1_40.anInt592, arg6);
			this.method6164(true);
		} else {
	...
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(20) opengl local20 = arg0.anOpengl1;
		this.aClass19_Sub1_40.method848(this);
		local20.glTexImage2D(this.anInt6882, 0, this.anInt6883, arg3, arg4, 0, Static187.method6154(this.anInt6883), GL.GL_UNSIGNED_BYTE, null);
		this.method6159(true);
	}
	...
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) byte[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean arg8) {
		...
		if (arg5 && this.anInt6882 != 34037) {
			Static187.method6156(local20, arg1, arg2, arg3, arg4, arg7, arg6);
			this.method6164(true);
		} else {
	...
	protected Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt3685 = arg5;
		@Pc(20) opengl local20 = arg0.anOpengl1;
		@Pc(29) int local29 = this.aClass19_Sub1_40.method821().method5792() - arg3 - arg5;
		this.aClass19_Sub1_40.method848(this);
	...
	public final void method3634(@OriginalArg(2) int arg0, @OriginalArg(3) int arg1, @OriginalArg(4) byte[] arg2, @OriginalArg(5) int arg3, @OriginalArg(8) boolean arg4) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_40.anOpengl1;
		if (arg4) {
			@Pc(12) int local12 = Static187.method6162(6406);
	...
	public final void method3635(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(8) int local8 = this.aClass19_Sub1_40.method821().method5792() - arg3;
		this.aClass19_Sub1_40.method848(this);
	...
	public final void method3637(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_40.anOpengl1;
	...
	public final void method3638(@OriginalArg(0) int arg0) {
