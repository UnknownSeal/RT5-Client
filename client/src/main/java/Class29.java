...
public class Class29 {
		...
		for (@Pc(7) int local7 = 0; local7 < this.anInt900; local7++) {
			for (@Pc(11) int local11 = 0; local11 < this.anInt911; local11++) {
				if (Static158.anInt2911 == -1 || Static142.method2661(local11, Static158.anInt2911, arg4, local7)) {
					...
					@Pc(97) Class225 local97 = local65 == 0 ? null : this.aClass241_2.method6270(local65 - 1);
					@Pc(99) int local99 = 0;
					...
					if (local139 != 0) {
						...
						if (local82 == null || local82.anInt3769 == -1 && local82.anInt3757 == -1 && local82.anInt3762 == -1) {
							...
							if (!this.aBoolean73 && arg4 == 0) {
								Static199.method5240(local7, local11, local82.anInt3771, local82.anInt3766 * 8, local82.anInt3764);
							}
						}
						if (!local157) {
							local149 = null;
						...
						for (@Pc(362) int local362 = 0; local362 < local181; local362++) {
							...
							if (local351 != null && Static375.aBooleanArrayArray6[local34][local362]) {
								...
								local351[local362] = arg0.method5727(local454, local460) - arg5.method5727(local454, local460);
							}
							if (local360 != null) {
								if (arg0 != null && !Static375.aBooleanArrayArray6[local34][local362]) {
									local454 = (local7 << 7) + local368;
									local460 = (local11 << 7) + local368;
									local360[local362] = arg5.method5727(local454, local460) - arg0.method5727(local454, local460);
								} else if (arg2 != null && !Static329.aBooleanArrayArray4[local34][local362]) {
									local454 = (local7 << 7) + local368;
									local460 = (local11 << 7) + local368;
									local360[local362] = arg2.method5727(local454, local460) - arg5.method5727(local454, local460);
								}
							}
						}
						local368 = arg5.method5718(local7, local11);
						local372 = arg5.method5718(local7 + 1, local11);
						local454 = arg5.method5718(local7 + 1, local11 - -1);
						local460 = arg5.method5718(local7, local11 + 1);
						if (arg4 > 0) {
						...
						if (this.aBoolean73) {
							local636 = Static357.method5986(local7, local11);
							local638 = Static168.method6475(local7, local11);
							local640 = Static51.method1548(local7, local11);
						}
						arg5.method5716(local7, local11, local341, local351, local344, local360, Static221.anIntArrayArray36[local34], Static118.anIntArrayArray25[local34], Static96.anIntArrayArray17[local34], local146, local149, local152, local155, local636, local638, local640);
						Static237.method4118(arg4, local7, local11);
					}
				}
			}
		}
		...
		while (true) {
			...
			if (local69 == 0) {
				if (this.aBoolean73) {
					...
					this.anIntArrayArrayArray8[0][arg4 + arg7][arg0 + arg2] = -Static7.method6465(arg1 + 932731, arg5 + 556238) * 8;
					return;
				} else {
			...
			if (local69 == 1) {
				@Pc(152) int local152 = arg6.method4814();
				if (this.aBoolean73) {
			...
			if (local69 <= 49) {
				if (arg3) {
					...
					this.aByteArrayArrayArray10[arg8][arg4][arg0] = arg6.method4824();
		...
		if (!this.aBoolean73) {
			...
			for (local20 = 0; local20 < 8; local20++) {
				for (@Pc(24) int local24 = 0; local24 < 8; local24++) {
					...
					local50 = arg5 + Static235.method3343(local20 & 0x7, arg6, local24 & 0x7);
				...
				for (@Pc(148) int local148 = 0; local148 < 64; local148++) {
					if (arg7 == local50 && local144 >= local11 && local11 + 8 >= local144 && local148 >= local101 && local148 <= local101 + 8) {
						...
						if (local11 + 8 == local144 || local101 + 8 == local148) {
							...
							local224 = arg5 + Static235.method3343(local144 & 0x7, arg6, local148 & 0x7);
	...
	public final void method1093(@OriginalArg(0) Class6 arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) Class6 arg2) {
			...
			for (@Pc(89) int local89 = -5; local89 < this.anInt900; local89++) {
				...
				for (@Pc(93) int local93 = 0; local93 < this.anInt911; local93++) {
					...
					if (this.anInt900 > local99) {
						...
						if (local118 > 0) {
							@Pc(128) Class225 local128 = this.aClass241_2.method6270(local118 - 1);
					...
					if (local118 >= 0) {
						...
						if (local187 > 0) {
							@Pc(199) Class225 local199 = this.aClass241_2.method6270(local187 - 1);
				...
				if (local89 >= 0) {
					...
					for (@Pc(260) int local260 = -5; local260 < this.anInt911; local260++) {
						...
						if (local260 >= 0 && local256 > 0 && local258 > 0) {
							local11[local89][local260] = Static181.method3380(local99 * 256 / local256, local187 / local258, local118 / local258);
						}
					}
				}
			}
		...
		for (local60 = 0; local60 < this.anInt912; local60++) {
			Static365.aClass6Array4[local60].method5717();
		}
	}
	...
	private void method1095(@OriginalArg(0) Class225 arg0, @OriginalArg(1) Class148 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[][] arg4, @OriginalArg(5) boolean[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class19 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) byte[][] arg10, @OriginalArg(12) int arg11, @OriginalArg(13) byte[][] arg12) {
				...
				if (arg11 > 0) {
					...
					if (local49 > 0) {
						...
						if (local59.anInt3769 != -1 && local59.aBoolean245) {
							...
							local99 = Static78.method5698(arg7, local59);
				...
				if (local49 > 0) {
					...
					if (local59.anInt3769 != -1) {
						...
						if (local59.aBoolean245) {
							...
							local528 = Static78.method5698(arg7, local59);
		...
		@Pc(1242) int local1242 = Static78.method5698(arg7, arg1);
		if (!arg1.aBoolean245) {
			return;
		}
			...
			for (@Pc(51) int local51 = 0; local51 < this.anInt911; local51++) {
				...
				if (Static158.anInt2911 == -1 || Static142.method2661(local51, Static158.anInt2911, arg0, local35)) {
					...
					if (local104 != 0 || local112 != 0) {
						...
						@Pc(179) Class225 local179 = local112 == 0 ? null : this.aClass241_2.method6270(local112 - 1);
						...
						if ((local90 == 0 || local90 == 12) && local35 > 0 && local51 > 0 && this.anInt900 > local35 && this.anInt911 > local51) {
							...
							if (local370 == local380) {
								local370 = arg4.method5718(local35, local51) - arg4.method5718(local49, local65);
								if (local370 < 0) {
									local370 = -local370;
								}
								local380 = arg4.method5718(local49, local51) - arg4.method5718(local35, local65);
								if (local380 < 0) {
									local380 = -local380;
								}
							}
						...
						if (local903 <= 0) {
							Static237.method4118(arg0, local35, local51);
						} else {
							if (local84[0]) {
								local903++;
							}
							...
							if (local158 != null) {
								...
								local1033 = Static78.method5698(arg1, local158);
								for (local1035 = 0; local1035 < local380; local1035++) {
									...
									for (local1267 = 0; local1267 < local1134; local1267++) {
										...
										if (local968 != null && Static375.aBooleanArrayArray6[local90][local1273]) {
											...
											local968[local935] = arg2.method5727(local1354, local1360) - arg4.method5727(local1354, local1360);
										}
										if (local977 != null) {
											if (arg2 != null && !Static375.aBooleanArrayArray6[local90][local1273]) {
												local1354 = local1302 + (local35 << 7);
												local1360 = local1300 + (local51 << 7);
												local977[local935] = arg4.method5727(local1354, local1360) - arg2.method5727(local1354, local1360);
											} else if (arg3 != null && !Static329.aBooleanArrayArray4[local90][local1273]) {
												local1354 = local1302 + (local35 << 7);
												local1360 = local1300 + (local51 << 7);
												local977[local935] = arg3.method5727(local1354, local1360) - arg4.method5727(local1354, local1360);
											}
										}
								...
								if (!this.aBoolean73 && arg0 == 0) {
									Static199.method5240(local35, local51, local158.anInt3771, local158.anInt3766 * 8, local158.anInt3764);
								}
							...
							if (local179 != null) {
								...
								@Pc(1581) Class225 local1581 = this.aClass241_2.method6270(local112 - 1);
								@Pc(1589) Class225 local1589 = this.aClass241_2.method6270(local120 - 1);
								@Pc(1597) Class225 local1597 = this.aClass241_2.method6270(local128 - 1);
								@Pc(1605) Class225 local1605 = this.aClass241_2.method6270(local136 - 1);
								for (local1282 = 0; local1282 < local370; local1282++) {
									...
									for (local1286 = 0; local1286 < local1134; local1286++) {
										...
										if (local968 != null && Static375.aBooleanArrayArray6[local90][local1302]) {
											...
											local968[local935] = arg2.method5727(local1931, local1938) - arg4.method5727(local1931, local1938);
										}
										if (local977 != null) {
											if (arg2 != null && !Static375.aBooleanArrayArray6[local90][local1302]) {
												local1931 = (local35 << 7) + local1354;
												local1938 = (local51 << 7) + local1875;
												local977[local935] = arg4.method5727(local1931, local1938) - arg2.method5727(local1931, local1938);
											} else if (arg3 != null && !Static329.aBooleanArrayArray4[local90][local1302]) {
												local1931 = local1354 + (local35 << 7);
												local1938 = local1875 + (local51 << 7);
												local977[local935] = arg3.method5727(local1931, local1938) - arg4.method5727(local1931, local1938);
											}
										}
										if (local1302 < 8 && Static6.anIntArray4[local1290] >= 0) {
											...
											if (local81 && Static375.aBooleanArrayArray6[local90][local1302]) {
												...
												local1931 = Static289.method5019(local1354 << 7 >> 7, arg5[local49][local51], arg5[local35][local51]);
												local1938 = Static289.method5019(local1354 << 7 >> 7, arg5[local49][local65], arg5[local35][local65]);
												local955[local935] = Static289.method5019(local1875 << 7 >> 7, local1938, local1931);
											}
											if (local946 != null) {
							...
							local1033 = arg4.method5718(local35, local51);
							local1035 = arg4.method5718(local49, local51);
							local1267 = arg4.method5718(local49, local65);
							local1273 = arg4.method5718(local35, local65);
							if (arg0 > 0) {
							...
							local1302 = 0;
							if (this.aBoolean73) {
								local1282 = Static357.method5986(local35, local51);
								local1286 = Static168.method6475(local35, local51);
								local1302 = Static51.method1548(local35, local51);
							}
							arg4.method5726(local35, local51, local949, local968, local952, local977, local955, local946, local958, local961, local1282, local1286, local1302, local79);
							Static237.method4118(arg0, local35, local51);
						}
					}
				}
