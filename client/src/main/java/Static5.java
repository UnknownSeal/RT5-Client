...
public final class Static5 {
	...
	public static PrivelegedRequest aPrivelegedRequest_1;
		...
		while (true) {
			...
			for (@Pc(23) int local23 = 0; local23 < local16.anInt7154; local23++) {
				if (local16.aPrivelegedRequestArray1[local23] != null) {
					if (local16.aPrivelegedRequestArray1[local23].anInt993 == 2) {
						local16.anIntArray491[local23] = -5;
					}
					if (local16.aPrivelegedRequestArray1[local23].anInt993 == 0) {
						local21 = true;
					}
				}
				if (local16.aPrivelegedRequestArray2[local23] != null) {
					if (local16.aPrivelegedRequestArray2[local23].anInt993 == 2) {
						local16.anIntArray491[local23] = -6;
					}
					if (local16.aPrivelegedRequestArray2[local23].anInt993 == 0) {
						local21 = true;
					}
				}
			}
			...
			for (@Pc(113) int local113 = 0; local113 < local16.anInt7154; local113++) {
				if (local16.anIntArray491[local113] == 0) {
					try {
						...
						@Pc(150) int local150;
						if (local137 == 0) {
							local146 = (Field) local16.aPrivelegedRequestArray1[local113].anObject2;
						...
						if (local137 == 3) {
							local218 = (Method) local16.aPrivelegedRequestArray2[local113].anObject2;
