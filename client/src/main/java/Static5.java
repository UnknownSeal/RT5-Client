...
public final class Static5 {
	...
	public static PrivelegedRequest sockerRequest;
	...
	public static Frame method85(@OriginalArg(0) int arg0, @OriginalArg(3) SignLink arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3) {
		...
		@Pc(98) PrivelegedRequest local98 = arg1.method3748(arg2, arg0, arg3);
		...
		if (local110 == null) {
			...
			Static17.method4214(local110, arg1);
			return null;
		} else {
			return local110;
		}
	...
	public static void method88(@OriginalArg(1) Packet arg0, @OriginalArg(2) int arg1) {
		while (true) {
			@Pc(16) Class2_Sub42 local16 = (Class2_Sub42) Static337.aLinkedList_37.head();
			if (local16 == null) {
				return;
			}
			@Pc(21) boolean local21 = false;
			for (@Pc(23) int local23 = 0; local23 < local16.anInt7154; local23++) {
				if (local16.aPrivelegedRequestArray1[local23] != null) {
					if (local16.aPrivelegedRequestArray1[local23].status == 2) {
						local16.anIntArray491[local23] = -5;
					}
					if (local16.aPrivelegedRequestArray1[local23].status == 0) {
						local21 = true;
					}
				}
				if (local16.aPrivelegedRequestArray2[local23] != null) {
					if (local16.aPrivelegedRequestArray2[local23].status == 2) {
						local16.anIntArray491[local23] = -6;
					}
					if (local16.aPrivelegedRequestArray2[local23].status == 0) {
						local21 = true;
					}
				}
			}
			...
			arg0.p1isaac(arg1);
			arg0.p1(0);
			@Pc(106) int local106 = arg0.offset;
			...
			for (@Pc(113) int local113 = 0; local113 < local16.anInt7154; local113++) {
				if (local16.anIntArray491[local113] == 0) {
					try {
						...
						@Pc(150) int local150;
						if (local137 == 0) {
							local146 = (Field) local16.aPrivelegedRequestArray1[local113].result;
						...
						if (local137 == 3) {
							local218 = (Method) local16.aPrivelegedRequestArray2[local113].result;
			...
			arg0.psize1(arg0.offset - local106);
			local16.unlink();
		}
	}
}
