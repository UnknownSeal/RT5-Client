...
public final class Class2_Sub6 extends Node {
		...
		if (local13 == 0) {
			...
			if (local119 instanceof Class11_Sub1_Sub1) {
				...
				if (local125.aClass11_Sub1_1 != null) {
					return ((Interface6) local125.aClass11_Sub1_1).method6087(arg1, arg0);
				}
			}
		} else if (local13 == 1) {
			...
			if (local28 instanceof Class11_Sub3_Sub1) {
				...
				if (local34.aClass11_Sub3_1 != null) {
					return ((Interface6) local34.aClass11_Sub3_1).method6087(arg1, arg0);
				}
			}
		} else if (local13 == 2) {
			...
			if (local94 instanceof Class11_Sub5_Sub6) {
				...
				if (local100.aClass11_Sub5_2 != null) {
					return ((Interface6) local100.aClass11_Sub5_2).method6087(arg1, arg0);
				}
			}
		} else if (local13 == 3) {
			...
			if (local61 instanceof Class11_Sub2_Sub2) {
				...
				if (local67.aClass11_Sub2_1 != null) {
					return ((Interface6) local67.aClass11_Sub2_1).method6087(arg1, arg0);
				}
			}
		}
		return null;
