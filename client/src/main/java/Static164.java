...
public final class Static164 {
	...
	public static void method3146(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class130 arg6, @OriginalArg(8) Class239 arg7, @OriginalArg(9) Class78 arg8, @OriginalArg(10) String arg9, @OriginalArg(11) Class161 arg10) {
		...
		if (-arg10.anInt4248 <= local109 && arg10.anInt4248 >= local109 && -arg10.anInt4261 <= local96 && local96 <= arg10.anInt4261) {
			arg6.method5892(arg0, 0, arg10.anInt4248 / 2 + local109 + arg0, 1, 0, null, arg2, arg8, 50, arg9, 0, arg10.anInt4261 / 2 + arg2 - local117 - local96 - arg5, null, arg3, local103);
		}
	}
	...
	public static void method3147() {
		...
		try {
			...
			if (Static154.anInt2803 == 1) {
				Static5.aPrivelegedRequest_1 = Static328.aClass152_5.method3750(Static61.aString14, Static278.anInt5154);
			...
			if (Static154.anInt2803 == 2) {
				...
				local125 = Static335.aBufferedSocket_4.method2800();
				if (Static303.aClass221_2 != null) {
					Static303.aClass221_2.method6324();
				}
				if (Static190.aClass221_1 != null) {
			...
			if (Static154.anInt2803 == 3 && Static335.aBufferedSocket_4.method2795() >= 2) {
				local125 = Static335.aBufferedSocket_4.method2800() << 8 | Static335.aBufferedSocket_4.method2800();
				Static375.method6278(local125);
