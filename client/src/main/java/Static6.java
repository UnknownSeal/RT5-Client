...
public final class Static6 {
	...
	public static void method141(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		Static161.method2971(local43, true);
	}
	...
	public static void method142(@OriginalArg(0) Class161 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		if (!Static330.aBoolean419) {
			...
			for (@Pc(5) int local5 = 9; local5 >= 5; local5--) {
				...
				if (local12 != null) {
					Static1.method3(arg0.anInt4300, true, arg0.anInt4317, false, local12, arg0.anInt4297, 1011, arg0.aString45, Static274.method4630(arg0, local5), (long) (local5 + 1));
				}
			}
			...
			for (@Pc(75) int local75 = 4; local75 >= 0; local75--) {
				...
				if (local82 != null) {
					Static1.method3(arg0.anInt4300, true, arg0.anInt4317, false, local82, arg0.anInt4297, 45, arg0.aString45, Static274.method4630(arg0, local75), (long) (local75 + 1));
				}
			}
			if (Static45.method1404(arg0).method1855()) {
				if (arg0.aString46 == null) {
					Static1.method3(arg0.anInt4300, true, arg0.anInt4317, false, Static262.A_TRANSLATABLE_STRING___145.getLocalisedText(Static295.anInt5581), arg0.anInt4297, 30, "", -1, 0L);
				} else {
