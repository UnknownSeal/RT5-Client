...
public final class Class2_Sub25 extends Class2 {
	...
	public Class2_Sub25(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(38) int local38;
		for (local38 = 0; local36.aByteArray73[local36.anInt5300 + local38] != 0; local38++) {
		}
		@Pc(52) byte[] local52 = new byte[local38];
		for (@Pc(54) int local54 = 0; local54 < local38; local54++) {
			local52[local54] = local36.method4824();
		}
		local38++;
		local36.anInt5300++;
		@Pc(80) int local80 = local36.anInt5300;
		local36.anInt5300 += local38;
		@Pc(88) int local88;
		for (local88 = 0; local36.aByteArray73[local36.anInt5300 + local88] != 0; local88++) {
		}
		@Pc(102) byte[] local102 = new byte[local88];
		for (@Pc(104) int local104 = 0; local104 < local88; local104++) {
			local102[local104] = local36.method4824();
		}
		local88++;
		local36.anInt5300++;
		@Pc(130) int local130 = local36.anInt5300;
		local36.anInt5300 += local88;
		@Pc(138) int local138;
		for (local138 = 0; local36.aByteArray73[local138 + local36.anInt5300] != 0; local138++) {
		}
		@Pc(152) byte[] local152 = new byte[local138];
		for (@Pc(154) int local154 = 0; local154 < local138; local154++) {
			local152[local154] = local36.method4824();
		}
		local138++;
		local36.anInt5300++;
		...
		for (local189 = 0; local189 < local224.length; local189++) {
			...
			@Pc(240) int local240 = local36.method4814();
			if (local240 > 0) {
				local236.aByteArray3 = new byte[local240 * 2];
			}
			local240 = local36.method4814();
			if (local240 > 0) {
		...
		for (@Pc(630) int local630 = 0; local630 < 128; local630++) {
			if (local405 == 0) {
				...
				if (this.anIntArray264[local630] > 0) {
					local628 = local36.method4814() + 1;
				}
			}
			local405--;
			this.aByteArray47[local630] = (byte) local628;
		}
		this.anInt4064 = local36.method4814() + 1;
		@Pc(689) int local689;
		for (@Pc(678) int local678 = 0; local678 < local187; local678++) {
			...
			if (local684.aByteArray3 != null) {
				for (local689 = 1; local689 < local684.aByteArray3.length; local689 += 2) {
					local684.aByteArray3[local689] = local36.method4824();
				}
			}
			if (local684.aByteArray4 != null) {
				for (local689 = 3; local689 < local684.aByteArray4.length - 2; local689 += 2) {
					local684.aByteArray4[local689] = local36.method4824();
				}
			}
		}
		@Pc(742) int local742;
		if (local294 != null) {
			for (local742 = 1; local742 < local294.length; local742 += 2) {
				local294[local742] = local36.method4824();
			}
		}
		if (local310 != null) {
			for (local742 = 1; local742 < local310.length; local742 += 2) {
				local310[local742] = local36.method4824();
			}
		}
		@Pc(791) int local791;
		...
		for (local689 = 0; local689 < local187; local689++) {
			...
			if (local833.aByteArray3 != null) {
				...
				for (local840 = 2; local840 < local833.aByteArray3.length; local840 += 2) {
					local352 = local352 + local36.method4814() + 1;
		...
		if (local294 != null) {
			...
			while (local294.length > local933) {
				...
				for (local961 = local904; local961 < local939; local961++) {
					local971 = Static220.method3875(local959, local939 - local904);
	...
	public boolean method4017(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Class24 arg1, @OriginalArg(3) int[] arg2) {
