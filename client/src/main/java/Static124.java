...
public final class Static124 {
	...
	public static Class98 aClass98_63 = new Class98(50);

	@OriginalMember(owner = "client!hb", name = "k", descriptor = "[I")
	public static int[] anIntArray476 = new int[] { 16776960, 16711680, 65280, 65535, 16711935, 16777215 };

	@OriginalMember(owner = "client!hb", name = "u", descriptor = "[S")
	public static short[] aShortArray128 = new short[] { 76, 8, 137, 4, 0, 1, 38, 2, 19 };
