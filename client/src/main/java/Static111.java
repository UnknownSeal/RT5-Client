...
public final class Static111 {
	...
	public static void method2274() {
		for (@Pc(15) Class2_Sub6 local15 = (Class2_Sub6) Static366.A_LINKED_LIST___40.head(); local15 != null; local15 = (Class2_Sub6) Static366.A_LINKED_LIST___40.next()) {
				...
				if (Static114.loop >= local15.anInt1118) {
					...
					if (local41 == 0) {
						...
						if (local262 instanceof Class11_Sub1_Sub1) {
							Static259.method4428(local15.anInt1110, local15.anInt1117, local15.anInt1109);
						...
						if (local54 instanceof Class11_Sub3_Sub1) {
							Static201.method3653(local15.anInt1110, local15.anInt1117, local15.anInt1109);
						...
						if (local117 instanceof Class11_Sub2_Sub2) {
							Static370.method6245(local15.anInt1110, local15.anInt1117, local15.anInt1109);
					...
					if (local41 == 0) {
						...
						if (local162 instanceof Class11_Sub5_Sub6) {
							...
							Static188.method3465(local15.anInt1110, local15.anInt1117, local15.anInt1109, Interface6.class);
							@Pc(191) Class41 local191 = LocTypeList.locTypeList.method5162(local15.anInt1112);
							@Pc(207) int local207;
							@Pc(204) int local204;
							...
							Static329.method5629(local248, false);
						}
					} else if (local41 == 3) {
						local117 = Static26.method865(local15.anInt1110, local15.anInt1117, local15.anInt1109);
						if (local117 instanceof Class11_Sub2_Sub2) {
