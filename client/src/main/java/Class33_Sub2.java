	...
	public void method5711(@OriginalArg(0) int arg0) {
		if ((arg0 & 0x1) == 1) {
			if (this.aClass76_2.aBoolean160) {
				...
				this.aClass19_Sub1_35.anOpengl1.glTexGenfv(GL.GL_R, GL.GL_OBJECT_PLANE, Static130.aFloatArray13, 0);
			} else {
