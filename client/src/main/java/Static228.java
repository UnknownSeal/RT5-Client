...
public final class Static228 {
	...
	public static void method3994(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(6) int arg3) {
		@Pc(7) int local7 = Static31.anInt751;
		Static45.anInt1196 = 0;
		@Pc(11) int[] local11 = Static85.anIntArray121;
		@Pc(194) int local194;
		@Pc(217) int local217;
		@Pc(261) int local261;
		@Pc(435) int local435;
		...
		@Pc(663) int local663;
		@Pc(322) int local322;
		for (@Pc(13) int local13 = 0; local13 < Static166.size + local7; local13++) {
			@Pc(17) NpcType local17 = null;
			@Pc(33) Class11_Sub5_Sub2 local33;
			if (local7 <= local13) {
				local33 = Static365.npcs[Static211.ids[local13 - local7]];
			...
			if (local33.anInt4638 >= 0 && (Static163.anInt3086 == local33.anInt4603 || Static17.self.aByte78 == local33.aByte78)) {
				...
				if (Static216.anIntArray231[0] >= 0) {
					if (local33.aString50 != null && (local13 >= local7 || Static20.anInt545 == 0 || Static20.anInt545 == 3 || Static20.anInt545 == 1 && Static391.method6450(((Class11_Sub5_Sub2_Sub1) local33).aString41)) && Static319.anInt5977 > Static45.anInt1196) {
						Static319.anIntArray398[Static45.anInt1196] = Static113.aClass239_2.method6125(local33.aString50) / 2;
					...
					@Pc(180) Sprite local180 = Static62.aSpriteArray9[0];
					local194 = arg3 + Static216.anIntArray231[1] - Math.max(Static113.aClass239_2.anInt6836, local180.method6381());
					@Pc(209) Sprite local209;
					@Pc(310) int local310;
					if (!local33.aBoolean320 && Static114.loop < local33.anInt4606) {
						local209 = Static62.aSpriteArray9[1];
						if (local33 instanceof Npc) {
							local217 = local17.hitbarid;
							if (local217 == -1) {
						...
						if (local217 != -1) {
							@Pc(246) Sprite[] local246 = (Sprite[]) Static306.A_SOFT_LRU_HASH_TABLE___49.get((long) local217);
							if (local246 == null) {
								@Pc(253) SoftwareSprite[] local253 = Static396.method1688(client.js5Archive8, local217);
								if (local253 != null) {
						...
						local310 = arg0 + Static216.anIntArray231[0] - (local180.method6388() >> 1);
						local180.method6384(local310, local194);
						local322 = local180.method6388() * local33.anInt4631 / 255;
						if (local33.anInt4631 > 0 && local322 < 2) {
							local322 = 2;
						}
						Static190.aClass19_8.method2817(local310, local194, local322 + local310, local194 + local180.method6381());
						local209.method6384(local310, local194);
						Static190.aClass19_8.method2895(arg0, arg3, arg0 + arg1, arg3 - -arg2);
					}
					local194 -= 2;
					if (!local33.aBoolean320) {
						if (Static114.loop < local33.anInt4621) {
							local209 = Static332.aSpriteArray23[local33.aBoolean319 ? 2 : 0];
							@Pc(386) Sprite local386 = Static332.aSpriteArray23[local33.aBoolean319 ? 3 : 1];
							if (local33 instanceof Npc) {
							...
							if (local310 != -1) {
								@Pc(420) Sprite[] local420 = (Sprite[]) Static139.A_SOFT_LRU_HASH_TABLE___18.get((long) local310);
								if (local420 == null) {
									@Pc(427) SoftwareSprite[] local427 = Static396.method1688(client.js5Archive8, local310);
									if (local427 != null) {
							...
							local322 = local33.anInt4621 - Static114.loop;
							if (local322 > local33.anInt4578) {
								...
								local261 = local209.method6388() * local435 / local33.anInt4623;
							} else {
								local261 = local209.method6388();
							}
							local435 = local209.method6381();
							local194 -= local435;
							local546 = Static216.anIntArray231[0] + arg0 - (local209.method6388() >> 1);
							local209.method6384(local546, local194);
							Static190.aClass19_8.method2817(local546, local194, local261 + local546, local194 - -local435);
							local386.method6384(local546, local194);
							local194 -= 2;
						...
						if (local13 < local7) {
							...
							if (local587.anInt4188 != -1) {
								local194 -= 25;
								Static232.aSpriteArray17[local587.anInt4188].method6384(Static216.anIntArray231[0] + arg0 - 12, local194);
								local194 -= 2;
							}
							if (local587.anInt4198 != -1) {
								local194 -= 25;
								Static137.aSprite[local587.anInt4198].method6384(arg0 + Static216.anIntArray231[0] - 12, local194);
								local194 -= 2;
							}
						} else if (local17.headicon >= 0 && local17.headicon < Static137.aSprite.length) {
							local209 = Static137.aSprite[local17.headicon];
							local194 -= 25;
							local209.method6384(arg0 + Static216.anIntArray231[0] - (local209.method6388() >> 1), local194);
							local194 -= 2;
						}
					}
					@Pc(665) HintArrow[] local665;
					@Pc(673) HintArrow local673;
					@Pc(695) Sprite local695;
					if (!(local33 instanceof Class11_Sub5_Sub2_Sub1)) {
						local663 = 0;
						local665 = Static50.HINT_ARROWS;
						for (local310 = 0; local310 < local665.length; local310++) {
							local673 = local665[local310];
							if (local673 != null && local673.type == 1 && Static211.ids[local13 - local7] == local673.target) {
								local695 = Static230.headHints[local673.headIcon];
								if (local695.method6381() > local663) {
									local663 = local695.method6381();
								}
								if (Static114.loop % 20 < 10) {
									local695.method6384(Static216.anIntArray231[0] + arg0 - 12, local194 - local695.method6381());
								}
							}
						}
						if (local663 > 0) {
						...
						for (local310 = 0; local310 < local665.length; local310++) {
							local673 = local665[local310];
							if (local673 != null && local673.type == 10 && local11[local13] == local673.target) {
								local695 = Static230.headHints[local673.headIcon];
								if (local663 < local695.method6381()) {
									local663 = local695.method6381();
								}
								local695.method6384(Static216.anIntArray231[0] + arg0 - 12, -local695.method6381() + local194);
							}
						}
						if (local663 > 0) {
						}
					...
					for (local663 = 0; local663 < 4; local663++) {
						if (local33.anIntArray315[local663] > Static114.loop) {
							local217 = local33.method4322() / 2;
							Static250.method4343(local217, local33, arg1 >> 1, arg2 >> 1);
							if (Static216.anIntArray231[0] > -1) {
								...
								Static15.aSpriteArray3[local33.anIntArray312[local663]].method6384(Static216.anIntArray231[0] + arg0 - 12, arg3 - -Static216.anIntArray231[1] + -12);
								Static200.aClass130_3.method5899(Integer.toString(local33.anIntArray313[local663]), 0, arg3 + Static216.anIntArray231[1] + 3, -1, arg0 - -Static216.anIntArray231[0] + -1);
							}
						}
					}
				}
		...
		for (@Pc(959) int local959 = 0; local959 < Static51.anInt1369; local959++) {
			...
			if (local965 >= 2048) {
				local974 = Static365.npcs[local965 - 2048];
			} else {
			...
			if (local194 < 2048) {
				...
				local991 = Static365.npcs[local194 - 2048];
			}
			Static242.method4194(local991, arg3, arg0, local974, arg1, arg2, --local974.anInt4625);
		}
		...
		for (@Pc(1030) int local1030 = 0; local1030 < Static45.anInt1196; local1030++) {
			...
			if (Static389.anInt4896 == 0) {
				...
				if (Static319.anIntArray400[local1030] == 0) {
					Static52.aClass130_1.method5899(local1134, -16777216, local663 + arg3, local435, arg0 + local194);
				}
				if (Static319.anIntArray400[local1030] == 1) {
					Static52.aClass130_1.method5904(local435, Static163.anInt3086, local1134, arg3 + local663, arg0 + local194);
				}
				if (Static319.anIntArray400[local1030] == 2) {
					Static52.aClass130_1.method5888(local435, local1134, local663 + arg3, local194 + arg0, Static163.anInt3086);
				}
				if (Static319.anIntArray400[local1030] == 3) {
					Static52.aClass130_1.method5894(Static163.anInt3086, local194 + arg0, -Static319.anIntArray401[local1030] + 150, local1134, local435, local663 + arg3);
				}
				if (Static319.anIntArray400[local1030] == 4) {
					local546 = (150 - Static319.anIntArray401[local1030]) * (Static113.aClass239_2.method6125(local1134) + 100) / 150;
					Static190.aClass19_8.method2817(local194 + arg0 - 50, arg3, arg0 + local194 + 50, arg3 - -arg2);
					Static52.aClass130_1.method5896(local194 + arg0 + 50 - local546, -16777216, local663 + arg3, local435, local1134);
					Static190.aClass19_8.method2895(arg0, arg3, arg1 + arg0, arg3 - -arg2);
				}
				if (Static319.anIntArray400[local1030] == 5) {
					...
					Static52.aClass130_1.method5899(local1134, -16777216, local1549 + arg3 + local663, local435, local194 + arg0);
					Static190.aClass19_8.method2895(arg0, arg3, arg0 + arg1, arg3 + arg2);
				}
			} else {
				Static52.aClass130_1.method5899(local1134, -16777216, arg3 + local663, -256, local194 + arg0);
			}
		}
	}

	@OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIII)Lclient!mr;")
	public static Class11_Sub5_Sub2 method3996(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
