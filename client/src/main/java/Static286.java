...
public final class Static286 {
	...
	public static void method4919() {
		for (@Pc(23) Class12_Sub5 local23 = (Class12_Sub5) Static131.aClass36_4.method1415(); local23 != null; local23 = (Class12_Sub5) Static131.aClass36_4.method1420()) {
			local23.method4349();
		}
	}
	...
	public static boolean method4922(@OriginalArg(0) Class2_Sub20 arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) Class164 arg2) {
		...
		if (arg2.anInt4420 != -1) {
			if (arg0.aBoolean207 && arg2.anInt4438 != -1) {
				local123 = arg2.method4188(arg1, true);
			} else {
				local123 = arg2.method4188(arg1, false);
			}
			if (local123 != null) {
				local125 = arg0.anInt2948 - (local123.method6398() + 1 >> 1);
				local127 = arg0.anInt2948 + (local123.method6398() + 1 >> 1);
				if (local125 < local24) {
					local24 = local125;
				}
				local129 = arg0.anInt2944 - (local123.method6383() + 1 >> 1);
				if (local127 > local26) {
					local26 = local127;
				}
				if (local28 > local129) {
				...
				local131 = arg0.anInt2944 + (local123.method6383() + 1 >> 1);
				if (local131 > local30) {
					local30 = local131;
				}
			}
		...
		if (arg2.aString48 != null) {
			local232 = Static212.method3728(arg2.anInt4418);
			if (local232 != null) {
				local234 = Static52.aClass239_1.method6118(Static287.aStringArray52, arg2.aString48, null, null);
				local236 = arg0.anInt2944;
				if (local123 == null) {
					local236 -= local234 * local232.method2946() / 2;
				} else {
					local236 -= (local123.method6383() >> 1) + (local234 * local232.method2947());
				}
				for (local296 = 0; local296 < local234; local296++) {
					...
					local323 = local232.method2949(local302);
				...
				local246 = local236 + local232.method2947() * local234;
				if (local30 < local246) {
					local30 = local246;
				}
			}
		...
		if (arg2.anIntArray290 != null) {
			...
			Static293.method5045(arg1, local437, arg2.anInt4414);
		...
		if (local123 != null) {
			if (Static243.anInt4495 > 0 && (Static225.anInt3979 != -1 && Static225.anInt3979 == arg0.anInt2947 || Static236.anInt4301 != -1 && Static236.anInt4301 == arg2.anInt4424)) {
				...
				arg1.method2861(arg0.anInt2948, local123.method6388() / 2 + 7, local439, arg0.anInt2944);
				arg1.method2861(arg0.anInt2948, local123.method6388() / 2 + 5, local439, arg0.anInt2944);
				arg1.method2861(arg0.anInt2948, local123.method6388() / 2 + 3, local439, arg0.anInt2944);
				arg1.method2861(arg0.anInt2948, local123.method6388() / 2 + 1, local439, arg0.anInt2944);
				arg1.method2861(arg0.anInt2948, local123.method6388() / 2, local439, arg0.anInt2944);
			}
			local123.method6384(arg0.anInt2948 - (local123.method6398() >> 1), arg0.anInt2944 + -(local123.method6383() >> 1));
		}
		if (arg2.aString48 != null && local232 != null) {
			Static212.method3726(local238, local234, local236, local232, arg1, arg0, arg2);
		}
	...
	public static void method4924(@OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1) {
		@Pc(10) Class2_Sub41 local10 = Static374.method6274(arg0, arg1);
		if (local10 != null) {
