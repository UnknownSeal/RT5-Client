...
public final class Static43 {
	...
	public static final Class242 aClass242_1 = new Class242(14, 1);

	@OriginalMember(owner = "client!ck", name = "K", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_2 = new Class242(15, 4);

	@OriginalMember(owner = "client!ck", name = "L", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_3 = new Class242(16, -2);

	@OriginalMember(owner = "client!ck", name = "M", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_4 = new Class242(17, 0);

	@OriginalMember(owner = "client!ck", name = "N", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_5 = new Class242(18, -2);

	@OriginalMember(owner = "client!ck", name = "O", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_6 = new Class242(20, 6);

	@OriginalMember(owner = "client!ck", name = "P", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_7 = new Class242(21, 8);

	@OriginalMember(owner = "client!ck", name = "Q", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_8 = new Class242(22, -2);

	@OriginalMember(owner = "client!ck", name = "R", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_9 = new Class242(23, 4);

	@OriginalMember(owner = "client!ck", name = "S", descriptor = "Lclient!vr;")
	public static final Class242 aClass242_10 = new Class242(24, -1);
}
