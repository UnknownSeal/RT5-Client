...
public final class Class2_Sub4_Sub1 extends Buffer {
	...
	public void method3057(@OriginalArg(0) float arg0) {
		...
		this.data[this.offset++] = (byte) local6;
		this.data[this.offset++] = (byte) (local6 >> 8);
		this.data[this.offset++] = (byte) (local6 >> 16);
		this.data[this.offset++] = (byte) (local6 >> 24);
	}
	...
	public void method3058(@OriginalArg(0) float arg0) {
		...
		this.data[this.offset++] = (byte) (local2 >> 24);
		this.data[this.offset++] = (byte) (local2 >> 16);
		this.data[this.offset++] = (byte) (local2 >> 8);
		this.data[this.offset++] = (byte) local2;
	}
}
