...
public final class RawModel {
	...
	private void method4651(@OriginalArg(1) byte[] arg0) {
		...
		local15.offset = local295;
		local20.offset = local301;
		local25.offset = local307;
		local30.offset = local242;
		...
		for (@Pc(545) int local545 = 0; local545 < this.anInt5075; local545++) {
			...
			if ((local551 & 0x1) != 0) {
				local553 = local15.gsmart();
			}
			@Pc(563) int local563 = 0;
			if ((local551 & 0x2) != 0) {
				local563 = local20.gsmart();
			}
			@Pc(573) int local573 = 0;
			if ((local551 & 0x4) != 0) {
				local573 = local25.gsmart();
			}
		...
		local10.offset = local286;
		local15.offset = local204;
		local20.offset = local220;
		local25.offset = local252;
		local30.offset = local230;
		local35.offset = local268;
		local48.offset = local280;
		...
		local10.offset = local262;
		this.anInt5087 = -1;
		local15.offset = local213;
		...
		for (@Pc(778) int local778 = 0; local778 < this.anInt5071; local778++) {
			local784 = local15.g1();
			if (local784 == 1) {
				local770 = (short) (local776 + local10.gsmart());
				local772 = (short) (local10.gsmart() + local770);
				local774 = (short) (local10.gsmart() + local772);
				local776 = local774;
			...
			if (local784 == 2) {
				local772 = local774;
				local774 = (short) (local10.gsmart() + local776);
				local776 = local774;
				this.aShortArray97[local778] = local770;
				this.aShortArray105[local778] = local772;
				this.aShortArray102[local778] = local774;
		...
		this.anInt5087++;
		local10.offset = local313;
		local15.offset = local321;
		local20.offset = local329;
		local25.offset = local337;
		local30.offset = local343;
		local35.offset = local349;
	...
	private void method4653(@OriginalArg(1) byte[] arg0) {
		...
		this.aShortArray97 = new short[this.anInt5071];
		this.aShortArray102 = new short[this.anInt5071];
		local19.offset = local187;
		local24.offset = local193;
		local29.offset = local100;
		local34.offset = local141;
		...
		for (@Pc(344) int local344 = 0; local344 < this.anInt5075; local344++) {
			...
			local352 = 0;
			if ((local350 & 0x1) != 0) {
				local352 = local19.gsmart();
			}
			@Pc(365) int local365 = 0;
			if ((local350 & 0x2) != 0) {
				local365 = local24.gsmart();
			}
			@Pc(378) int local378 = 0;
			if ((local350 & 0x4) != 0) {
				local378 = local29.gsmart();
			}
		...
		local14.offset = local169;
		local19.offset = local129;
		local24.offset = local109;
		local29.offset = local151;
		local34.offset = local119;
		...
		this.anInt5087 = -1;
		local14.offset = local163;
		local19.offset = local102;
		...
		for (@Pc(602) int local602 = 0; local602 < this.anInt5071; local602++) {
			local608 = local19.g1();
			if (local608 == 1) {
				local594 = (short) (local600 + local14.gsmart());
				local596 = (short) (local14.gsmart() + local594);
				local598 = (short) (local596 + local14.gsmart());
				local600 = local598;
			...
			if (local608 == 2) {
				local596 = local598;
				local598 = (short) (local14.gsmart() + local600);
				local600 = local598;
				this.aShortArray97[local602] = local594;
				this.aShortArray105[local602] = local596;
				this.aShortArray102[local602] = local598;
			...
			if (local608 == 3) {
				local594 = local598;
				local598 = (short) (local600 + local14.gsmart());
				local600 = local598;
				this.aShortArray97[local602] = local594;
				this.aShortArray105[local602] = local596;
				this.aShortArray102[local602] = local598;
