...
public final class Static243 {
	...
	public static void method4238(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12) {
		...
		if (arg8 < 0) {
			...
			local18 = arg8 - 1;
			local27 = Static365.npcs[local18];
		}
		if (local27 == null) {
			return;
		}
		...
		@Pc(138) int local138 = local114.method5718(local79, local102) + local114.method5718(local96, local102) + local114.method5718(local79, local110) + local114.method5718(local96, local110) >> 2;
		@Pc(142) Class2_Sub6 local142 = new Class2_Sub6();
		local142.anInt1110 = local27.aByte78;
		local142.anInt1118 = arg3 + Static114.loop;
		local142.anInt1100 = Static114.loop + arg7;
		...
		Static366.A_LINKED_LIST___40.addTail(local142);
