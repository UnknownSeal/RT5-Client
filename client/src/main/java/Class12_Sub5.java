...
public final class Class12_Sub5 extends Class12 {
	...
	public void method4349() {
		this.aClass224_2.aClass191_1.method4891();
		for (@Pc(10) Class12_Sub8 local10 = (Class12_Sub8) this.aClass36_5.method1415(); local10 != null; local10 = (Class12_Sub8) this.aClass36_5.method1420()) {
			local10.method5687(this.aLong137);
		}
	}
	...
	public boolean method4351(@OriginalArg(0) Class19 arg0, @OriginalArg(1) long arg1) {
		...
		for (local36 = (Class12_Sub8) this.aClass36_5.method1415(); local36 != null; local36 = (Class12_Sub8) this.aClass36_5.method1420()) {
			local36.method5685(arg1, arg0, local27, !this.aBoolean323);
		}
		this.aLong137 = arg1;
		return true;
	}
	...
	private void method4352(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class114[] arg1) {
	...
	public void method4354(@OriginalArg(0) long arg0) {
		this.aLong138 = arg0;
	}
	...
	public void method4355() {
		...
		for (@Pc(8) Class2_Sub2_Sub5 local8 = (Class2_Sub2_Sub5) this.aLinkedList_29.head(); local8 != null; local8 = (Class2_Sub2_Sub5) this.aLinkedList_29.next()) {
	...
	public void method4356(@OriginalArg(0) Class19 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) Class114[] arg2, @OriginalArg(3) Class163[] arg3) {
		if (!this.aBoolean322) {
			this.method4352(arg0, arg2);
			this.method4361(arg3);
			this.aLong138 = arg1;
		}
	}

	@OriginalMember(owner = "client!oh", name = "e", descriptor = "()Lclient!tp;")
	public Class224 method4357() {
	...
	public void method4360(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		this.anInt4679 = arg0;
		this.anInt4677 = arg1;
		this.anInt4676 = arg2;
		this.anInt4680 = arg3;
	...
	private void method4361(@OriginalArg(0) Class163[] arg0) {
		for (@Pc(1) int local1 = 0; local1 < 8; local1++) {
			Static251.aBooleanArray38[local1] = false;
		}
		@Pc(21) int local21;
		label68: for (@Pc(16) Class2_Sub2_Sub5 local16 = (Class2_Sub2_Sub5) this.aLinkedList_29.head(); local16 != null; local16 = (Class2_Sub2_Sub5) this.aLinkedList_29.next()) {
			if (arg0 != null) {
		...
		for (local21 = 0; local21 < arg0.length && this.anInt4678 != 8; local21++) {
			if (!Static251.aBooleanArray38[local21]) {
				...
				if (Static314.method5366(arg0[local21].anInt4330).anInt737 == 1 && Static201.anInt3701 < 32) {
					local93 = new Class2_Sub2_Sub5(arg0[local21], this);
					Static141.aClass115_1.method2977((long) arg0[local21].anInt4330, local93);
					Static201.anInt3701++;
				}
				if (local93 == null) {
					local93 = new Class2_Sub2_Sub5(arg0[local21], this);
				}
				this.aLinkedList_29.addTail(local93);
				this.anInt4678++;
				Static251.aBooleanArray38[local21] = true;
			}
		}
