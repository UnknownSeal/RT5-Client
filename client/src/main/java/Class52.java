...
public final class Class52 {
	...
	private void method1767(@OriginalArg(0) Class2_Sub4 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.aChar4 = Static78.method5697(arg0.method4824());
		} else if (arg1 == 2) {
			this.aChar3 = Static78.method5697(arg0.method4824());
		} else if (arg1 == 3) {
			this.aString16 = arg0.method4808();
		} else if (arg1 == 4) {
			this.anInt1634 = arg0.method4835();
		} else if (arg1 == 5 || arg1 == 6) {
			@Pc(45) int local45 = arg0.method4828();
			this.aClass4_31 = new Class4(Static162.method2976(local45));
			for (@Pc(55) int local55 = 0; local55 < local45; local55++) {
				@Pc(61) int local61 = arg0.method4835();
				@Pc(73) Class2 local73;
				if (arg1 == 5) {
					local73 = new Class2_Sub40(arg0.method4808());
				} else {
					local73 = new Class2_Sub39(arg0.method4835());
				}
	...
	public void method1774(@OriginalArg(1) Class2_Sub4 arg0) {
		while (true) {
