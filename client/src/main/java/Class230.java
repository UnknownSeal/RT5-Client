...
public final class Class230 {
	...
	private void method5831(@OriginalArg(1) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			...
			if (arg1 == 3) {
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArrayArray55[local31][1] = arg0.mg4();
					this.anIntArrayArray55[local31][2] = arg0.mg4();
				}
			} else if (arg1 == 4) {
				local24 = arg0.g1();
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArrayArray57[local31][1] = arg0.mg4();
					this.anIntArrayArray57[local31][2] = arg0.mg4();
				}
			} else if (arg1 == 5) {
				arg0.g2();
			} else if (arg1 == 6) {
				...
				if (arg1 == 9) {
					...
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArray436[local31] = arg0.mg4();
					}
				} else if (arg1 == 12) {
					arg0.mg4();
				} else if (arg1 == 13) {
					...
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArray442[local31] = arg0.mg4();
						this.anIntArray440[local31] = arg0.mg4();
						this.anIntArray437[local31] = arg0.mg4();
					...
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArray439[local31] = arg0.mg4();
						this.anIntArray438[local31] = arg0.mg4();
						this.anIntArray441[local31] = arg0.mg4();
						this.aStringArray60[local31] = arg0.gjstr();
					}
				} else if (arg1 == 249) {
					local24 = arg0.g1();
					if (this.aClass4_134 == null) {
						local31 = Static162.clp2(local24);
					...
					for (local31 = 0; local31 < local24; local31++) {
						...
						if (local329) {
							local342 = new StringNode(arg0.gjstr());
						} else {
							local342 = new IntNode(arg0.mg4());
						}
	...
	public void method5835(@OriginalArg(1) Buffer arg0) {
		while (true) {
