...
public final class Class230 {
	...
	private void method5831(@OriginalArg(1) Class2_Sub4 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			this.aString64 = arg0.method4855();
		} else if (arg1 == 2) {
			this.aString63 = arg0.method4855();
		} else {
			@Pc(24) int local24;
			@Pc(31) int local31;
			if (arg1 == 3) {
				local24 = arg0.method4814();
				this.anIntArrayArray55 = new int[local24][3];
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArrayArray55[local31][0] = arg0.method4828();
					this.anIntArrayArray55[local31][1] = arg0.method4835();
					this.anIntArrayArray55[local31][2] = arg0.method4835();
				}
			} else if (arg1 == 4) {
				local24 = arg0.method4814();
				this.anIntArrayArray57 = new int[local24][3];
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArrayArray57[local31][0] = arg0.method4828();
					this.anIntArrayArray57[local31][1] = arg0.method4835();
					this.anIntArrayArray57[local31][2] = arg0.method4835();
				}
			} else if (arg1 == 5) {
				arg0.method4828();
			} else if (arg1 == 6) {
				...
				if (arg1 == 9) {
					...
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArray436[local31] = arg0.method4835();
					}
				} else if (arg1 == 12) {
					arg0.method4835();
				} else if (arg1 == 13) {
					...
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArray443[local31] = arg0.method4828();
					}
				} else if (arg1 == 14) {
					local24 = arg0.method4814();
					this.anIntArrayArray56 = new int[local24][2];
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArrayArray56[local31][0] = arg0.method4814();
						this.anIntArrayArray56[local31][1] = arg0.method4814();
					}
				} else if (arg1 == 15) {
					arg0.method4828();
				} else if (arg1 == 17) {
					this.anInt6454 = arg0.method4828();
				} else if (arg1 == 18) {
					local24 = arg0.method4814();
					...
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArray442[local31] = arg0.method4835();
						this.anIntArray440[local31] = arg0.method4835();
						this.anIntArray437[local31] = arg0.method4835();
						this.aStringArray61[local31] = arg0.method4808();
					}
				} else if (arg1 == 19) {
					local24 = arg0.method4814();
					...
					for (local31 = 0; local31 < local24; local31++) {
						this.anIntArray439[local31] = arg0.method4835();
						this.anIntArray438[local31] = arg0.method4835();
						this.anIntArray441[local31] = arg0.method4835();
						this.aStringArray60[local31] = arg0.method4808();
					}
				} else if (arg1 == 249) {
					local24 = arg0.method4814();
					if (this.aClass4_134 == null) {
						local31 = Static162.method2976(local24);
						this.aClass4_134 = new Class4(local31);
					}
					for (local31 = 0; local31 < local24; local31++) {
						@Pc(329) boolean local329 = arg0.method4814() == 1;
						@Pc(333) int local333 = arg0.method4832();
						@Pc(342) Class2 local342;
						if (local329) {
							local342 = new Class2_Sub40(arg0.method4808());
						} else {
							local342 = new Class2_Sub39(arg0.method4835());
						}
	...
	public void method5835(@OriginalArg(1) Class2_Sub4 arg0) {
		while (true) {
			@Pc(13) int local13 = arg0.method4814();
			if (local13 == 0) {
				return;
			}
			this.method5831(arg0, local13);
		}
	}
}
