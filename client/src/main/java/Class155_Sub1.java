...
public final class Class155_Sub1 extends Class155 implements ImageProducer {
	...
	private synchronized void method3917(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
	...
	@Override
	public void method5150(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Graphics arg3, @OriginalArg(5) int arg4) {
		this.method3917(arg1, arg0, arg4, arg2);
	...
	private synchronized void method3918() {
		if (this.anImageConsumer1 != null) {
	...
	@Override
	public void method5149(@OriginalArg(0) Canvas arg0) {
		this.aCanvas4 = arg0;
	...
	@Override
	public void method5151(@OriginalArg(0) Graphics arg0) {
		this.method3918();
