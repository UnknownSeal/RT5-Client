...
public final class Static344 {
	...
	private static void method5509(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub4 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7) {
		@Pc(3) int local3 = arg1.method4814();
		if ((local3 & 0x1) == 0) {
			@Pc(15) boolean local15 = (local3 & 0x2) == 0;
			@Pc(21) int local21 = local3 >> 2 & 0x3F;
			if (local21 != 62) {
				if (local21 == 63) {
					local21 = arg1.method4814();
				} else if (local15) {
				...
				if (local15) {
					...
					aByteArray88[arg4 + arg5 * anInt6056] = arg1.method4824();
				}
			}
			return;
		}
		...
		for (@Pc(118) int local118 = 0; local118 < local100; local118++) {
			@Pc(123) int local123 = arg1.method4814();
			@Pc(125) int local125 = 0;
			@Pc(127) int local127 = 0;
			if (local108) {
				local125 = arg1.method4814();
				local127 = arg1.method4814();
			}
			@Pc(139) int local139 = 0;
			if (local116) {
				local139 = arg1.method4814();
			}
			...
			if (local118 == 0) {
				...
				if (local139 == 1) {
					aShortArray122[arg4 + arg5 * anInt6056] = (short) (arg1.method4828() + 1);
					aByteArray87[arg4 + arg5 * anInt6056] = arg1.method4824();
				} else if (local139 > 1) {
					...
					for (local220 = 0; local220 < local139; local220++) {
						local215[local220] = (short) arg1.method4828();
						local218[local220] = arg1.method4824();
					}
	...
	public static void method5510() {
		...
		for (@Pc(4) int local4 = 0; local4 < aClass103_5.anInt2702; local4++) {
			@Pc(32) boolean local32 = aClass2_Sub2_Sub17_3.method6144(aClass103_5.anIntArray170[local4] >> 28 & 0x3, local2, aClass103_5.anIntArray170[local4] >> 14 & 0x3FFF, aClass103_5.anIntArray170[local4] & 0x3FFF);
			if (local32) {
				...
				aClass135_36.method3539(local42);
			}
		}
	}
	...
	public static void method5511(@OriginalArg(0) Class197 arg0, @OriginalArg(1) Class72 arg1, @OriginalArg(2) Class241 arg2, @OriginalArg(3) Class202 arg3, @OriginalArg(4) Class125 arg4, @OriginalArg(5) Class104 arg5, @OriginalArg(6) Interface11 arg6) {
		aClass197_85 = arg0;
		aClass72_6 = arg1;
		aClass241_4 = arg2;
		aClass202_3 = arg3;
	...
	private static int method5514(@OriginalArg(0) Interface2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	private static Class135 method5516(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(4) Class2_Sub20 local4 = (Class2_Sub20) aClass135_36.method3550(); local4 != null; local4 = (Class2_Sub20) aClass135_36.method3551()) {
	...
	private static void method5519(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) short[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(16) int local16 = -5; local16 < anInt6056; local16++) {
			...
			for (@Pc(27) int local27 = 0; local27 < anInt6052; local27++) {
				...
				if (local21 < anInt6056) {
					...
					if (local41 > 0) {
						local50 = aClass241_4.method6270(local41 - 1);
						local2[local27] += local50.anInt6378;
						local5[local27] += local50.anInt6379;
						local8[local27] += local50.anInt6381;
						local11[local27] += local50.anInt6372;
				...
				for (@Pc(167) int local167 = -5; local167 < anInt6052; local167++) {
					...
					if (local167 >= 0 && local165 > 0) {
						...
						if ((arg0[local16 + local167 * anInt6056] & 0xFF) == 0) {
							...
							local261 = local163 == 0 ? 0 : Static181.method3380(local41 * 256 / local163, local161 / local165, local159 / local165);
							...
							@Pc(333) int local333 = Static181.anIntArray204[Static26.method863(Static303.method5208(local316)) & 0xFFFF];
	...
	public static void method5520(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(9) Class2_Sub4 local9 = new Class2_Sub4(aClass197_85.method5083(aClass2_Sub2_Sub17_3.aString67, "area"));
		@Pc(13) int local13 = local9.method4814();
		@Pc(16) int[] local16 = new int[local13];
		for (@Pc(18) int local18 = 0; local18 < local13; local18++) {
			local16[local18] = local9.method4814();
		}
		@Pc(33) int local33 = local9.method4814();
		@Pc(36) int[] local36 = new int[local33];
		for (@Pc(38) int local38 = 0; local38 < local33; local38++) {
			local36[local38] = local9.method4814();
		}
		while (true) {
			@Pc(58) int local58;
			@Pc(64) int local64;
			...
			while (local9.anInt5300 < local9.aByteArray73.length) {
				@Pc(62) int local62;
				@Pc(84) int local84;
				if (local9.method4814() == 0) {
					local58 = local9.method4814();
					local62 = local9.method4814();
					for (local64 = 0; local64 < 64; local64++) {
						for (local67 = 0; local67 < 64; local67++) {
							...
							method5509(arg0, local9, local58, local62, local76, local84, local16, local36);
						}
					}
				} else {
					local58 = local9.method4814();
					local62 = local9.method4814();
					local64 = local9.method4814();
					local67 = local9.method4814();
					for (local76 = 0; local76 < 8; local76++) {
						for (local84 = 0; local84 < 8; local84++) {
							...
							method5509(arg0, local9, local58, local62, local136, local148, local16, local36);
						}
					}
				}
			}
			...
			for (local58 = 0; local58 < 3; local58++) {
				...
				method5519(local191, aByteArray86, aShortArray121, arg1, arg2);
			...
			method5519(aByteArray88, aByteArray86, aShortArray121, arg1, arg2);
			aByteArray88 = null;
			method5530();
			return;
		}
	...
	public static void method5521(@OriginalArg(0) Class19 arg0) {
	...
	public static Class135 method5523(@OriginalArg(0) Class19 arg0) {
		@Pc(3) int local3 = anInt6054 - anInt6058;
		@Pc(7) int local7 = anInt6060 - anInt6059;
		@Pc(15) int local15 = (anInt6051 - anInt6050 << 16) / local3;
		@Pc(23) int local23 = (anInt6061 - anInt6053 << 16) / local7;
		return method5516(arg0, local15, local23);
	}

	@OriginalMember(owner = "client!tt", name = "b", descriptor = "(Lclient!wm;IIII)V")
	private static void method5524(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = anInt6054 - anInt6058;
		@Pc(7) int local7 = anInt6060 - anInt6059;
					...
					for (local57 = 0; local57 < local7; local57++) {
						...
						if (local84 > 0) {
							...
							if (local175 == 0 && local177 == 0 && local179 == 0) {
								...
								method5508(arg0, local28, local70, local44, local84, local175, local177, aByteArray89[local173], null, null, true);
							} else if (local179 == 65535) {
								@Pc(282) Class2_Sub29 local282 = (Class2_Sub29) aClass4_125.method90((long) (local50 << 16 | local93));
								if (local282 != null) {
									method5508(arg0, local28, local70, local44, local84, local175, local177, aByteArray89[local173], local282.aShortArray109, local282.aByteArray71, true);
								}
							} else {
								aShortArray120[0] = (short) (local179 - 1);
								aByteArray85[0] = aByteArray87[local173];
								method5508(arg0, local28, local70, local44, local84, local175, local177, aByteArray89[local173], aShortArray120, aByteArray85, true);
							}
						}
					}
				} else {
					...
					for (local70 = -16; local70 < local7 + 16; local70++) {
						...
						if (local93 > 0) {
							...
							if (local173 >= 0 && local173 < anInt6052) {
								...
								if (local175 <= 0) {
									method5525(arg0, local40, local80, local50, local93, null, null);
								} else if (local175 == 65535) {
									@Pc(459) Class2_Sub29 local459 = (Class2_Sub29) aClass4_125.method90((long) (local57 << 16 | local173));
									if (local459 != null) {
										method5525(arg0, local40, local80, local50, local93, local459.aShortArray109, local459.aByteArray71);
									}
								} else {
									aShortArray120[0] = (short) (local175 - 1);
									aByteArray85[0] = aByteArray87[local57 + local173 * anInt6056];
									method5525(arg0, local40, local80, local50, local93, aShortArray120, aByteArray85);
								}
							}
						}
					}
				...
				for (local84 = local44; local84 <= local57; local84++) {
					...
					if (local589 != null) {
						...
						for (@Pc(612) Class12_Sub7 local612 = (Class12_Sub7) local589.method1415(); local612 != null; local612 = (Class12_Sub7) local589.method1420()) {
							...
							method5508(arg0, local641, local665, local653 - local641, local675 - local665, local612.anInt5883, local612.aByte63 & 0xFF, local612.aByte64, local612.aShortArray116, local612.aByteArray76, false);
						}
					}
				}
			}
				...
				for (local93 = local44; local93 <= local57; local93++) {
					...
					if (local727 != null) {
						...
						for (@Pc(750) Class12_Sub7 local750 = (Class12_Sub7) local727.method1415(); local750 != null; local750 = (Class12_Sub7) local727.method1420()) {
							...
							method5525(arg0, local653, local675, local665 - local653, local813 - local675, local750.aShortArray116, local750.aByteArray76);
						}
					}
				}
			}
	...
	private static void method5525(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) byte[] arg6) {
		if (arg5 == null) {
			return;
		}
			...
			if (local17 != -1) {
				...
				if (local49 != null) {
					...
					if (local25.aBoolean243) {
						@Pc(71) int local71 = local14.anInt1356;
						@Pc(74) int local74 = local14.anInt1327;
					...
					if (local58 != 0 && local65 != 0) {
						if (local25.anInt3752 == 0) {
							local49.method6387(arg1, arg2 + arg4 - local65, local58, local65);
						} else {
							local49.method6394(arg1, arg2 + arg4 - local65, local58, local65, 1, local25.anInt3752 | 0xFF000000, 1);
						}
					}
				}
			}
	...
	public static void method5527(@OriginalArg(0) Interface2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < aClass72_6.anInt2059; local1++) {
			anIntArray406[local1 + 1] = method5514(arg0, local1, arg1, arg2);
		}
	}

	@OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lclient!wm;Lclient!jg;IIII)V")
	private static void method5528(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class2_Sub20 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public static void method5529(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
	...
	private static void method5530() {
		@Pc(4) int local4;
		@Pc(15) int local15;
		@Pc(49) int local49;
				...
				if (local15 != 0) {
					...
					if (local15 == 65535) {
						...
						if (local31 != null) {
							for (local35 = 0; local35 < local31.aShortArray109.length; local35++) {
								...
								if (local49 != -1) {
									...
									aClass135_36.method3539(local70);
								}
							}
						}
					} else {
						...
						if (local35 != -1) {
							...
							aClass135_36.method3539(local118);
						}
					}
				}
			}
							...
							if (local160.aShortArray116 != null) {
								for (local49 = 0; local49 < local160.aShortArray116.length; local49++) {
									...
									if (local180 != -1) {
										...
										aClass135_36.method3539(local201);
									}
								}
							}
						}
