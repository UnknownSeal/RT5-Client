...
public final class Static391 {
	...
	public static void method6451(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg3 == 0) {
			...
			if (local43 != null && arg0 != 2) {
				if (local43 instanceof Class11_Sub1_Sub2) {
					((Class11_Sub1_Sub2) local43).aClass192_1.method4933(arg1);
				} else {
					Static79.method1871(arg6, arg5, local43.method6084(), arg4, arg3, arg1, arg0, arg2);
				}
			}
			if (local49 != null) {
				if (!(local49 instanceof Class11_Sub1_Sub2)) {
					Static79.method1871(arg6, arg5, local49.method6084(), arg4, arg3, arg1, arg0, arg2);
					return;
				}
				((Class11_Sub1_Sub2) local49).aClass192_1.method4933(arg1);
				return;
			}
			return;
		}
			...
			if (arg3 == 2) {
				...
				if (local43 != null) {
					...
					if (local43 instanceof Class11_Sub5_Sub5) {
						((Class11_Sub5_Sub5) local43).aClass192_4.method4933(arg1);
						return;
					}
					Static79.method1871(arg6, arg5, local43.method6084(), arg4, arg3, arg1, arg0, arg2);
					return;
				...
				((Class11_Sub2_Sub3) local43).aClass192_2.method4933(arg1);
			} else {
				return;
			}
			return;
		...
		if (local43 instanceof Class11_Sub3_Sub3) {
			((Class11_Sub3_Sub3) local43).aClass192_3.method4933(arg1);
		} else {
			@Pc(207) int local207 = local43.method6084();
			if (arg0 == 4 || arg0 == 5) {
	...
	public static void method6455(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public static void method6457(@OriginalArg(0) int arg0, @OriginalArg(1) byte[][][] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		Static193.anInt3556++;
		...
		if (!Static160.method2952(true)) {
			Static160.method2952(false);
		}
	}
}
