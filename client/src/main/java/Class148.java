...
public final class Class148 {
	...
	private void method3714(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 == 1) {
			this.anInt3769 = Static97.method2101(arg1.method4832());
		} else if (arg0 == 2) {
			this.anInt3762 = arg1.method4814();
		} else if (arg0 == 3) {
			this.anInt3762 = arg1.method4828();
			...
			this.anInt3757 = Static97.method2101(arg1.method4832());
		} else if (arg0 == 8) {
			this.aClass72_4.anInt2060 = this.anInt3756;
			return;
		} else if (arg0 == 9) {
			this.anInt3763 = arg1.method4828();
			return;
		} else if (arg0 == 10) {
			this.aBoolean246 = false;
			return;
		} else if (arg0 == 11) {
			this.anInt3772 = arg1.method4814();
			return;
		} else if (arg0 == 12) {
			this.aBoolean245 = true;
			return;
		} else if (arg0 == 13) {
			this.anInt3771 = arg1.method4832();
			return;
		} else {
			if (arg0 == 14) {
				this.anInt3766 = arg1.method4814();
			} else if (arg0 == 15) {
				this.anInt3759 = arg1.method4828();
				if (this.anInt3759 == 65535) {
					this.anInt3759 = -1;
					return;
				}
			} else if (arg0 == 16) {
				this.anInt3764 = arg1.method4814();
				return;
			} else {
				return;
			}
	...
	public void method3717(@OriginalArg(1) Class2_Sub4 arg0) {
		while (true) {
			@Pc(5) int local5 = arg0.method4814();
			if (local5 == 0) {
				return;
			}
			this.method3714(local5, arg0);
		}
	}
}
