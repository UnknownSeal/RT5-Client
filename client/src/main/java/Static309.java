...
public final class Static309 {
	...
	public static void method5278(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) {
		...
		if (Static301.anInt5700 >= 100) {
			Static207.method3699(Static322.A_TRANSLATABLE_STRING___125.getLocalisedText(Static295.anInt5581));
			return;
		}
		...
		for (@Pc(27) int local27 = 0; local27 < Static301.anInt5700; local27++) {
			...
			if (local35 != null && local35.equals(local22)) {
				Static207.method3699(arg0 + Static44.A_TRANSLATABLE_STRING___26.getLocalisedText(Static295.anInt5581));
				return;
			}
		...
		for (@Pc(95) int local95 = 0; local95 < Static384.anInt7178; local95++) {
			...
			if (local65 != null && local65.equals(local22)) {
				Static207.method3699(Static261.A_TRANSLATABLE_STRING___107.getLocalisedText(Static295.anInt5581) + arg0 + Static120.A_TRANSLATABLE_STRING___50.getLocalisedText(Static295.anInt5581));
				return;
			}
		...
		if (Static135.method2537(Static17.aClass11_Sub5_Sub2_Sub1_3.aString41).equals(local22)) {
			Static207.method3699(Static47.A_TRANSLATABLE_STRING___27.getLocalisedText(Static295.anInt5581));
		} else {
