...
public final class Static309 {
	...
	public static void method5278(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) {
		...
		if (Static301.anInt5700 >= 100) {
			Static207.method3699(Static322.A_TRANSLATABLE_STRING___125.getLocalisedText(client.language));
			return;
		}
		...
		for (@Pc(27) int local27 = 0; local27 < Static301.anInt5700; local27++) {
			...
			if (local35 != null && local35.equals(local22)) {
				Static207.method3699(arg0 + Static44.A_TRANSLATABLE_STRING___26.getLocalisedText(client.language));
				return;
			}
		...
		for (@Pc(95) int local95 = 0; local95 < Static384.anInt7178; local95++) {
			...
			if (local65 != null && local65.equals(local22)) {
				Static207.method3699(Static261.A_TRANSLATABLE_STRING___107.getLocalisedText(client.language) + arg0 + Static120.A_TRANSLATABLE_STRING___50.getLocalisedText(client.language));
				return;
			}
