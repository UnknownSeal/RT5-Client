...
public final class Static373 {
	...
	public static Class145 aClass145_254 = new Class145(43, 8);
	...
	public static void method6266(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		if (!arg2 && Static105.anInt2187 == arg1 && Static9.anInt212 == arg3 && (Static355.anInt6585 == Static44.anInt1115 || Static218.aClass177_Sub1_2.method4494(Static77.anInt1762))) {
			return;
		}
				...
				if (local183 != null) {
					...
					if (local183.anInt6781 >= 0 && local183.anInt6781 <= local103 && local183.anInt6783 >= 0 && local183.anInt6783 <= local175) {
						...
						if (local232) {
							...
							Static365.aClass11_Sub5_Sub2_Sub2Array1[local113].method4341(null);
