...
public final class Component {
	...
	public Class130 method4100(@OriginalArg(0) Class19 arg0) {
		...
		@Pc(26) Class130 local26 = (Class130) Static333.A_SOFT_LRU_HASH_TABLE___65.get((long) this.textFont);
		if (local26 != null) {
			return local26;
		}
		@Pc(35) SoftwareSprite[] local35 = Static396.method1678(Static79.aJs5_19, this.textFont);
		if (local35 == null) {
			Static86.aBoolean133 = true;
			return null;
		}
		@Pc(47) Class239 local47 = Static218.method1088(this.textFont, Static391.aJs5_95);
		if (local47 == null) {
			Static86.aBoolean133 = true;
			return null;
		} else {
			local26 = arg0.method2857(local47, local35);
			Static333.A_SOFT_LRU_HASH_TABLE___65.put((long) this.textFont, local26);
			return local26;
		}
	}
	...
	public Model method4104(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class107 arg2, @OriginalArg(3) Interface11 arg3, @OriginalArg(5) Class157 arg4, @OriginalArg(6) Class7 arg5, @OriginalArg(7) Class117 arg6, @OriginalArg(8) Class219 arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class85 arg9, @OriginalArg(11) int arg10, @OriginalArg(12) Class55 arg11, @OriginalArg(13) Class19 arg12) {
		...
		if (this.modelType == 0) {
			...
			if (this.modelType == 1) {
				...
				local61 = (Model) Static124.A_SOFT_LRU_HASH_TABLE___63.get((long) ((this.modelType << 16) + (arg12.anInt2836 << 29) + this.modelID));
				if (local61 == null || arg12.method2863(local61.method3826(), arg10) != 0) {
					...
					Static124.A_SOFT_LRU_HASH_TABLE___63.put((long) (this.modelID + (this.modelType << 16)), local61);
				}
				if (arg4 != null) {
			...
			if (this.modelType == 2) {
				local151 = arg7.get(this.modelID).getHeadModel(arg0, arg1, arg8, arg12, arg4, arg3, arg9);
				if (local151 == null) {
					Static86.aBoolean133 = true;
					return null;
				} else {
	...
	public void decodeIf3(@OriginalArg(1) Buffer buffer) {
		...
		if ((this.type & 0x80) != 0) {
			this.type &= 0x7F;
			this.aString43 = buffer.gjstr();
		}
		this.anInt4273 = buffer.g2();
		this.anInt4241 = buffer.g2b_dup();
		this.anInt4249 = buffer.g2b_dup();
		this.anInt4294 = buffer.g2();
		this.anInt4289 = buffer.g2();
		this.widthMode = buffer.g1b();
		this.heightMode = buffer.g1b();
		this.aByte45 = buffer.g1b();
		this.aByte46 = buffer.g1b();
		...
		if (this.type == 0) {
			this.scrollWidth = buffer.g2();
			this.scrollHeight = buffer.g2();
			this.noClickThrough = buffer.g1() == 1;
		}
		@Pc(155) int local155;
		if (this.type == 5) {
			this.graphic = buffer.mg4();
			this.angle = buffer.g2();
			local155 = buffer.g1();
			this.alpha = (local155 & 0x2) != 0;
			this.tiled = (local155 & 0x1) != 0;
			this.transparency = buffer.g1();
			this.outline = buffer.g1();
			this.graphicShadow = buffer.mg4();
			this.horizontalFlip = buffer.g1() == 1;
			this.verticalFlip = buffer.g1() == 1;
		...
		if (this.type == 6) {
			...
			this.modelOrthographic = buffer.g1() == 1;
			this.aShort62 = (short) buffer.g2();
			this.aShort61 = (short) buffer.g2();
			this.aBoolean289 = buffer.g1() == 1;
			if (this.widthMode != 0) {
				this.anInt4251 = buffer.g2();
			}
			if (this.heightMode != 0) {
				this.anInt4269 = buffer.g2();
			}
		}
		if (this.type == 4) {
			this.textFont = buffer.g2();
		...
		if (this.type == 3) {
			this.color = buffer.mg4();
			this.fill = buffer.g1() == 1;
			this.transparency = buffer.g1();
		}
		if (this.type == 9) {
			this.lineWidth = buffer.g1();
			this.color = buffer.mg4();
			this.lineDirection = buffer.g1() == 1;
		}
		local155 = buffer.ig3();
		@Pc(449) int local449 = buffer.g1();
		@Pc(474) int local474;
		if (local449 != 0) {
			...
			while (local449 != 0) {
				...
				this.aByteArray49[local474] = buffer.g1b();
				if (this.aByteArray49[local474] != 0) {
					this.aBoolean282 = true;
				}
				this.aByteArray50[local474] = buffer.g1b();
				local449 = buffer.g1();
			}
		}
		...
		if (local545 > 0) {
			...
			for (local556 = 0; local556 < local545; local556++) {
				this.ops[local556] = buffer.gjstr();
			}
		}
		@Pc(577) int local577 = local474 >> 4;
		if (local577 > 0) {
			local556 = buffer.g1();
			this.opCursors = new int[local556 + 1];
			for (@Pc(594) int local594 = 0; local594 < this.opCursors.length; local594++) {
				this.opCursors[local594] = -1;
			}
			this.opCursors[local556] = buffer.g2();
		}
		if (local577 > 1) {
			local556 = buffer.g1();
			this.opCursors[local556] = buffer.g2();
		}
		this.pausText = buffer.gjstr();
		...
		if (Static13.getTargetMask(local155) != 0) {
			...
			this.anInt4238 = buffer.g2();
			if (this.anInt4238 == 65535) {
				this.anInt4238 = -1;
			}
			this.anInt4286 = buffer.g2();
	...
	public Class78 method4108(@OriginalArg(1) Class19 arg0) {
		@Pc(19) Class78 local19 = (Class78) Static297.A_SOFT_LRU_HASH_TABLE___44.get((long) this.id);
		if (local19 != null) {
			return local19;
		}
		@Pc(29) SoftwareSprite local29 = Static396.loadSoftwareSprite(Static79.aJs5_19, this.graphic, 0);
		if (local29 == null) {
			return null;
		}
		...
		Static297.A_SOFT_LRU_HASH_TABLE___44.put((long) this.id, local19);
		return local19;
	}
	...
	public void method4109(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.opCursors == null || this.opCursors.length <= arg1) {
			@Pc(18) int[] local18 = new int[arg1 + 1];
			if (this.opCursors != null) {
				for (@Pc(23) int local23 = 0; local23 < this.opCursors.length; local23++) {
					local18[local23] = this.opCursors[local23];
				}
				for (@Pc(42) int local42 = this.opCursors.length; local42 < arg1; local42++) {
					local18[local42] = -1;
				}
			}
			this.opCursors = local18;
		}
		this.opCursors[arg1] = arg0;
	}
	...
	public Class13 method4112(@OriginalArg(1) Class19 arg0) {
		...
		@Pc(64) SoftwareSprite local64 = Static396.loadSoftwareSprite(Static79.aJs5_19, this.graphic, 0);
		if (local64 == null) {
			Static86.aBoolean133 = true;
			return null;
		}
		...
		if (this.outline > 0) {
			local64.method1686(this.outline);
		...
		if (this.graphicShadow != 0) {
			local64.method1677(this.graphicShadow | 0xFF000000);
		}
		local54 = arg0.method2891(local64);
		Static335.A_SOFT_LRU_HASH_TABLE___57.put(local48, local54);
		return local54;
	}
}
