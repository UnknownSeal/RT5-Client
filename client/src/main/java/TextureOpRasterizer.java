...
public final class TextureOpRasterizer extends TextureOp {
	...
	public void decode(@OriginalArg(1) Buffer buffer, @OriginalArg(0) int opcode) {
		if (opcode == 0) {
			this.aClass173Array1 = new Class173[buffer.g1()];
			for (@Pc(33) int local33 = 0; local33 < this.aClass173Array1.length; local33++) {
				@Pc(39) int local39 = buffer.g1();
				if (local39 == 0) {
					this.aClass173Array1[local33] = Static354.method1393(buffer);
				} else if (local39 == 1) {
					this.aClass173Array1[local33] = Static174.method1508(buffer);
				} else if (local39 == 2) {
					this.aClass173Array1[local33] = Static372.method6265(buffer);
				} else if (local39 == 3) {
					this.aClass173Array1[local33] = Static217.method3798(buffer);
				}
			}
		} else if (opcode == 1) {
