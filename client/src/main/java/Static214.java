...
public final class Static214 {
	...
	public static Class2_Sub2_Sub11 method3744(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(32) int local32 = local21.method4828();
		@Pc(43) int local43 = local21.aByteArray73.length - local32 - 2 - 12;
		local21.anInt5300 = local43;
		@Pc(50) int local50 = local21.method4835();
		local16.anInt3225 = local21.method4828();
		local16.anInt3228 = local21.method4828();
		local16.anInt3230 = local21.method4828();
		local16.anInt3227 = local21.method4828();
		@Pc(74) int local74 = local21.method4814();
		@Pc(85) int local85;
		@Pc(91) int local91;
		if (local74 > 0) {
			local16.aClass4Array1 = new Class4[local74];
			for (local85 = 0; local85 < local74; local85++) {
				local91 = local21.method4828();
				@Pc(98) Class4 local98 = new Class4(Static162.method2976(local91));
				local16.aClass4Array1[local85] = local98;
				while (local91-- > 0) {
					@Pc(109) int local109 = local21.method4835();
					@Pc(115) int local115 = local21.method4835();
					local98.method87(new Class2_Sub39(local115), (long) local109);
				}
			}
		}
		local21.anInt5300 = 0;
		local16.aString27 = local21.method4858();
		...
		while (local43 > local21.anInt5300) {
			local91 = local21.method4828();
			if (local91 == 3) {
				local16.aStringArray27[local85] = local21.method4808().intern();
			} else if (local91 >= 100 || local91 == 21 || local91 == 38 || local91 == 39) {
				local16.anIntArray200[local85] = local21.method4814();
			} else {
				local16.anIntArray200[local85] = local21.method4835();
			}
