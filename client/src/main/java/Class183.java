...
public final class Class183 {
	...
	private void method4631() {
		...
		try {
			this.aClass2_Sub4_7.anInt5300 = 0;
			this.aClass2_Sub4_7.method4841(6);
			this.aClass2_Sub4_7.method4845(3);
			this.aClass111_3.method2797(4, this.aClass2_Sub4_7.aByteArray73);
	...
	public void method4634() {
		...
		try {
			this.aClass2_Sub4_7.anInt5300 = 0;
			this.aClass2_Sub4_7.method4841(7);
			this.aClass2_Sub4_7.method4845(0);
			this.aClass111_3.method2797(4, this.aClass2_Sub4_7.aByteArray73);
	...
	public void method4638(@OriginalArg(0) Class111 arg0, @OriginalArg(1) boolean arg1) {
		...
		this.aClass2_Sub4_8.anInt5300 = 0;
				...
				while (true) {
					...
					if (local44 == null) {
						if (this.aByte55 != 0) {
							try {
								this.aClass2_Sub4_7.anInt5300 = 0;
								this.aClass2_Sub4_7.method4841(4);
								this.aClass2_Sub4_7.method4841(this.aByte55);
								this.aClass2_Sub4_7.method4842(0);
								this.aClass111_3.method2797(4, this.aClass2_Sub4_7.aByteArray73);
	...
	public boolean method4639() {
		...
		try {
			...
			for (@Pc(74) Class2_Sub2_Sub10_Sub1 local74 = (Class2_Sub2_Sub10_Sub1) this.aClass246_5.method6336(); local74 != null; local74 = (Class2_Sub2_Sub10_Sub1) this.aClass246_5.method6335()) {
				this.aClass2_Sub4_7.anInt5300 = 0;
				this.aClass2_Sub4_7.method4841(1);
				this.aClass2_Sub4_7.method4845((int) local74.aLong215);
				this.aClass111_3.method2797(4, this.aClass2_Sub4_7.aByteArray73);
			...
			for (@Pc(126) Class2_Sub2_Sub10_Sub1 local126 = (Class2_Sub2_Sub10_Sub1) this.aClass246_7.method6336(); local126 != null; local126 = (Class2_Sub2_Sub10_Sub1) this.aClass246_7.method6335()) {
				this.aClass2_Sub4_7.anInt5300 = 0;
				this.aClass2_Sub4_7.method4841(0);
				this.aClass2_Sub4_7.method4845((int) local126.aLong215);
				this.aClass111_3.method2797(4, this.aClass2_Sub4_7.aByteArray73);
			...
			for (local18 = 0; local18 < 100; local18++) {
				...
				@Pc(301) int local301;
				if (local191 > 0) {
					local219 = local191 - this.aClass2_Sub4_8.anInt5300;
					if (local175 < local219) {
						local219 = local175;
					}
					this.aClass111_3.method2793(this.aClass2_Sub4_8.aByteArray73, local219, this.aClass2_Sub4_8.anInt5300);
					if (this.aByte55 != 0) {
						for (local243 = 0; local243 < local219; local243++) {
							this.aClass2_Sub4_8.aByteArray73[this.aClass2_Sub4_8.anInt5300 + local243] = (byte) (this.aClass2_Sub4_8.aByteArray73[this.aClass2_Sub4_8.anInt5300 + local243] ^ this.aByte55);
						}
					}
					this.aClass2_Sub4_8.anInt5300 += local219;
					if (this.aClass2_Sub4_8.anInt5300 >= local191) {
						if (this.aClass2_Sub2_Sub10_Sub1_2 == null) {
							this.aClass2_Sub4_8.anInt5300 = 0;
							local243 = this.aClass2_Sub4_8.method4814();
							local301 = this.aClass2_Sub4_8.method4828();
							@Pc(306) int local306 = this.aClass2_Sub4_8.method4814();
							@Pc(311) int local311 = this.aClass2_Sub4_8.method4835();
							...
							this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.method4841(local315);
							this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.method4812(local311);
					...
					if (local219 - this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.anInt5300 < local243) {
						local243 = local219 - this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.anInt5300;
					}
					if (local175 < local243) {
						local243 = local175;
					}
					this.aClass111_3.method2793(this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.aByteArray73, local243, this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.anInt5300);
					if (this.aByte55 != 0) {
						for (local301 = 0; local301 < local243; local301++) {
							this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.aByteArray73[local301 + this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.anInt5300] ^= this.aByte55;
						}
					}
					this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.anInt5300 += local243;
					this.aClass2_Sub2_Sub10_Sub1_2.anInt3083 += local243;
					if (local219 == this.aClass2_Sub2_Sub10_Sub1_2.aClass2_Sub4_3.anInt5300) {
	...
	public void method4646(@OriginalArg(0) boolean arg0) {
		...
		try {
			this.aClass2_Sub4_7.anInt5300 = 0;
			this.aClass2_Sub4_7.method4841(arg0 ? 2 : 3);
			this.aClass2_Sub4_7.method4845(0);
			this.aClass111_3.method2797(4, this.aClass2_Sub4_7.aByteArray73);
