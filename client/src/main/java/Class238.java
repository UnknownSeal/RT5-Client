...
public final class Class238 {
	...
	public boolean method6060() {
		...
		for (@Pc(54) int local54 = 0; local54 < this.anIntArray474.length; local54++) {
			...
			@Pc(78) int local78 = 0;
			if (local70 > 0) {
				local78 = Static267.aVorbisCodebookArray1[this.anIntArray469[local60]].decodeScalar();
			}
			for (@Pc(90) int local90 = 0; local90 < local65; local90++) {
				@Pc(100) int local100 = this.anIntArrayArray60[local60][local78 & local76];
				local78 >>>= local70;
				Static362.anIntArray468[local52++] = local100 >= 0 ? Static267.aVorbisCodebookArray1[local100].decodeScalar() : 0;
			}
		}
		return true;
	}
