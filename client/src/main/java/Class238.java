...
public final class Class238 {
	...
	public Class238() {
		@Pc(4) int local4 = Static267.method4512(16);
		if (local4 != 1) {
			throw new RuntimeException();
		}
		@Pc(14) int local14 = Static267.method4512(5);
		@Pc(16) int local16 = 0;
		this.anIntArray474 = new int[local14];
		@Pc(26) int local26;
		for (@Pc(22) int local22 = 0; local22 < local14; local22++) {
			local26 = Static267.method4512(4);
		...
		for (local26 = 0; local26 < local16; local26++) {
			this.anIntArray472[local26] = Static267.method4512(3) + 1;
			local77 = this.anIntArray473[local26] = Static267.method4512(2);
			if (local77 != 0) {
				this.anIntArray469[local26] = Static267.method4512(8);
			}
			local77 = 0x1 << local77;
			@Pc(92) int[] local92 = new int[local77];
			this.anIntArrayArray60[local26] = local92;
			for (local99 = 0; local99 < local77; local99++) {
				local92[local99] = Static267.method4512(8) - 1;
			}
		}
		this.anInt6772 = Static267.method4512(2) + 1;
		local77 = Static267.method4512(4);
		...
		for (@Pc(163) int local163 = 0; local163 < local14; local163++) {
			...
			for (@Pc(171) int local171 = 0; local171 < this.anIntArray472[local169]; local171++) {
				this.anIntArray475[local126++] = Static267.method4512(local77);
			}
		}
	...
	private void method6055(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float[] arg4, @OriginalArg(5) int arg5) {
	...
	public void method6056(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(20) int local20 = 2; local20 < local3; local20++) {
			local25 = Static362.method6058(Static362.anIntArray470, local20);
			local29 = Static362.method6059(Static362.anIntArray470, local20);
			local47 = this.method6061(Static362.anIntArray470[local25], Static362.anIntArray468[local25], Static362.anIntArray470[local29], Static362.anIntArray468[local29], Static362.anIntArray470[local20]);
		...
		for (local47 = 1; local47 < local3; local47++) {
			if (Static362.aBooleanArray60[local47]) {
				...
				this.method6055(local25, local29, local51, local55, arg0, arg1);
				if (local51 >= arg1) {
					return;
				}
				local25 = local51;
	...
	private void method6057(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 >= arg1) {
			return;
		}
		...
		this.method6057(arg0, local5 - 1);
		this.method6057(local5 + 1, arg1);
	}

	@OriginalMember(owner = "client!vd", name = "a", descriptor = "()Z")
	public boolean method6060() {
		@Pc(5) boolean local5 = Static267.method4521() != 0;
		if (!local5) {
			return false;
		}
		...
		for (@Pc(54) int local54 = 0; local54 < this.anIntArray474.length; local54++) {
			...
			@Pc(78) int local78 = 0;
			if (local70 > 0) {
				local78 = Static267.aClass175Array1[this.anIntArray469[local60]].method4438();
			}
			for (@Pc(90) int local90 = 0; local90 < local65; local90++) {
				@Pc(100) int local100 = this.anIntArrayArray60[local60][local78 & local76];
				local78 >>>= local70;
				Static362.anIntArray468[local52++] = local100 >= 0 ? Static267.aClass175Array1[local100].method4438() : 0;
			}
		}
		return true;
	}
	...
	private int method6061(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(3) int local3 = arg3 - arg1;
		@Pc(7) int local7 = arg2 - arg0;
		@Pc(14) int local14 = local3 < 0 ? -local3 : local3;
