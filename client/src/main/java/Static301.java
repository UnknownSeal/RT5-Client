			...
			if (local19.aByte78 != Static355.anInt6585 || local19.anInt4722 < Static114.loop) {
				...
				if (local19.anInt4714 > 0) {
					...
					if (local56 != null && local56.anInt6781 >= 0 && local56.anInt6781 < Static373.anInt7033 * 128 && local56.anInt6783 >= 0 && Static242.anInt4449 * 128 > local56.anInt6783) {
						local19.method4396(Static386.method6031(local56.anInt6781, local56.anInt6783, local19.aByte78) - local19.anInt4736, local56.anInt6781, Static114.loop, local56.anInt6783);
					}
				}
				if (local19.anInt4714 < 0) {
					...
					if (local120 != null && local120.anInt6781 >= 0 && local120.anInt6781 < Static373.anInt7033 * 128 && local120.anInt6783 >= 0 && local120.anInt6783 < Static242.anInt4449 * 128) {
						local19.method4396(Static386.method6031(local120.anInt6781, local120.anInt6783, local19.aByte78) - local19.anInt4736, local120.anInt6781, Static114.loop, local120.anInt6783);
					}
				}
