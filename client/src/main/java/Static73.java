	...
	public static boolean method1821() throws IOException {
		...
		if (Static231.aClass89_164 == null) {
			if (Static69.aBoolean129) {
				local15--;
				Static335.socket.read(Static212.inboundBuffer.data, 1, 0);
				Static301.anInt5697++;
			...
			if (Static212.inboundBuffer.method4869()) {
				...
				Static335.socket.read(Static212.inboundBuffer.data, 1, 1);
				local15--;
				Static301.anInt5697++;
			}
		...
		if (Static82.anInt1836 == -1) {
			...
			Static335.socket.read(Static212.inboundBuffer.data, 1, 0);
			Static301.anInt5697++;
			Static82.anInt1836 = Static212.inboundBuffer.data[0] & 0xFF;
			local15--;
		}
						...
						if (Static231.aClass89_164 == Static384.aClass89_253) {
							...
							if (Static83.aClass89_69 == Static231.aClass89_164) {
								...
								if (Static231.aClass89_164 == Static220.aClass89_158) {
									...
									local1381 = Static146.method2699(local74).method5601(Static212.inboundBuffer);
									...
									if (Static231.aClass89_164 == Static82.aClass89_67) {
										...
										if (!local3016 && Static212.anInt3785 == 0) {
											...
											Static193.anInt3555 = (Static193.anInt3555 + 1) % 100;
											@Pc(3071) String local3071 = Static146.method2699(local542).method5601(Static212.inboundBuffer);
											if (local536 == 2) {
										...
										if (Static153.aClass89_117 == Static231.aClass89_164) {
											...
											if (Static125.aClass89_249 == Static231.aClass89_164) {
												...
												if (!local4900 && Static212.anInt3785 == 0) {
													...
													Static193.anInt3555 = (Static193.anInt3555 + 1) % 100;
													@Pc(4955) String local4955 = Static146.method2699(local4892).method5601(Static212.inboundBuffer);
													if (local638 == 2) {
