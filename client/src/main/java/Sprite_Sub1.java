...
public abstract class Sprite_Sub1 extends Sprite {
	...
	protected Sprite_Sub1(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@Override
	protected final void method6386(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class78 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	@Override
	protected final void method6393(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (this.aClass19_Sub2_5.method2912()) {
			throw new IllegalStateException();
		}
		this.method1990(arg0, arg1, arg2, arg3, arg4, arg5);
	...
	@Override
	public final int method6381() {
		return this.anInt1944;
	}

	@OriginalMember(owner = "client!ik", name = "b", descriptor = "(IIII)V")
	@Override
	public final void method6390(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.anInt1938 = arg0;
		this.anInt1916 = arg1;
		this.anInt1919 = arg2;
		this.anInt1929 = arg3;
	...
	@Override
	public final void method6396(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (this.aClass19_Sub2_5.method2912()) {
			throw new IllegalStateException();
		}
		...
		@Pc(37) int local37 = this.method6398();
		@Pc(40) int local40 = this.method6383();
		@Pc(48) int local48 = (arg2 + local37 - 1) / local37;
		@Pc(56) int local56 = (arg3 + local40 - 1) / local40;
		for (@Pc(58) int local58 = 0; local58 < local56; local58++) {
			@Pc(63) int local63 = local58 * local40;
			for (@Pc(65) int local65 = 0; local65 < local48; local65++) {
				this.method6400(arg0 + local65 * local37, arg1 + local63, arg4, arg5);
			}
		}
