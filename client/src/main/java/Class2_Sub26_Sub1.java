...
public final class Class2_Sub26_Sub1 extends Class2_Sub26 {
	...
	public Class2_Sub26_Sub1(@OriginalArg(0) Class2_Sub4 arg0) {
		if (Static202.anIntArray220 == null) {
			Static241.method4193();
		}
		this.anInt4380 = arg0.method4814();
		this.aBoolean301 = (this.anInt4380 & 0x8) != 0;
		this.aBoolean300 = (this.anInt4380 & 0x10) != 0;
		this.anInt4380 &= 0x7;
		super.anInt4370 = arg0.method4828();
		super.anInt4371 = arg0.method4828();
		super.anInt4368 = arg0.method4828();
		super.anInt4374 = arg0.method4814();
		...
		for (@Pc(71) int local71 = 0; local71 < this.aShortArray92.length; local71++) {
			@Pc(78) short local78 = (short) arg0.method4828();
		...
		if (Static59.anIntArray107 == null) {
			super.anInt4372 = Static181.anIntArray204[Static26.method863(arg0.method4828()) & 0xFFFF];
		} else {
			super.anInt4372 = Static59.anIntArray107[arg0.method4828()];
		}
		@Pc(158) int local158 = arg0.method4814();
	...
	public void method4152(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		@Pc(9) int local9;
		if (arg1) {
			local9 = 2048;
		} else {
	...
	public void method4153(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		this.anInt4382 = arg1;
		this.anInt4377 = arg2;
		this.anInt4386 = arg0;
		this.anInt4375 = arg3;
