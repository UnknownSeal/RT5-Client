...
public final class RuntimeException_Sub2 extends RuntimeException {
	...
	public static void method6500(@OriginalArg(0) Applet arg0, @OriginalArg(1) String arg1, @OriginalArg(3) Throwable arg2) {
		try {
			@Pc(6) String local6 = "";
			if (arg2 != null) {
				local6 = method6504(arg2);
			}
			if (arg1 != null) {
				if (arg2 != null) {
					local6 = local6 + " | ";
			...
			method6503(local6);
			local6 = method6502(":", local6, "%3a");
			local6 = method6502("@", local6, "%40");
			local6 = method6502("&", local6, "%26");
			local6 = method6502("#", local6, "%23");
	...
	private static String method6502(@OriginalArg(1) String arg0, @OriginalArg(2) String arg1, @OriginalArg(3) String arg2) {
	...
	private static void method6503(@OriginalArg(1) String arg0) {
		System.out.println("Error: " + method6502("%0a", arg0, "\n"));
	}

	@OriginalMember(owner = "loader!e", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;")
	private static String method6504(@OriginalArg(0) Throwable arg0) throws IOException {
