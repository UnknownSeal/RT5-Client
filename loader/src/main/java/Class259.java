...
public final class Class259 implements Runnable {
	...
	private static Class260 method6531(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1) {
	...
	private static File method6540(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
	...
	private static Class260 method6542(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
	...
	public Class259(@OriginalArg(0) Applet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3) throws Exception {
		...
		this.aClass260_2 = new Class260(method6540(null, this.anInt7278, "random.dat"), "rw", 25L);
		this.aClass260_3 = new Class260(this.method6529("main_file_cache.dat2"), "rw", 209715200L);
		this.aClass260_1 = new Class260(this.method6529("main_file_cache.idx255"), "rw", 1048576L);
		this.aClass260Array1 = new Class260[arg3];
		for (@Pc(192) int local192 = 0; local192 < arg3; local192++) {
			this.aClass260Array1[local192] = new Class260(this.method6529("main_file_cache.idx" + local192), "rw", 1048576L);
		}
		try {
	...
	public File method6529(@OriginalArg(0) String arg0) {
		return method6540(this.aString79, this.anInt7278, arg0);
	}
	...
	public void run() {
		while (true) {
			...
			try {
				...
				if (local45 == 1) {
					if (Class258.method6519() < aLong235) {
					...
					if (local45 == 8) {
						...
						if (local45 == 3) {
							...
							if (aLong235 > Class258.method6519()) {
								throw new IOException();
							}
							local16.anObject8 = InetAddress.getByName((String) local16.anObject9).getAddress();
						} else if (local45 == 5) {
							local16.anObject8 = this.aClass255_1.method6495();
						} else if (local45 == 6) {
							@Pc(676) Frame local676 = new Frame("Jagex Full Screen");
							local16.anObject8 = local676;
							local676.setResizable(false);
							this.aClass255_1.method6496(local676, local16.anInt7267 & 0xFFFF, local16.anInt7265 >> 16, local16.anInt7267 >>> 16, local16.anInt7265 & 0xFFFF);
						} else if (local45 == 7) {
							...
							if (local45 == 10) {
								...
								if (local45 == 11) {
									...
									if (local45 == 12) {
										local156 = method6531(this.aString79, this.anInt7278);
										local16.anObject8 = local156;
									} else if (local45 == 13) {
										local156 = method6542(this.anInt7278, this.aString79);
										local16.anObject8 = local156;
									} else if (local45 == 14) {
										@Pc(395) int local395 = local16.anInt7267;
										@Pc(398) int local398 = local16.anInt7265;
										this.aClass254_1.method6490(local395, local398);
									} else if (local45 == 15) {
										@Pc(179) boolean local179 = local16.anInt7267 != 0;
										@Pc(183) Component local183 = (Component) local16.anObject9;
										this.aClass254_1.method6492(local179, local183);
									} else if (local45 == 17) {
										local73 = (Object[]) local16.anObject9;
										this.aClass254_1.method6491((int[]) local73[1], local16.anInt7267, local16.anInt7265, (Point) local73[2], (Component) local73[0]);
									} else if (local45 == 16) {
										try {
										...
										try {
											...
											if (aString80.startsWith("win")) {
												if (aString81.startsWith("amd64") || aString81.startsWith("x86_64")) {
													local297.invoke(local291, local16.anObject9, this.method6529("jagmisc64.dll").toString());
												} else {
													local297.invoke(local291, local16.anObject9, this.method6529("jagmisc.dll").toString());
												}
											}
											local297.setAccessible(false);
